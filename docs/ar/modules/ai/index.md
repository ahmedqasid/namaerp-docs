...
- [دعم أفضل باستخدام وكيل ذكاء اصطناعي](./ai-assisted-support.md) — الإعداد الكامل للإجابة عن أسئلة الدعم بوكيل برمجي: قاعدة معرفة التوثيق، والربط بنظام حي، والأدوات التي تستحق التعريف.
