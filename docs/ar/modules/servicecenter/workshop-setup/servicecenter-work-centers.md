...
menu: مركز خدمة ← الملفات ← مركز خدمة
---
...
الكتلة المعتادة — الشركة (Legal Entity) والفرع (Branch) والقطاع (Sector) والإدارة (Department) والمجموعة التحليلية (Analysis Set) — تصنّف مركز الخدمة داخل الهيكل التنظيمي. وانظر [المحددات والمحددات المركبة](/ar/platform/dimensions-and-composite-dimensions) لمعرفة ما هي الخمسة وكيف يُنشأ المحدد.
