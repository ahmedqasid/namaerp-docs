...
![Stock receipt list in NaMa ERP](../../../modules/supplychain/images/receiving/stock-receipt-list-en.png)
...
When receiving finished products, scrap, or materials returning from production, you use the **Manufacturing** module's documents (such as product delivery and scrap receipt), not the general stock receipt. See the [Manufacturing module](/en/modules/manufacturing/) for those paths.
:::
...
![Stock receipt screen in NaMa ERP](../../../modules/supplychain/images/receiving/stock-receipt-edit-en.png)
