...
![Sales group](../../../modules/mobile/images/sales-inventory/sales-group.jpg)
...
![Sales order](../../../modules/mobile/images/sales-inventory/sales-order.jpg)
...
![Sales invoice](../../../modules/mobile/images/sales-inventory/sales-invoice.jpg)
...
![Item data](../../../modules/mobile/images/sales-inventory/item-data-inquiry.jpg)
...
![Items list](../../../modules/mobile/images/sales-inventory/item-list.jpg)

## Warehouse management

![Warehouse management group](../../../modules/mobile/images/sales-inventory/warehouse-group.jpg)
...
- **Stock receipt** — to receive goods, and it can be created **based on** a purchase invoice. You specify the customer/supplier, warehouse, locator, quantity and item, with barcode scanning supported in each field.
  ...
  ![Stock receipt](../../../modules/mobile/images/sales-inventory/stock-receipt.jpg)
...
- **Stock transfer request** — specifies the **from** and **to** warehouse and locator, the item and quantity, and can be created **based on** a sales order.
  ...
  ![Stock transfer request](../../../modules/mobile/images/sales-inventory/stock-transfer-request.jpg)
...
- **Issue stock transfer** and **receipt stock transfer** — to execute the transfer in two stages (issue from the sending warehouse, then receipt at the receiving warehouse); the receipt voucher is created **based on** the issue voucher.
  ...
  ![Issue stock transfer](../../../modules/mobile/images/sales-inventory/issue-stock-transfer.jpg)

  ![Receipt stock transfer](../../../modules/mobile/images/sales-inventory/receipt-stock-transfer.jpg)

## Electronic stock taking

![Electronic stock taking group](../../../modules/mobile/images/sales-inventory/stock-taking-group.jpg)
