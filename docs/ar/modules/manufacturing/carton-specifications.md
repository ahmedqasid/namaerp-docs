...
![مواصفة كرتونة: صندوق طماطم 40×30×15](images/carton/carton-specification-ar.png)
...
**الكود والاسم**: شيء وصفي مثل "CS-TOM400" و"Tomato Box 40x30x15"
...
**الصنف**: الكرتونة النهائية بوصفها صنفًا مخزنيًا. املأه. فهو غير معلَّم بأنه إلزامي في الشاشة، لكن [توليد أوامر الإنتاج](/ar/modules/manufacturing/carton-material-planning) يأخذ المنتج النهائي لأمر الإنتاج من هذا الحقل، فالمواصفة الخالية منه لا يمكن أخذها إلى الإنتاج.
...
مثلاً، صندوق بأبعاد 40 × 30 × 15 بعد التجميع.

::: warning أدخل الأبعاد بالسنتيمتر
لا شيء في الشاشة يذكر الوحدة، لكن حسابات مخطط الخامات تفترض **السنتيمتر** في كل موضع — هذه الأبعاد، وأبعاد الشيت أدناه، وعروض البكرات في المخزون. فصندوق 400 × 300 × 150 مم يُدخَل `40` و`30` و`15`. أدخله بالمليمتر فتُحفظ المواصفة ويبدو كل شيء سليمًا، لكن كل خطة مبنية عليها تُخفق برسالة *لا يمكن إيجاد حل ممكن*. والسبب في [الوحدة سنتيمترات](/ar/modules/manufacturing/carton-material-planning).
:::
...
**واجعل لكل مواصفة عملية تشغيل واحدة على الأقل.** فالمكونات التي يخرج بها تخطيط الخامات تُعلَّق كلها على أول عملية في مسار التشغيل، فالمواصفة ذات تبويب عمليات التشغيل الفارغ يُخفق معها توليد أوامر الإنتاج من أصله برسالة «هذة العملية ليست من عمليات التشغيل».
...
- معادلة الطول: `(l+w)*2+4`
- معادلة العرض: `w+h`

وتحقّق منها على صندوق حقيقي. فكرتونة 40 × 30 × 15 سم تعطي `(40+30)*2+4 = 144` و`30+15 = 45` — وهو شيت 144 × 45 سم الذي تحتاجه تلك الكرتونة بالضبط. والـ`4` لسان اللصق، بالسنتيمتر كسائر ما هنا؛ والمصنع الذي يعمل بلسان 3 سم يكتب `(l+w)*2+3`.
...
والنتيجة بالجرام. والقسمة على 10,000 هي الدليل على أن أبعاد الشيت بالسنتيمتر: فهي التي تحوّل السنتيمترات المربعة إلى أمتار مربعة ليمكن تطبيق الأوزان عليها.

وأجرِ الحساب على صندوق الطماطم. تعطي الطبقات `150 + (112 × 1.34) + 125 = 425.08` جرامًا للمتر المربع، وبإضافة منسوب نشا 18 تصير 443.08. والشيت 144 × 45 سم، أي 6,480 سم² أو 0.648 م². فيخرج الناتج **287.1 جرامًا**، وهو ما يخزّنه Nama وما تزنه الكرتونة فعلًا. فإن كان الوزن الذي يحسبه Nama بعيدًا جدًا عن عيّنة حقيقية، فأحد الأوزان أو معامل التضليع أو وحدة الأبعاد خطأ.
...
|---|---|---|
| «المواصفة {0} في السطر {1} مستخدمة في المواصفة {2}» | كرتونة فرعية مدرجة في مواصفة مجمعة تابعة بالفعل لمواصفة أخرى. والكرتونة المكوِّنة تتبع أبًا واحدًا فقط. | احذف السطر، أو خُذ نسخة من تلك المواصفة لتستخدمها فرعًا هنا. |
| «العميل {0} الموجود بمواصفات الكرتونة {1} مختلف عن العميل {2} الموجود بهذه الملف» | سطر كرتونة فرعية يذكر مواصفة تابعة لعميل غير عميل المواصفة الأب. | استخدم مواصفة فرعية للعميل نفسه، أو صحّح العميل في أحد الملفين. |
| «السجل {0} في السطر {1} هو نفس السجل الحالي» | المواصفة تدرج نفسها كإحدى كراتينها الفرعية. | احذف ذلك السطر. |
| «الحقل {0} في {1} يجب أن يكون من نوع {2}» | سطر فرعي ليس من نوع التصنيع الذي يطلبه أبوه: الكرتونة المجمعة تأخذ كراتين عادية أبناءً، والفاصل المجمع يأخذ فواصل. والرسالة تذكر النوع المتوقَّع وتربطك بالمواصفة المخالفة. | استبدل الفرع بآخر من النوع المذكور، أو غيّر نوع تصنيع تلك المواصفة إن كان مضبوطًا خطأً. |
| «منسوب النشا {0} الموجود في المستند لا يساوي منسوب النشا {1} الموجود في النوع {2}» | منسوب النشا المكتوب في المواصفة يخالف المنسوب الذي يحمله نوع الكرتونة المشار إليه. | طابِق المواصفة على النوع، أو استخدم نوعًا منسوب النشا فيه هو ما تريد. والرسالة تذكر القيمتين. |
| «معامل التضليع {0} الموجود علي السطر لا يساوي معامل التضليع {1} الموجود في نوع التضليع {2}» | سطر في مرحلة الإنتاج الأولى يحمل معامل تضليع لا يطابق المعامل في نوع التضليع المختار في السطر نفسه. | خُذ المعامل من نوع التضليع، أو اختر نوع التضليع الذي يحمل المعامل الذي تريده فعلًا. |
| «طول الشيت {0} يجب أن يكون أقل من أو يساوي قيمة أقصي طول {1} للشيت الموجودة في نوع الطباعة {2}» | الشيت الذي تنتجه المواصفة أطول مما يتحمله نوع الطباعة. والفحص لا يعمل إلا إذا كان لنوع الطباعة أقصى طول شيت مملوء. | قصِّر الشيت، أو استخدم نوع طباعة — ماكينة — يقبله. |
| «القالب {0} يجب أن يكون قالب طيات (فورم)» | حقل **قالب الطيات** يشير إلى قالب نوعه ليس قالب طيات. | اختر قالب طيات، أو صحّح النوع في ملف القالب. |
| «القالب {0} يجب أن يكون قالب طباعة (سريلة)» | الالتباس نفسه في حقل **قالب الطباعة**. | اختر قالب طباعة، أو صحّح النوع في ملف القالب. |
