...
عند استلام منتجات تامة أو خردة أو مواد عائدة من الإنتاج، تُستخدم مستندات وحدة **التصنيع** (مثل تسليم المنتج واستلام الخردة) لا التوريد المخزني العام. راجع [وحدة التصنيع](/ar/modules/manufacturing/) لتفاصيل تلك المسارات.
:::
...
|---|---|---|
| «{0} يمكن أن يحتوي على أكثر من شحنة ولذلك حقل مصدر التكلفة يجب أن يحتوي على الشحنة بدلاً من الإعتماد المستندي» | سند التوريد يأخذ تكلفته من اعتماد مستندي مُعلَّم بأنه متعدد الشحنات، فالاعتماد ككل لا يحدد تكلفة هذه الشحنة. | اجعل **مصدر التكلفة** يشير إلى الشحنة المعنية من الاعتماد لا إلى الاعتماد نفسه. |
| «لابد من عمل مستند تحكم جودة لهذا الصنف» | سند التوريد مولَّد من **توريد أول المدة**، والصنف في السطر المذكور له قائمة فحص جودة، ولم يُسجَّل بعد مستند تحكم جودة لهذا الصنف على سند أول المدة. | سجّل مستند تحكم الجودة لهذا الصنف على سند أول المدة أولًا، ثم احفظ سند التوريد. |
| «كمية الصنف {0} غير كافية» | سند توريد قائم على **مرتجع مبيعات** يعيد من الصنف أكثر مما تبقى غير مرتجع من الصرف الأصلي — فمرتجعات سابقة استهلكت جزءًا منه. | راجع الكمية المرتجعة فعلًا من سطر الفاتورة، ولا تورِّد أكثر من الباقي. |
| «المورد بالمستند {0} هو {1} بينما المورد بالفاتورة هو {2}» | سند التوريد يذكر موردًا، وفاتورة الشراء المولَّد منها تذكر موردًا آخر. | وحِّد المورد في الاثنين، أو أفرِغ المورد من سند التوريد وأترك الفاتورة تحدده. |
| «العميل بالمستند {0} هو {1} بينما العميل بالفاتورة هو {2}» | سند التوريد يذكر عميلًا، ومرتجع المبيعات المولَّد منه يذكر عميلًا آخر. | وحِّد العميل في الاثنين، أو أفرِغ العميل من سند التوريد. |
| «الكمية يجب أن تساوى مجموع {0} و {1}» | في سطر **فحص التوريد** لا يساوي مجموع الكمية المقبولة والمرفوضة كمية السطر. والرسالة تذكر الحقلين، فتعرف منها إن كان الخلل في الوحدة الأساسية أم الثانية. | وزّع كمية السطر كلها بين المقبول والمرفوض بالوحدة التي تذكرها الرسالة. |
| «الوحدة في السطر رقم {0} لاتطابق الوحدة في سند التوريد المخزني» | سطر في **سند إلغاء توريد مخزني** بوحدة مختلفة عن وحدة سطر التوريد الذي يلغيه. | استخدم وحدة سطر التوريد الأصلي نفسها؛ فالإلغاء لا يحوّل بين الوحدات. |
| «الكمية {0} لايمكن أن تكون أكبر من الكمية المتاحة {1} في السطر رقم {2}» | الإلغاء يطلب أكثر من المتبقي من سطر التوريد بعد عمليات إلغاء سابقة. والرسالة تذكر الرقمين. | ألغِ الكمية المتبقية التي تذكرها الرسالة أو أقل منها. |
| «الصنف {0} في السطر رقم {1} غير موجود في التوريد المخزني {2}» | سطر الإلغاء لا يقابل أي سطر في سند التوريد الذي يشير إليه — وغالبًا لأن سند التوريد عُدِّل بعد إنشاء الإلغاء. | أعد توليد سند الإلغاء من سند التوريد ليعود ارتباط السطور. |
| «لا يمكن إنشاء المستند في فترة عادية» | **مستند مخزون أول المدة** واقع في فترة مالية عادية، وتوجيهه لا يسمح بذلك — فأرصدة أول المدة موضعها فترة افتتاحية. | انقل المستند إلى الفترة الافتتاحية، أو فعّل **السماح بالفترات العادية** في توجيهه. |
