...
فاقبل. فتجاوز **اخر رقم** يُرفض صراحة برسالة
*You reached out to the last number {0} for queue {1}* (ولا نص عربي لها، فتظهر بالإنجليزية على الشاشات العربية أيضاً)، والعميل الواقف عند
...
«المستخدم {0} ليس لديه صلاحية {1} للفرع {2}». فالجدول هو ما تعدّله حين يشكو مشرف أنه لا يستطيع
حذف تذكرة عالقة.
:::
...
- دورة مغلقة — إذ يُمشى المسار كله ويُرفض الدوران برسالة *We found infinite path {0}* — وهي بالإنجليزية كذلك.
...
|---|---|---|
| «كود الطابور {0} مكرر في السطر {1}» | سطران في جدول **الطوابير** يحملان حرف الطابور نفسه. والحرف هو بادئة التذكرة ولا بد أن يكون فريداً على الإعدادات. | أعطِ الطابور الثاني حرفاً آخر، أو احذف السطر المكرر. |
| «كود الطابور {0} ليس موجود في سطور الطوابير» | سطر في جدول **مقدمين الخدمة** يسمّي كود طابور ليس من الحروف المعرَّفة في جدول الطوابير فوقه. | صحّح الكود على سطر مقدم الخدمة، أو أضف ذلك الحرف إلى جدول الطوابير أولاً. |
| «مقدم الخدمة {0} للطابور {1} مكرر في السطر {2}» | المستخدم نفسه يظهر مرتين لكود الطابور نفسه في جدول مقدمي الخدمة. فسطر واحد لكل مستخدم لكل طابور. | احذف السطر المكرر. ولتمكين مستشار من خدمة طابورين أعطه سطرين بحرفين **مختلفين**. |
| «المستخدم {0} ليس لديه صلاحية {1} للفرع {2}» | أحدهم تصرّف في تذكرة من شاشة الفرع دون العمود المناسب على سطره في مقدمي الخدمة — **يمكنه التعديل** للتعديل، و**يمكنه سحب التذكرة يدويا** للسحب أو الإسناد، و**الحذف** للحذف. | علّم العمود الذي يحتاجه هذا الشخص على سطره، أو أضف له سطر مقدم خدمة على إعدادات هذا الفرع. |
