...
|---|---|---|
| «طلب عمل تحليل مستخدم بالفعل فى نتيجة تحليل اخرى» | طلب التحليل المسمّى في هذه النتيجة مرتبط بنتيجة تحليل أخرى بالفعل. فالطلب له نتيجة واحدة. | افتح الطلب لتجد النتيجة القائمة وأدخل القيم فيها؛ فمنتقي الطلبات يخفي عادةً الطلبات التي أُدخلت نتائجها. |
| «طلب عمل أشعة مستخدم بالفعل فى نتيجة اشعة اخرى» | المستند المصدر طلب أشعة مرتبط بنتيجة أشعة أخرى بالفعل. | افتح الطلب لتجد النتيجة القائمة واكتب التقرير عليها. |
| «يوجد سند حجز {0} على الغرفة {1} تم الحجز في {2} والوقت المسموح به لعمل حجز آخر على نفس الغرفة هو {3}» | سند حجز عمليات آخر مرحَّل يحجز غرفة العمليات نفسها في وقت قريب جدًا من هذا الحجز. فملف الغرفة يحمل أدنى فارق بين الحجوزات، وتوجيه سند الحجز معلَّم عليه *مراعاة الفارق الزمني بين حجوزات الغرفة*. | انقل الحجز خارج الفارق، أو احجز غرفة أخرى، أو راجع الفارق في ملف الغرفة إن كان أوسع من المعقول. |
