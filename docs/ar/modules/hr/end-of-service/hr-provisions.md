...
|---|---|---|
| «الموظف {0} له سند إعادة إحتساب مخصصات موظف {1} بتاريخ {2} و هو بعد التاريخ الفعلى للمستند الحالي {3}» | يوجد لهذا الموظف سند إعادة احتساب أحدث، فإعادة احتساب فترة أسبق تجعل الاحتساب يبدأ من رقم تجاوزه السند الأحدث بالفعل. | تابع من أحدث سند إعادة احتساب، أو ألغِ السند اللاحق أولًا ثم أعد السلسلة بترتيب التواريخ. |
| «مفرد الراتب {0} لا يوجد سطور مدين تستخدم في التصفية الاّليه» | مفرد الراتب في سطر المخصص ليس فيه سطر حساب مدين معلَّم **يستخدم مع التصفية الآلية** ومطابق لهذا الموظف، فلا يوجد جانب مصروف يُرحَّل إليه الاحتساب. | في مفرد الراتب، عَلِّم **يستخدم مع التصفية الآلية** على سطر الحساب المدين الذي يحمل المخصص — وتأكد أن معيار الموظف في السطر يشمل هذا الموظف فعلًا. |
| «مفرد الراتب {0} لا يوجد سطور دائن تستخدم في التصفية الاّليه» | الأمر نفسه في الجانب الدائن: لا يوجد سطر حساب التزام معلَّم للتصفية الآلية. | عَلِّم سطر الحساب الدائن الذي يحمل التزام المخصص. |
| «مفرد المكون {0} للموظف {1} مكرر» | سند الافتتاح يدرج الموظف نفسه ومفرد الراتب نفسه مرتين. | احذف السطر المكرر؛ فرقم افتتاحي واحد لكل موظف مع كل مفرد. |
| «يوجد قيمة لمفرد الراتب {0} للموظف {1} في المستند {2}» | يوجد سند افتتاح مخصصات آخر يحمل رقمًا افتتاحيًا لذلك الموظف وذلك المفرد — والرصيد الافتتاحي يُدخل مرة واحدة. | عدّل المستند المذكور في الرسالة بدلًا من فتح ثانٍ، واستخدم سند إعادة الاحتساب لتغيير الرقم بعد ذلك. |
