...
متقاعدًا رُفض الحفظ بالرسالة «لا يمكن استعمال السجلات التي تم منع استعمالها {0}-{1}»، حيث `{0}-{1}`
نوع السجل المتقاعد وكوده. هذه هي الآلية كلها.
...
|---|---|---|
| «لا يمكن استعمال السجلات التي تم منع استعمالها {0}-{1}» | السجل الذي تحفظه يسمّي سجلًا متقاعدًا، والرسالة تذكر نوعه وكوده. | أعد السماح باستعماله، أو استعمل أحد الاستثناءات الثلاثة أعلاه — إعدادَي المستخدم أو جدول الحقول. |
| «لا يمكن استخدام الصنف {0} ، حيث أنه ممنوع من الإستخدام» | المنع نفسه على صنف، يرفعه فحص الصنف فتذكر الرسالة الصنف باسمه. | كما سبق. وفي مستند المرتجع يكون الاستثناء على مستوى الحقل هو الحل المناسب عادةً. |
| «المستند {0} ممنوع من الإستخدام في بناء على» | المستند المصدر الذي تولّد منه أُغلق بأمر **منع الاستعمال في بناءا علي**. وهو ليس متقاعدًا، الممنوع استعماله مصدرًا فقط. | نفّذ **السماح بالاستعمال في بناءا علي** على ذلك المستند، أو ولّد من مستند مصدر آخر. |
