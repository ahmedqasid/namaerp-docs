...
| الاعتماد مغلق بالفعل | الاستيراد رُسمِل؛ ألغِ سند التكليف أولاً |

وسند المصروف التابع لاعتماد مغلق لا يُحذَف كذلك، للسبب نفسه: أرقامه صارت داخل تكلفة أصل.

وإلغاء سند مصروف مرحَّل يعكس قيده ويمسح سطور توزيعه، فتخرج تلك التكاليف من أي إعادة حساب يجريها
سند التكليف بعد ذلك.
...
|---|---|---|
| «لا توجد فاتورة لهذا الإعتماد {0}» | الاعتماد المدوّن على المستند ليس له فاتورة مبدئية بعد، فلا إجمالي يُوزَّع عليه. | أدخِل الفاتورة المبدئية على الاعتماد ورحّلها أولاً. |
| «لا يمكن التعامل مع اعتماد حالته مغلقة» | الاعتماد المدوّن على المستند **مغلق** بالفعل. | ألغِ سند التكليف ليُفتَح الاعتماد من جديد، ثم أدخِل المصروف. |
| «لا يمكن حذف سند مصروفات لاعتماد مستندي حالته مغلق {0}» | حاولت حذف سند مصروف تابع لاعتماد مغلق. | ألغِ سند التكليف أولاً؛ فأرقام المصروف حتى ذلك الحين داخل تكلفة أصل. |
