...
|---|---|---|
| «إجمالي مبلغ الدفعات {0} لايساوي السعر الإجمالي {1}» | للعقد سطور دفعات في صفحة الفوترة ومجموعها لا يساوي **صافي القيمة**. | اجعل مجموع الجدول يساوي صافي القيمة (71,136.00 في `MC-0021`) لا الرقم الذي تطبعه الرسالة — فالرسالة تعرض الإجمالي قبل الضريبة بينما يقارن التحقّق بصافي القيمة. |
| «لا يمكن استخدام الاّلة {0} لأنها غير موجودة في جدول الالاّت» | سطر في جدول الزيارات يسمّي آلة غير مدرجة في جدول الآلات. | أضف الآلة إلى جدول الآلات، أو افرغ سطر جدول الزيارات — فهذا الجدول لا يحرّك شيئاً والأفضل تركه فارغاً. |
| «البند {0} في السطر {1} مكرر» | نفس قطعة الغيار، أو نفس الخدمة، مدرجة مرتين في صفحة قطع الغيار والخدمات. | ادمج السطرين في سطر واحد بالكمية المجمّعة؛ فالتغطية تُحتسب لكل سطر على حدة. |
| «الكمية الأساسية لا يمكن ان تقل عن الكمية المباعة» | سطر قطعة غيار أو خدمة كميته أقل من الكمية المباعة المخصومة عليه بالفعل. | ارفع الكمية إلى ما استُهلك على الأقل؛ فتخفيض التغطية إلى أقل مما أخذته المستندات مرفوض. |
