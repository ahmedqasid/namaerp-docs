...
|---|---|---|
| «يجب إختيار نوع المكافأة / الجزاء» | بطاقة الكتالوج ليس فيها تعليم على **عينية** ولا على **النقدي**، فلا شيء يحدد نوع القيمة التي تحملها. | عَلِّم **النقدي** للمكافأة أو الجزاء النقدي، و**عينية** للعيني. |
| «طريقة توزيع الحسابات المدينة يجب أن تكون ثابت في نوع المكافأة / الجزاء {0}» | توجيه المستند مضبوط على **الصرف الفوري** — أي أن السند يرحّل بنفسه لا عبر تشغيلة الرواتب — وفي هذه الحالة يجب أن تكون طريقة توزيع **الحسابات المدينة** في بطاقة الكتالوج **ثابت**. | اجعل توزيع المدين **ثابت** في النوع، أو غيّر طريقة الصرف في التوجيه لتُحمل القيمة إلى سند الراتب التالي. |
| «طريقة توزيع الحسابات الدائنة يجب أن تكون ثابت في نوع المكافأة / الجزاء {0}» | القاعدة نفسها في جانب **الحسابات الدائنة**. | كما سبق، بالنسبة لطريقة توزيع الدائن. |
