...
menu: التعليم ← الملفات ← إلغاء عقد دورة تدريبية
---
...
الأقساط، وإلا رُفض المستند برسالة
«اجمالي التفاصيل {0} يجب ان يكون مساوي لإجمالي الدفعات{1}». وهناك
...
مستند الإلغاء قابل للتراجع بالطريقة المعتادة. فإلغاؤه أو حذفه يزيل قيده المحاسبي ويزيل كل قيد
