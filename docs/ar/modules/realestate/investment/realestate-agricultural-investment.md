...
|---|---|---|
| «لا يمكن تعديل او حذف العقد الحالى لأنه مُعدل بواسطة العقد {0}» | هذا العقد عُدِّل بعقد تعديل بالفعل، والرسالة تسمّيه. والعقد المعدَّل مجمَّد. | اعمل على عقد التعديل بدلاً منه. وللرجوع إلى الأصل لا بد من إلغاء عقد التعديل أولاً. |
| «يجب أن يكون العقار فارغا لأن التصنيف {0} لا يعمل مع العقارات» | تصنيف العقد لا يعمل مع العقارات، وحقل **العقار** مملوء. | افرغ العقار، أو انقل العقد إلى تصنيف يعمل مع العقارات. |
| «لا يمكن تغيير التاريخ الفعلى للعقد لأن مستند استحقاق الأرباح {0} تم انشاؤه قبل {1}» | غيّرت التاريخ الفعلي للعقد، ويوجد مستند استحقاق أرباح أُنشئ قبل التاريخ الجديد. | اترك التاريخ الفعلي كما هو، أو ألغِ مستندات الاستحقاق التي تقع قبله أولاً. |
| «العقد {0} تم تعديله مسبقا بالعقد {1} .العقد يمكن تعديله مرة واحدة فقط» | العقد الذي تحاول تعديله سبق تعديله مرة بعقد تعديل آخر. | عدّل آخر عقد في السلسلة. فالعقد لا يقبل إلا تعديلاً واحداً. |
| «يجب ان يكون العقد المطلوب تعديلة {0} أقدم من العقد الحالى» | العقد المذكور في حقل **العقد المعدَّل** تاريخه الفعلي بعد تاريخ عقد التعديل نفسه. | أرِّخ عقد التعديل بعد العقد الذي يعدّله. |
| «لا يمكن ترك الأرباح فارغة» | جدول **الأرباح** في مستند الاستحقاق فارغ، فلا شيء يُطالَب به. | املأ سطور الأرباح، أو استعمل الزر الذي يحمّل أرباح العقد المستحقة. |
| «{1} إجمالي قيمة الفوائد {0} يجب ان يكون أكبر من او يساوى قيمة الأقساط المدفوعة» | مجموع سطور الأقساط المدفوعة أكبر من مجموع سطور الأرباح في المستند نفسه. | أنقِص الأقساط المدفوعة، أو ارفع الأرباح حتى يغطي الاستحقاق ما يُسوَّى به. |
| «لا يمكن استخدام العقد {0} لأن تاريخه الفعلي بعد تاريخ الستند الحالي» | التاريخ الفعلي للعقد بعد التاريخ الفعلي لمستند الاستحقاق، أي أن العقد لم يكن قائماً في ذلك اليوم. | أرِّخ مستند الاستحقاق في تاريخ العقد أو بعده، أو اختر عقداً أقدم. |
| «لا يمكن حفظ أو تعديل أو حذف مستند استحقاق الأرباح لأن العقد {0} تم تعديله بواسطة {1}» | العقد المدوّن على مستند الاستحقاق عُدِّل بعقد تعديل، فالمطالبات عليه مجمَّدة. | ارفع مستند الاستحقاق على عقد التعديل بدلاً منه. |
