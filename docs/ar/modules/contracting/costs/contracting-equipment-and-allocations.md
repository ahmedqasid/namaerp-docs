...
|---|---|---|
| «السطر {0} في المستند {1} متداخل مع السطر {2} في المستند {3}» | نفس الشخص أو الأصل أو السيارة مُسكَّن في موضعين بتاريخين متداخلين. والمراجعة تجري داخل المستند وفي مقابل كل تسكين آخر محفوظ، فقد يختلف رقما المستندين في الرسالة. | قصّر أحد المدتين حتى لا تتداخلا، أو احذف السطر المكرر. وإن سمّت الرسالة مستنداً آخر فذلك المستند هو ما يجب أن تنظر فيه. |
| «المستند {0} لعقد مشروع {1} التكلفة {2} والتكلفة المُوزعة {3}» | على مستند توزيع التكلفة، سطور توزيع التكلفة لذلك المستند المصدر ولعقد المشروع لا تساوي التكلفة المُجمَّعة لهذا الزوج. | اجعل الرقمين متساويين — والتكلفة المُجمَّعة لا تظهر في أي جدول، فاقرأها من الرسالة نفسها. اضغط **توزيع التكلفة** من جديد ليُعيد بناء السطور من الأيام المسكَّنة، أو صحّح المبالغ يدوياً. |
| «الأصل الثابت {0} المنشأ يعتمد على هذا المشروع {1}» | سطر سند إنشاء الأصول يشير إلى مشروع له أصل ثابت مُنشَأ بالفعل. فالمشروع الواحد لا يُرسمَل إلا في أصل واحد. | استخدم الأصل الموجود، أو وجّه السطر إلى مشروع آخر. |
