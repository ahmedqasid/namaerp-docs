...
| `AITTermAndConfigTools` | `<prefix>ListTermAndConfigTargets` و `<prefix>GetTermOrConfigSchema` و `<prefix>ReadTermOrConfig` و `<prefix>UpdateTermOrConfig` | سرد إعدادات التوجيهات وإدخالات الإعدادات ووصفها وقراءتها وتحديثها |
