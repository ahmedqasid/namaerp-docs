...
- يعيد حساب كل فرق؛
- يتحقق من أن صنف كل سطر إما موجود على الفاتورة المصدر وإما صنف **تعبئة** مصنَّف، ويفشل برسالة «الصنف المختار فى السطر {0} ليس له تصنيفات خاصة» إن لم يكن أياً منهما؛
...
- إن كان لسطرٍ فرقٌ غير صفري، وجب وجود سطر غير متطابق يحمل **الفرق نفسه** — وإلا ظهرت الرسالة «السطر رقم {0} لم تتم مراجعته ,برجاء الضغط على تحديث جدول الكميات الغير متطابقة». والعكس صحيح: السطر غير المتطابق القديم الذي لا يقابله سطر يُرفض بالطريقة ذاتها.
- السطر غير المتطابق المشير إلى سطر حذفته يُرفض برسالة «السطر رقم {0} لم يعد موجود ,برجاء الضغط على تحديث جدول الكميات الغير متطابقة».
...
|---|---|---|
| «الصنف المختار فى السطر {0} ليس له تصنيفات خاصة» | يرفعها زر **تحديث جدول الكميات الغير متطابقة**: صنف ذلك السطر ليس على فاتورة المبيعات المصدر وليس مصنَّفاً صنف تعبئة بأحد التصنيفات المذكورة على التوجيه. | احذف السطر، أو صنّف الصنف تعبئةً واربط تصنيفه بنوع عبوة على التوجيه. |
| «السطر رقم {0} لم تتم مراجعته ,برجاء الضغط على تحديث جدول الكميات الغير متطابقة» | سطر في التفاصيل له فرق ولا يوجد سطر غير متطابق يحمل الفرق نفسه، أو سطر غير متطابق يحمل فرقاً والسطر نفسه لم يعد له فرق. فالجدولان تباعدا. | اضغط **تحديث جدول الكميات الغير متطابقة** من جديد، فيعيد بناء جدول غير المتطابقة من الفروق الحالية. |
| «السطر رقم {0} لم يعد موجود ,برجاء الضغط على تحديث جدول الكميات الغير متطابقة» | سطر غير متطابق يشير إلى سطر تفاصيل حُذف بعد ذلك. والرقم في الرسالة هو رقم السطر في جدول **غير المتطابقة** لا في جدول التفاصيل. | اضغط الزر من جديد. |
| «برجاء الضغط على تحديث جدول الكميات الغير متطابقة» | صنف موجود على فاتورة المبيعات المصدر لا يظهر في أي من الجدولين — فلم يُسجَّل عنه شيء على الإطلاق. | أدخل سطر ذلك الصنف وكمية استلامه ثم اضغط الزر. |
| «السطر رقم {0} به صنف مفقود من الفاتورة» | سطر غير متطابق معلَّم بـ*صنف مفقود من الفاتورة*: صنف على الفاتورة لم يحاسب عنه التسليم إطلاقاً. | إما أن تسجّل ما حدث لذلك الصنف، وإما أن تفعّل **الحفظ بالرغم من وجود أصناف مفقودة من الفاتورة** على الترويسة إن كان الغياب مقصوداً. |
