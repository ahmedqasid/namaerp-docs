...
الاعتماد لا شيئاً تضغطه. وللتراجع ألغِ المستند أو احذفه.
...
فقداً أو شطباً. وحين يصير الصنف في حالة *تم التخلص منه* فلا شيء يعيده إلى التداول إلا إلغاء
مستند التخلص أو حذفه.
...
إن حُرِّر مستند تخلص خطأً، فإلغاؤه أو حذفه يعكس القيد المحاسبي ويعيد استنتاج حالة الصنف من تاريخه هو:
