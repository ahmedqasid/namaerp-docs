...
## كيفية تعريف فلتر الحقل بالمعايير {#How-to-Define-a-Field-Filter-with-Criteria}
...
## مثال: فلترة الأصناف غير الخدمية في فاتورة المبيعات {#Example-Filter-Non-Service-Items-in-Sales-Invoice}
...
## مثال: فلتر ديناميكي باستخدام Tempo {#Example-Dynamic-Filter-Using-Tempo}
