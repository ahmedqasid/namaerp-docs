...
menu: الأساسيات ← الملفات ← سياسة الضريبة
---
...
وبنية الخصم ذات المستويات الثمانية والنموذج الضريبي الموحد وإعداد التأثيرات تغطي فيما بينها متطلبات الخصومات والضرائب المعقدة بالإعداد وحده، دون أن يكتب أحد لها كوداً.
