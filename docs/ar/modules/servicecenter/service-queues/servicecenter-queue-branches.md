...
التذكرة يدويا** لأي من نوعَي السحب، و**الحذف** للحذف — وإلا رُدَّ الإجراء برسالة
«المستخدم {0} ليس لديه صلاحية {1} للفرع {2}». وحين يبلّغك مشرف أن الزر «لا يفعل شيئاً» فذلك الجدول أول ما تنظر فيه.
