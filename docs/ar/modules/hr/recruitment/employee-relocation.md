...
|---|---|---|
| «لايمكن نقل الموظف الى شركة أخري  {0}» | **الشركة** في المحددات الجديدة تختلف عن شركة الموظف الحالية؛ وسند النقل لا ينقل إلا الفرع والإدارة والقطاع والمجموعة التحليلية. | أبقِ الشركة نفسها. فالانتقال الحقيقي بين الشركات علاقة عمل جديدة لا نقلًا. |
| «لايمكن تعديل هذا المستند تم عمل مستد بتاريخ بعده» | يوجد للموظف سند نقل آخر بتاريخ هذا المستند أو بعده، أو أن بياناته حُدِّثت فعلًا بعد ذلك التاريخ. | اعمل على أحدث مستند يخص الموظف؛ وألغِه أولًا إن كان لا بد من تعديل هذا الأسبق. |
| «ليس له عرض وظيفى {0}» | سند تحديث بيانات الموظف يسمّي موظفًا لا يوجد له عرض وظيفي مرحَّل أصلًا، فلا توجد حزمة أساس يعدّلها السند. | أنشئ العرض الوظيفي للموظف أولًا — فهو السجل الذي يعدّله سند التحديث. |
| «التاريخ الفعلي {0} يسبق التاريخ الفعلي {1} للعرض الوظيفي {2}» | التغيير مؤرَّخ قبل سريان العرض الوظيفي للموظف. | انقل التاريخ الفعلي إلى يوم العرض الوظيفي أو بعده. |
| «{1} السند {0} تم إنشاؤه في نفس التاريخ» | يوجد سند تحديث بيانات مرحَّل آخر لهذا الموظف بالتاريخ الفعلي نفسه، وخيار **السماح بأكثر من سند تحديث بيانات لنفس الموظف في نفس اليوم** غير مفعَّل في إعدادات الموارد البشرية. | ضع التغيير في السند القائم، أو استخدم تاريخًا فعليًا آخر، أو فعّل ذلك الخيار في الإعدادات. |
| «لا يمكن تحديث رصيد أجازات الموظف {0} من النوع {1} لان له مستند اجازة {2} متداخل مع التاريخ الفعلي {3} للمستند الحالي» | تغيير سطور الأجازات يعيد صياغة رصيد يسحب منه الموظف فعلًا: فهناك سند أجازة قائم يتقاطع مع التاريخ الفعلي لهذا المستند. ولا يظهر هذا إلا عند تفعيل خيار **اعتبار تغييرات الرصيد في عدة سندات تحديث داخل السنة** وعدم احتساب الأرصدة من تاريخ البداية. | أرّخ التغيير خارج الأجازة المسجَّلة، أو عدّل سند الأجازة أولًا. |
| «لا يمكن أن تكون الشركة عام» | في بيانات الحالة الجديدة بسند تحديث بيانات الموظف بقيت **الشركة** على القيمة المشتركة *عام* بدلًا من شركة محددة. | اختر شركة الموظف نفسها. |
| «الموظف {0} مكرر» | في سند تحديث بيانات موظف مجمع جُمِّع الموظف نفسه مرتين في جدول **بيانات الموظفين**. | احذف السطر المكرر؛ فكل موظف يولّد سند تحديث واحدًا. |
| «لا يمكن إضافة الموظف {0} إلى سطور مفردات الراتب، لأنه غير موجود في سطور معلومات الموظف» | سطر مفردات راتب في الدُّفعة يسمّي موظفًا ليس من الموظفين المجمَّعين. | جمّع ذلك الموظف في جدول بيانات الموظفين أولًا، أو اترك حقل الموظف في سطر المفرد فارغًا ليطبَّق على الجميع. |
| «لا يمكن إضافة الموظف {0} إلى سطور الأجازات، لأنه غير موجود في سطور معلومات الموظف» | القاعدة نفسها في جدول سطور الأجازات. | أضف الموظف إلى الدُّفعة، أو أفرغ حقل الموظف في ذلك السطر. |
| «يجب ملء دفتر وتوجيه سند تحديث بيانات الموظف في التوجيه {0}» | الدُّفعة تحاول توليد سندات تحديث بيانات الموظف المفردة، لكن توجيهها لا يحدد الدفتر والتوجيه الذي تُنشأ بهما. | املأ دفتر وتوجيه المستند المتولَّد في توجيه المستند المجمَّع ثم أعد الحفظ. |
