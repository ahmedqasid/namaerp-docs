...
![شاشة مستند نواقص طلبات العملاء في Nama ERP](images/sales-ops/customers-requests-shortage-ar.png)
...
![شاشة سند تحديث مندوب المبيعات في Nama ERP](images/sales-ops/salesman-update-document-ar.png)
...
![شاشة تحديد كميات الصنف للعميل في Nama ERP](images/sales-ops/limit-sales-qty-ar.png)
...
![شاشة مستند تعديل الخصومات في Nama ERP](images/sales-ops/discount-update-ar.png)
...
|---|---|---|
| «يجب ملئ مندوب المبيعات  أو المسئول عن العميل» | سطر في **مستند تعديل مندوب المبيعات** لا يذكر مندوبًا ولا مسؤولًا عن العميل، فالسطر لا يغيّر شيئًا. | املأ أحد الحقلين في ذلك السطر، أو احذفه. |
| «تم منع البيع للصنف {0}» | يوجد سطر محفوظ في **تحديد كميات البيع** يطابق سطر الفاتورة ومعلَّم فيه **منع البيع** — فالصنف ممنوع على ذلك العميل تمامًا بلا كمية يُتحاجَج فيها. والرفض يظهر على فاتورة المبيعات لا على هذه الشاشة. | ابحث عن سطر تحديد كميات البيع المطابق للعميل والصنف، وأزل علامة منع البيع أو ضيِّق نطاق السطر. |
| «هذا الصنف {0} قد بلغ الحد الأقصى {1} لهذا العميل {2} خلال الفترة من {3} إلى {4}» | العميل اشترى بالفعل الكمية المحددة من ذلك الصنف داخل إحدى الفترات المتحركة التي يعرّفها السطر. والرسالة تذكر الحد والفترة التي قيست عليها بالضبط، وبهما تعرف في أي فترة وقعت الفاتورة. | انتظر الفترة التالية، أو ارفع الحد في سطر تحديد كميات البيع، أو جزّئ الطلب. وطول الفترة يأتي من فترة السطر محسوبة من أول عملية بيع. |
| «السطر رقم {0} مكرر مع السطر رقم {1}» | سطران في **تحديد كميات البيع** يصفان التركيبة نفسها تمامًا — الصنف وتصنيفاته، والعميل وتصنيفه وفئته — فلا يستطيع النظام تحديد الحد المطبَّق. | ادمج السطرين؛ فالتركيبة الواحدة لا تظهر إلا مرة واحدة في المستند. |
