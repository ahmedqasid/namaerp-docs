...
menu: البنوك ← الملفات ← ورقة تجارية
---
...
![شاشة الورقة التجارية](images/cheques/financial-paper-ar.png)
...
![شاشة الحافظة البنكية](images/cheques/bank-portfolio-ar.png)
...
## تحريك الدورة من الورقة نفسها

لست مضطرًا لمغادرة شاشة **الورقة التجارية** والبحث عن الشاشة المناسبة. فمن على ورقة محفوظة، تفتح لك الأزرار التالية المستندَ التالي محمّلًا بهذه الورقة — قيمتها وتاريخ استحقاقها وحسابها البنكي والطرف المعني وسعر الصرف — كسجل جديد تكمله وتحفظه:

- **إنشاء حافظة بنكيه** (Create Bank Portfolio) — يودع هذه الورقة لدى البنك للتحصيل. الخطوة التالية المعتادة لشيك مقبوض.
- **إنشاء اشعار بنكي** (Create Bank Notice) — يسجّل حكم البنك عليها: تحصيل أو ارتداد.
- **إنشاء سند قبض** / **إنشاء سند صرف** (Create Receipt/Payment Voucher) — يحرّر السند الذي يقبض هذه الورقة أو يصرفها، حين تكون الورقة قد أُدخلت أولًا ولم يُكتب سندها بعد.
- **إنشاء إلغاء ورقه تجارية** (Create Commercial Paper Cancel) — يلغي الورقة.

وكل هذه الأزرار تحتاج أن تكون الورقة **محفوظة** أولًا؛ فعلى ورقة غير محفوظة لا يوجد بعدُ ما يشير إليه المستند الجديد.

وفي **دفتر الأوراق التجارية** زرٌّ إضافي:

- **انشاء أوراق تجارية** (Generate Cheques) — ينشئ أوراق الدفتر دفعةً واحدة بدل إدخالها ورقةً ورقة. املأ **عدد الشيكات** ومدخلات التكويد الآلي أولًا، وانتبه إلى أنه يعمل فقط مع دفتر **شيكات صادرة**: أما دفتر الكمبيالات أو دفتر الأوراق المقبوضة فلن يولّد شيئًا.
...
|---|---|---|
| «الورقة التجارية {0} مكرره في السطر رقم {1}» | الورقة التجارية نفسها مذكورة في سطرين من المستند. | احذف السطر المكرر؛ فالورقة تتحرك مرة واحدة في المستند. |
| «لا يمكن تغيير التاريخ الفعلي من {0} الي {1} بسبب وجود مدخل في الجدول النظامي للمستند {2} بتاريخ فعلي {3} وتاريخ إنشاء {4} , حدث هذا الخطأ في المستند {5}» | تغيير التاريخ الفعلي للمستند سيعيد ترتيب تاريخ حالات الورقة — فيصير القيد المذكور على الجانب الخطأ من هذا المستند. | اترك التاريخ الفعلي كما هو، أو فُكّ مستندات الحالة اللاحقة لتلك الورقة أولًا. |
| «يجب ان يقع الرقم {0} داخل النطاق {1} - {2}» | رقم الورقة خارج نطاق **أول رقم — آخر رقم** المعلَن في دفتر الأوراق التجارية. | استخدم رقمًا داخل نطاق الدفتر، أو وسّع النطاق في الدفتر. |
| «لا يمكنك تغيير دفتر الايصال {0} لان له ايصال {1} مستخدم في الورقة التجارية {2}» | يُستبدل **دفتر الإيصال** في دفتر أوراق تجارية وأحد إيصاله مرتبط بورقة بالفعل. | افصِل الإيصال عن الورقة، أو أبقِ الدفتر كما هو. |
| «دفتر الايصال {0} لا يمكن استخدامه مع دفاتر الاوراق التجارية» | دفتر الإيصال المختار ليس مرفوعًا عليه علم **يستخدم مع دفاتر الأوراق التجارية**. | ارفع العلم على دفتر الإيصال، أو اختر دفترًا مرفوعًا عليه. |
| «حالة الورقة التجارية يجب أن تكون فى حافظة او اجيو» | سطر في **الإشعار البنكي** يذكر ورقة مستلمة حالتها ليست **في حافظة** ولا **أجيو** ولا **مُظهَّرة** — فلا شيء يعمل عليه الإشعار. | أدخِل الورقة في حافظة (أو اخصمها) أولًا، ثم أصدِر الإشعار. |
| «الورقة التجارية لا بد ان تكون مرفوضة مؤقتا» | سطر في **مستند إلغاء ورقة تجارية** يذكر ورقة حالتها ليست من: مُصدَرة، مُظهَّرة، مرفوضة مؤقتًا، مستلمة — فلا تُلغى إلغاءً كاملًا. | راجِع حالة الورقة الحالية؛ فالورقة المحصَّلة أو الملغاة سابقًا لا تُلغى من هنا. (النصّ العربي لهذه الرسالة يذكر حالة الرفض المؤقت وحدها.) |
