...
::: tip الأرقام هنا بالمليمتر، وشاشات Nama ليست كذلك
عروض البكرات ومقاسات الشيت مذكورة بالمليمتر في هذه النظرة العامة، لأن هذا هو عرف المهنة في الحديث عنها. أما شاشات الكرتون في Nama فتعمل بـ**السنتيمتر** — فبكرة 2,000 مم تُسجَّل `200`، وشيت 520 × 440 مم يُسجَّل `52` × `44`. والخطأ في ذلك أشيع أسباب عدم إيجاد الخطة حلًّا؛ والتفصيل في [تخطيط خامات الكرتون](/ar/modules/manufacturing/carton-material-planning).
:::
