...
| **نظام إدارة قواعد البيانات** | SQL Server 2016 (إصدار Standard أو Developer أو Enterprise)                                                                                                                                            | SQL Server 2022 أو أحدث                                              |
...
ويفحص برنامج التركيب خادم قاعدة البيانات قبل أن يكتب شيئاً، ويتوقف في حالتين: إصدار SQL Server أقدم من **2016** (الإصدار الرئيسي 13)، وإصدار **Express** أياً كانت سنته. فإصدار Express مرفوض تماماً — ركّب Standard أو Developer أو Enterprise.
