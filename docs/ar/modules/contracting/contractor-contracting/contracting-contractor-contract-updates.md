...
|---|---|
| لا يوجد مستند تعديل **لاحق** على عقد الباطن نفسه. تُقارن التواريخ الفعلية، وفي مستندات اليوم نفسه ترتيب الإنشاء. | «لا يمكن تعديل المستند {0} في التاريخ {1} بسبب مستند تعديل المشروع {2}» |
| لا يُستبدل العقد بعد حفظ المستند. | *Cannot change contract from {0} to {1} in document {2}* — وهذه الرسالة لا نص عربي لها، فتظهر بالإنجليزية على الشاشات العربية |
| كود البند نفسه لا يتكرر بنوع التعديل نفسه. | «كود البند {0} بنوع التعديل {1} مكرر في السطر {2} و {3}» |
| **إضافة بعد** إجباري في أي سطر نوعه *إضافة*. | العمود إجباري |
| سطر *إضافة* أو *تعديل* أو *حذف* لا بد أن يطابق كوداً موجوداً في الصورة المحفوظة. | «لا يوجد بند بالكود {0}» |
| حذف مستند التعديل مرفوض ما دام هناك تعديل لاحق على العقد. | «لا يمكن حذف المستند {0} بسبب مستند التعديل {1}» |
