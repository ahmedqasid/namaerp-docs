...
- إذا ألغيت سند تحصيل، تراجعت أرقام العقد من تلقاء نفسها، لأن القيود تُحذف وتُعاد الخلاصة من دونها.
- وإذا ألغيته ثم أدخلته من جديد، لم ينحرف شيء، فالأرقام مشتقّة لا تراكمية.
