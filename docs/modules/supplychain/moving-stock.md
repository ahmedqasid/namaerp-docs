...
### IssueStockTransfer - إرسال الأصناف
...
### ReceiptStockTransfer - استلام الأصناف
...
## عمليات التجميع: تحويل المخزون

أحياناً تحريك المخزون ينطوي على تغييره. هنا يأتي دور **التجميع**.

### AssemblyDocument - البناء من المكونات
...
### AssemblyRequest - تخطيط التجميعات
...
## الحجوزات: إبقاء المخزون في مكانه

**الحجز** لا يحرّك الأصناف فعلياً، لكنه يغير حالتها من "متاح" إلى "محجوز".

### ReservationDocument - تخصيص المخزون
...
### ReservationCancellationDoc - تحرير المخزون
...
## التحميل والتسليم: الرحلة الفعلية

المرحلة الأخيرة من الحركة الداخلية هي تحضير الأصناف للمغادرة.

### LoadingDocument - التجهيز للشحن
...
## إعادة تقييم التكلفة: القيمة دون حركة
...
## نصائح لتتبع دقيق لحركات المخزون
