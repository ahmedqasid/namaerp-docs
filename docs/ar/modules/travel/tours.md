...
|---|---|---|
| «(Tpl * 3) + (Dbl * 2 ) + Sgl عدد الأفراد {0} يجب ان يساوى مجموع توزيعات الافراد {1} طبقاً للمعادلة» | عدد الأفراد في الرأس لا يطابق توزيع الغرف: الثلاثية في 3، زائد المزدوجة في 2، زائد الفردية. | صحّح عدد الأفراد أو خانات TPL و DBL و SGL حتى يتساويا. |
| «لا يمكن ان يكون تاريخ القيام {0} قبل تاريخ الوصول {1}» | تاريخ قيام الرحلة قبل تاريخ وصولها. | صحّح تاريخي الرأس؛ فكل قواعد التواريخ تُقاس على هذه النافذة. |
| «تاريخ قيام الرحلة {0} يجب ان يكون فى الفترة بين {1} و {2}» | تاريخ قيام الرحلة الجوية في الرأس خارج نافذة الوصول والقيام. | انقل التاريخ داخل النافذة، أو وسّع النافذة إن كانت الرحلة أطول فعلاً. |
| «تاريخ وصول الرحلة {0} يجب ان يكون فى الفترة بين {1} و {2}» | تاريخ وصول الرحلة الجوية في الرأس خارج نافذة الوصول والقيام. | كما سبق. |
| «تاريخ الدخول {0} يجب ان يكون فى الفترة بين {1} و {2}» | تاريخ الدخول في سطر إقامة خارج نافذة الرحلة، والسطر المخالف مميَّز. | صحّح السطر، أو تاريخي الرأس. |
| «تاريخ الخروج {0} يجب ان يكون فى الفترة بين {1} و {2}» | تاريخ الخروج في سطر إقامة خارج نافذة الرحلة — وغالباً إقامة تمتد يوماً بعد تاريخ القيام. | صحّح السطر، أو مدّد تاريخ القيام. |
| «التاريخ {0} يجب ان يكون فى الفترة بين {1} و {2}» | سطر في جدول الخدمات أو في جدول الرحلات الجوية يحمل تاريخاً خارج نافذة الرحلة. | راجع الجدولين — فالنص نفسه يُستعمل لكليهما، فاقرأ السطر المميَّز. |
| «مستند الرحلة السياحية {0} يجب ان يحتوي على توجيه» | ضُغط زر *إنشاء أوامر الشراء* على رحلة بلا توجيه مستند، فلا شيء يحدد الدفاتر والتوجيهات التي تُنشأ فيها الأوامر. | اضبط التوجيه على الرحلة، واملأ أزواج الدفتر والتوجيه في [توجيه الرحلة السياحية](./travel-document-terms) قبل الضغط على الزر مرة أخرى. |

وقواعد التواريخ لا تعمل إلا بعد ملء تاريخي الرأس معاً، فالرحلة التي أحد تاريخيها فارغ تمرّ منها كلها.
