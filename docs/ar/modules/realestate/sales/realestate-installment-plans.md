...
**ابنِ الخطة قبل أن تحصّل أي مبلغ.** وبعد أن يبدأ التحصيل عامل الجدول كأنه مغلق: فإن أسقطت إعادةُ البناء سطراً سبق سداده، سيرفض العقد الاعتماد برسالة *«{0}  لا يمكن حذف او تعديل كود القسط لسطر قسط مدفوع مسبقا»* — أي أن التحصيل نفسه في مأمن، لكن الجدول الذي كنت تعمل عليه ضاع ويحتاج إعادة بناء يدوية.
