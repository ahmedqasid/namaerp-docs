---
menu: إعدادات الوحدات ← إعدادات الحسابات
---
...
أما المحددات الخمسة نفسها — والمحدد المركب — فتجدها في [المحددات والمحددات المركبة](/ar/platform/dimensions-and-composite-dimensions).
...
كل خيار منها يوقف الفحص لنوع مستند كامل — لكل المستخدمين، ولكل الحسابات، وفي كل التواريخ — فهو أعمّ الطرق الثلاث لفتح حساب نظامي. والأولى أن تستعمل بدلًا منه سجل استثناء مؤرَّخًا؛ والطريقان معًا، وأعلام الحساب التي وراءهما، في [الحسابات النظامية واستثناءات الحركة عليها](../system-accounts-and-exceptions.md).
