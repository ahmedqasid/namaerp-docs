...
- **أختام المراجع في تبويب الإحصائيات.** السيارة المرتجعة ما زالت تعرض فاتورة المبيعات القديمة وأمر
  البيع القديم وتاريخ التسليم القديم. فهذه الأختام لا تُمسح إلا عند إلغاء المستند *الأصلي* أو حذفه،
...
وليس هناك كذلك **مستند إلغاء لمردود المبيعات**. فإن كان المردود نفسه خاطئاً، فاحذفه أو ألغِه —
وهذا هو ما يزيل إذن الإضافة المُنشأ عنه وقيده في الأستاذ.
