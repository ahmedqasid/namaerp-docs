...
- **إذا طابقت الشرائح دون أن تغطي المدة كلها**، يُرفض الحفظ برسالة
«لم نستطع إيجاد اسعار مناسبة ل {0} ساعات, الاصل التاجيري {1} - الساعات المتبقية : {2}» — أو، حين يكون التسعير باليوم،
«لم نستطع إيجاد اسعار مناسبة ل {0} أيام، الاصل التاجيري {1} - الأيام المتبقية : {2}» — إلا إذا كان خيار *تجاهل قوائم الأسعار للأصل التأجيري* مفعّلاً.
...
المسمّى يعد بما لا يفعله الخيار. أثره **الوحيد** هو كتم رسالة الرفض
«لم نستطع إيجاد اسعار مناسبة ل {0} ساعات, الاصل التاجيري {1} - الساعات المتبقية : {2}» حين لا تغطي شرائح الأسعار مدة الحجز كاملة؛ أما التحقق العادي من قوائم أسعار المبيعات فيظل يعمل على السطور المُنشأة كما هو.
