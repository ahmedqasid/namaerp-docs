...
لا واحدة من هذه الثلاث لها نص عربي في المنتج، فتظهر بالإنجليزية على الشاشات العربية أيضًا.

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| *Default Menu Cant Be The Target* | **القائمة المستهدفة** هي القائمة الجاهزة ذات الكود `default`. وهي القائمة الوحيدة التي لا يجوز أن تكون هدفًا أبدًا — وحمايتها هي سبب وجود هذه الشاشة. | اجعل الهدف قائمة من عندك، واستعمل القائمة الجاهزة **قائمة المصدر**. |
| *Target Menu Cant Be The Same As Source Menu* | **قائمة المصدر** و**القائمة المستهدفة** تسمّيان السجل نفسه، فتكون إعادة البناء قد كتبت فوق القائمة التي تقرأ منها. | اجعل الهدف سجل قائمة منفصلًا. |
| *There is another menu modifier {0} for the same target menu {1}* | يوجد تعديل قائمة آخر غير معلَّم بغير نشط ويستهدف القائمة نفسها. وكل منهما يعيد بناء الهدف من مصدره، فيغلب آخر حفظ. | اجمع كل التغييرات في سجل واحد، أو علّم الآخر **غير نشط** — والرسالة تسمّيه ويمكنك فتحه من الرفض مباشرة. |

وقد يأتي الرفض من **القائمة المستهدفة** لا من هذه الشاشة. فحفظ تعديل القائمة يعيد بناء الهدف ويعتمده، فقد ترفض قواعد القائمة المستهدفة مجموعةً أو وصلةً أنتجتها سطورك — والرسائل ومعانيها في
[كيف تُبنى القائمة](/ar/platform/menus/menu-structure#rsyl-qd-tZhr-lk).
