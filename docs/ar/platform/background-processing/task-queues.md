...
- حفظ طابور مهام أو مسار كيان يجعل النظام يعيد قراءة الصورة ويعيد تسجيل مسارات مسارات الكيانات، فيبدأ
  الطابور الجديد في حمل المسارات المؤجلة فورًا.
- أما جانب **المجدوِل** فيُقرأ عند بدء تشغيل الخادم. فنقل جدولة مهام إلى طابور آخر يُحفظ فورًا، لكنه
  لا يأخذ مساره الجديد إلا عند إعادة تشغيل الخادم التالية.
