...
::: tip يمكن تشغيل المسار من خارج النظام أيضًا
ليس كل مُشغِّل شخصًا ينقر زرًا. فنقطة **المُكامِل** المسجَّلة في [أعدادات الحقول و الشاشات](/ar/platform/fields-and-entities-settings/fields-settings-integrations) تمنح نظامًا خارجيًا عنوانًا يستدعيه، وما يصل إلى ذلك العنوان يُسلَّم إلى مسار كيان يقرر ما يفعله به. وبهذا يغذّي متجر إلكتروني أو بوابة دفع أو نظام مورّد بياناتِه إلى Nama مباشرة دون أن يجلس أحد أمام شاشة.
:::
...
| الحقل | ماذا يفعل |
|---|---|
| **طابور المهام** | المسار الذي يُعالَج فيه المسار المؤجل. المسارات على طوابير مختلفة تُعالَج في نفس الوقت، والمسارات التي تتشارك طابورًا تُعالَج واحدًا تلو الآخر بترتيب رفعها. وإذا تُرك فارغًا انضم المسار إلى المسار الافتراضي مع بقية المسارات غير المخصصة. انظر [طوابير المهام](/ar/platform/background-processing/task-queues). |
...
::: warning خمسة أحداث فقط تقبل التأجيل
...
> الأوبشن ( يعمل بعد حفظ المستند نهائيا و التأثير على قاعدة البيانات ) لا يعمل مع الإجراء {0}
...
::: warning اعتبار الموافقات يحتاج إلى خيار الحفظ
