...
تتولى صفحة **تجميد عقد** تعليق الخدمة: منتج، وتاريخ بداية تجميد، وتاريخ نهايته. وهي من أحسن أجزاء الشاشة سلوكاً — فهي ترفض منتجاً ليس على العقد (*You can not freeze product {0} because it does not exist in contract* — ولا ترجمة عربية لها فتظهر بالإنجليزية)، وتجمع أيام التجميد لكل منتج وتدفع عمود **إلى** المحسوب في ذلك السطر بالعدد نفسه.
