...
menu: العقارات و الممتلكات ← الإعدادات ← إعدادات الاستثمار العقاري
---
...
يوجد سجلّ إعدادات عقارات **واحد فقط**، وهو يسري على كل شيء. فكل سجل إعدادات نظام في نما سجل عام واحد لقاعدة البيانات كلها؛ ومجموعة الإعدادات والنوع والمحددات في ترويسته بقايا تصميم لإعدادات لكل شركة لم يُعتمد، ولذلك سيُتجاهَل أي سجلّ ثانٍ أضيق. **اضبطه مرة واحدة؛ ولا يوجد تخصيص لكل شركة.**
...
هذا الحقل هو سماحية ذلك التدقيق، وهو يُشحن بقيمة **0.05**، فيمرّ فرق القرش في صمت. ارفعه إذا كانت قواعد التقريب لديك أخشن، واضبطه على **0** ليصبح التدقيق تامًّا — عندئذ يفشل العقد أعلاه برسالة *«{1} إجمالى الاقساط {0} لايساوى المتبقى»* حتى يعدّل أحدهم سطرًا إلى 128,571.42.
