...
**HMSPharmacyInvoice** (Pharmacy Invoice): Dispensing medications to patients
...
**HMSPharmacyReturn** (Pharmacy Return): Unused medications returned
...
**HMSBloodBankInvoice** (Blood Bank Invoice): Issuing blood products
...
**HMSBloodBankReturn** (Blood Bank Return): Unused units returned
...
**HMSSuppliesInvoice** (Supplies Invoice): Issuing supplies
...
**HMSSupplyReturn** (Supply Return): Unused supplies returned
...
**NamaPOSSalesInvoice** (POS Sales Invoice): Retail sales
...
**NamaPOSSalesReturn** (POS Sales Return): Retail returns
...
**NamaPOSOrderReservation** (POS Order Reservation): Customer orders
...
**NamaPOSStockReceipt** (POS Stock Receipt): Store receiving
...
**GlassJobOrder** (Glass Job Order): Custom glass cutting/fabrication
...
**JOSalesQuotation** (Job Order Sales Quotation): Custom quotations
- Each job is unique
...
**ProcessingDoc** (Processing Document): Item processing
...
**Tender** (Tender): Tender management
- Government or corporate tenders
- Bid preparation
- Pricing strategy
- Compliance documentation

**FinishedProductPricing** (Finished Product Pricing): Cost-plus pricing
- Calculate product cost (materials + labor + overhead)
- Apply margin
- Set sales prices
- Update price lists
...
**WeightScalePreparationDoc** (Weight Scale Preparation Document): Bulk receiving/shipping
