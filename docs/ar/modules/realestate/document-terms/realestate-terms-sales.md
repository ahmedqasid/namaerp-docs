...
| مدين ضريبة 1 / دائن ضريبة 1 | ضريبة 1 على سطور الأقساط |
| مدين ضريبة 2 / دائن ضريبة 2 | ضريبة 2 على سطور الأقساط |
...
| حساب وديعة الصيانة من السطور | يغيّر مصدر إجمالي وديعة الصيانة. عند التفعيل: يُجمَع من سطور أقساط تكلفة الصيانة، ويُصفَّر حقل النسبة. وعند التعطيل: يُجمَع من سطور إنشاء الأقساط. والاختلاف بين الاثنين هو ما ينتج رسالة «إجمالي تكاليف الصيانة {0} لا تساوي تكاليف الصيانة {1}». |
...
3. وحين يُرحَّل مستند التسليم في سبتمبر يُنشأ قيد العقد المكبوح في تلك اللحظة. وإلغاء مستند التسليم أو حذفه
   يعكسه من جديد.
...
لكن تاريخه سابق لبدء التشغيل. وينفرد بخيار واحد:

| الخيار | ما يفعله |
|---|---|
| السماح بفترات محاسبيه غير افتتاحيه في عقد البيع الإفتتاحي | معطّل افتراضياً: فيرفض المستند الترحيل خارج فترة مالية افتتاحية برسالة *«نوع الفترة المحاسبية لا بد ان تكون افتتاحية»*. لا تفعّله إلا حين تضطر فعلاً إلى إدخال أرصدة افتتاحية في فترة عادية. |
