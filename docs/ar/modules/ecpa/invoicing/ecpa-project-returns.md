...
menu: ECPA ← الفاتورة ← مردود فاتورة المشاريع
---
...
1. **إلغاء الفاتورة الأصلية.** إلغاء الفاتورة يعكس تأثيرها المحاسبي ويزيل الوسم عن كل
   سطر مصدر استهلكته، فيعود العمل إلى المجموعة القابلة للفوترة. عندها تصحح الفاتورة وتصدرها من جديد
...
باختصار: استخدم المردود حين يجب أن تعود النقود إلى العميل فعلاً، وألغِ الفاتورة حين تكون
...
5. تبقى ساعات سارة الاثنتا عشرة موسومة بأنها فُوتِرت، فتخرج من مجموعة العمل القابل للفوترة نهائياً
   ما لم يُلغِ أحد الفاتورة الأصلية أو يحذفها — وهو ما لا ينبغي لأحد فعله بعد اعتماد المردود.
