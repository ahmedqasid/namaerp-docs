...
menu: مركز خدمة ← المستندات ← إغلاق أمر شغل
---
...
ويُرحَّل الصرف المخزني تلقائياً، ويُعاد توليده كلما أُعيد حفظ الإغلاق، ويُزال إذا أُلغي الإغلاق أو حُذف. وتحمل
...
|---|---|---|
| «أمر الشغل {0} مغلق بالفعل» | إغلاق ثانٍ يُصدَر لأمر شغل مغلق بالفعل. فإغلاق واحد لكل أمر. | ابحث عن الإغلاق الموجود من المستندات المرتبطة بأمر الشغل. وإن كان خطأً فألغه وأصدر غيره. |
| «لا يمكن اغلاق أمر الشغل {0} لان حالته {1}» | حالة الأمر *ملغي* أو *معلق* أو *موقوف*. | أعد الأمر إلى حالة عمل، أو فعّل **السماح باغلاق الاوامر المعلقة** على توجيه مستند الإغلاق. |
| «لا يمكن أغلاق أمر الشغل {0} لوجود مهمة {1} غير منتهيه للفنى {2}.» | سطر تنفيذ على هذا الأمر ينقصه وقت البداية أو النهاية، وخيار **منع إغلاق أمر الشغل في حالة وجود مهام غير منتهية** مفعّل في إعدادات مركز الخدمة — وهو مفعّل افتراضياً. | اجعل الفني يُكمل ورقة وقته على سطر التنفيذ ذاك. وتُرفع رسالة لكل سطر غير منتهٍ. |
| «لا يمكن غلق أمرالإنتاج {0} لأن كمية الصنف {1} تساوي {2} والكمية المصروفة {3}» | توجيه الإغلاق مفعَّل فيه **منع إغلاق أمر الشغل إذا لم يتم صرف الخامات بالكامل**، وقطعة غيار صُرف منها أقل من الكمية المخططة. والكميات تُجمَّع لكل صنف على مستوى الأمر كله. | اصرف باقي الخامة، أو أنقص الكمية المخططة على أمر الشغل، أو أزل تفعيل الخيار من التوجيه. |

## التراجع عن الإغلاق

الإغلاق مستند عادي: ألغِه أو احذفه فتنفكّ آثاره. فيختفي قيد الحالة، فتُعاد حالة أمر الشغل مما
