...
menu: الحسابات ← الإعدادات ← توزيع حسابات
---

# المحدِّدات ومراكز التكلفة والتوزيع

يجيب الحسابُ عن «ماذا» — نقدية، مبيعات، رواتب. أمّا **المحدِّدات** فتجيب عمّا سوى ذلك: *أيُّ* فرع، *أيُّ* إدارة، *أيُّ* مركز تكلفة، *أيُّ* مشروع. إنّها الإحداثيات الإضافية التي يحملها كلُّ سطرٍ في دفتر الأستاذ، وهي ما يحوّل ميزان مراجعةٍ مسطّحًا إلى تقاريرَ تقطّعها حسب الفرع، أو القطاع، أو مركز التكلفة. تشرح هذه الصفحة مجموعة المحدِّدات كما يراها دفتر الأستاذ، وكيف يمكن للحسابات أن تقيّد المحدِّدات التي تقبلها، وكيف يوزّع **توزيع الحسابات** قيمةً عليها تلقائيًا. أمّا الملفات الرئيسية الخمسة نفسها — أين يُنشأ الفرع أو مركز التكلفة، والمحدد المركب الذي ينوب عن عدة محددات — فتجدها في [المحددات والمحددات المركبة](/ar/platform/dimensions-and-composite-dimensions).
