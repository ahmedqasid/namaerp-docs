---
entities: [RESalesDoc]
menu: العقارات و الممتلكات ← مبيعات ← عقد بيع
---
...
2. **يُغلق الحجز.** مستند الحجز المرتبط يتحول إلى «مباع»، والعقد المبدئي المرتبط يُختم بأنه بِيع ويُشار منه إلى هذا العقد. وإلغاء العقد أو حذفه يعيد الحجز إلى «مؤكد».
...
| ضريبة 1 وضريبة 2 على كل سطر قسط | زوجا *مدين ضريبة 1* / *دائن ضريبة 1* و*مدين ضريبة 2* / *دائن ضريبة 2* |
...
يحسب جدول الأقساط ضريبة 1 وضريبة 2 لكل سطر من السياسة الضريبية — والنسب تأتي من جدول السياسة الضريبية الخاص بالتوجيه، أو من [إعدادات وحدة العقارات](/ar/modules/realestate/realestate-configuration.md) إذا كان جدول التوجيه فارغاً. وتصل هذه القيم إلى القيد عبر مجموعة **الضرائب** في التوجيه، وتُقيَّد **لكل سطر قسط على حدة**: فتنتج ضريبة كل سطر مديناً ودائناً خاصين بها يحملان بيانات مرجع ذلك القسط، لا مبلغاً واحداً مجمّعاً للعقد.

ومما يجدر معرفته حين يغيب سطر ضريبة متوقَّع: توجيه البيع هو الموضع **الوحيد** الذي يُبحث فيه عن الحسابات. وهذا يختلف عن سند التحصيل، حيث يجرّب النظام نوع المصروف ثم الوحدة ثم نموذج الوحدة قبل أن يرجع إلى التوجيه. فالحسابات المعرَّفة على الفيلا B-12 نفسها أو على نموذج وحدتها لا يقرأها العقد إطلاقاً — وإذا كان الزوج في التوجيه نصف معرَّف أو فارغاً غابت الضريبة بصمت.

والضريبة المعلَّمة كاستقطاع تُحفظ بقيمة سالبة على السطر وتُقيَّد كما هي، فتُقرأ تلك السطور بإشارات سالبة على الجانبين بدل أن يتبادل المدين والدائن موضعيهما.
...
- **لا يمكن حذف سطر مسدَّد ولا تغيير كوده.** فبمجرد أن يُحصَّل القسط أو يُطلب تحصيله أو تُغطّيه ورقة تجارية يُجمَّد كوده ولا يمكن أن يختفي السطر، وتظهر الرسالة *«{0}  لا يمكن حذف او تعديل كود القسط لسطر قسط مدفوع مسبقا»*. وهذه هي الحماية من إعادة بناء الجدول بالخطأ.
- **كود القسط فريد** داخل العقد، ويُولَّد آلياً ما لم يكن خيار *تكويد يدوي* مفعّلاً في التوجيه.
- **الحجز يجب أن يكون متسقاً.** فإذا كان على العقار مستند حجز ولم يرتبط به هذا العقد، يفشل الاعتماد برسالة *«العقار {0} له مستند حجز مسبق»*.
...
- **العقد المتنازل عنه مجمَّد.** فبعد صدور سند تنازل عليه تظهر رسالة *«لا يمكن تعديل هذا العقد لانه يوجد سند تنازل ملكيه{0} عليه»*. وأي تغيير مطلوب بعدها يتم على سند التنازل لا على العقد.
