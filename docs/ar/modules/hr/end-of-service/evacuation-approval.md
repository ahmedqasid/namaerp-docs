...
|---|---|---|
| «من فضلك قم بتعريف خطوة واحدة مطلوبة علي الأقل» | كل صفوف جدول **الخطوات** في الإعدادات معلَّمة **خطوة اختيارية**، فيصبح إخلاء الطرف بأكمله قابلًا للتخطي. | أزل التعليم عن **خطوة اختيارية** في صف واحد على الأقل — الخطوة التي لا يجوز لأي مغادر تخطّيها. |
| «لا توجد خطوات موافقة اخلاء طرف لهذا المستند» | تُوقَّع الموافقة على سند إخلاء طرف لا تحمل **إعدادات الموافقة** فيه، أو إعداداته بلا خطوات أصلًا. | وجّه إخلاء الطرف إلى سجل إعدادات فيه خطوات معرَّفة، وعرّفها فيه أولًا. |
| «كود خطوة غير صحيح» | **كود الخٌطوة** في الموافقة لا يطابق أي خطوة في الإعدادات التي يستخدمها إخلاء الطرف. | اختر الكود من جدول الخطوات في الإعدادات؛ فالأكواد خاصة بكل سجل إعدادات لا عامة. |
| «حالة الخطوه{0}» | نقلت الموافقة إلى خطوة سبق اعتمادها في إخلاء الطرف هذا، فتوقيعها مرة أخرى يلغي قرارًا قائمًا. | اختر خطوة ما زالت معلَّقة، أو عدّل مستند الموافقة الذي وقّع تلك الخطوة. |
| «الخطوة {0} تتطلب تنفيذ للخطوة {1} اولا» | الخطوة معلَّمة **تتطلب تنفيذ الخطوات السابقة أولا** والخطوات المذكورة في الرسالة ما زالت في حالة *مبدئي* — أي أن سلسلة الاعتماد لم تصل إلى هذه الخطوة. | اعتمد الخطوات المذكورة أولًا؛ فالرسالة تسمّي المتأخر منها بالتحديد. |
