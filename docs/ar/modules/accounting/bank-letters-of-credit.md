...
menu: البنوك ← اعتماد بنكى ← اعتماد بنكى
---

# الاعتمادات المستندية البنكية
...
![شاشة الاعتماد البنكي](images/lc/bank-lc-ar.png)
...
![شاشة فتح الاعتماد البنكي](images/lc/blc-opening-ar.png)
...
كما في خطابات الضمان، يحمل الطلب الزرّين اللذين يبنيان بقية السلسلة:

- **إنشاء اعتماد بنكى** (Create Bank LC) — يحوّل الطلب المعتمد إلى الملف الرئيسي للاعتماد، ناقلًا نوعه وقيمته والبنك والحساب البنكي والتواريخ والمبلغ المغطّى والتسهيلات والمصروفات، ويفتحه كسجل جديد لتراجعه وتحفظه.
- **إنشاء فتح اعتماد بنكى** (Create Bank LC Opening Document) — يفتح مستند **فتح الاعتماد** مباشرة، مملوءًا من حساب الطلب وبنكه وحسابه البنكي. استعمله لحظة فتح البنك للاعتماد فعلًا، فيُثبت الأثر ويُحجز التسهيل في خطوة واحدة.

ويحتاج الزرّان أن يكون الطلب **محفوظًا** أولًا.
