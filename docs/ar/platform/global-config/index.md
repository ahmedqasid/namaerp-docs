...
::: info أين تجدها
افتح **إدارة النظام ← الإعدادات ← إعدادات النظام** واختر ملف **الإعدادات العامة** (كوده `global`). الخيارات موزّعة على صفحات حسب الموضوع، ولكل صفحة صفحة مرجعية أدناه.
:::
...
ثلاثة إعدادات تقع في مستوى أمان محمي و**لا يمكن تفعيلها من جلسة عادية أصلاً**: الخياران اللذان يسمحان بإعادة معالجة طلبات الأعمال المؤرخة قبل قيد الإقفال، وخيار *عدم التحقق من وجود نسخة احتياطية*. فالحفظ وأحدها معلَّم حديثاً يُرفض — *«انت لا تمتلك صلاحية التعديل على الحقل … لأنه ينتمى لمستوى الأمان L2Dangerous برجاء التواصل مع الدعم الفنى»* — ولا يتمه إلا جلسة دعم من نما. أما إعادة إطفائها فغير محجوبة. وبعضها الآخر قرارات تُتخذ عند التركيب فعلياً: فسياسة تكلفة الصرف موجودة في إعدادات سلسلة التوريد، لكن **حدود التقريب** و**نموذج حساب الضريبة** في هذه الصفحات لا تقل خطورة، لأن تغييرها يغيّر حسابات مستندات موجودة بالفعل. اقرأ ملاحظات كل خيار قبل تغييره على قاعدة بيانات حية.
:::
