...
والملفات الرئيسية الخمسة نفسها تجدها في [المحددات والمحددات المركبة](/ar/platform/dimensions-and-composite-dimensions). وتحدد هذه الصفحة أي هذه المحددات تستعمله تركيبتك فعلاً، ومدى صرامة النظام في التحقق من اتساق محددات المستند مع بعضها، وكيف تنعكس المحددات على أكواد الحسابات.
