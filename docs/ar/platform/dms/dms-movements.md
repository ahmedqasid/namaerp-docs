...
menu: الأساسيات ← إدارة المستندات ← حركة المستند
---
...
المقصودة. والمجموعتان متنافيتان: فالتي لا تنطبق تظهر معطّلة.

![حركة نقل، وفيها مجموعة «تفاصيل النقل» ممتلئة ومجموعة «تفاصيل الخروج» معطّلة](images/dms-doc-movement-transfer-ar.png)
