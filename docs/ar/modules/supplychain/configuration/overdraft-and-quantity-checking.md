...
**عدد الحركات اللاحقة التي يجب التأكد منها** `value.checkOverdraftNextTransCount` *(القيمة الافتراضية 10)* — يظهر الخيار على الشاشة في صيغة سؤال: «عدد الحركات اللاحقة للسند التي يجب التاكد من انها لم تصبح مكشوفة»، فابحث بهذه الصياغة إن كنت تفتّش عنه في التبويب. بعد التأكد من المستند الحالي، يعيد النظام أيضًا التحقق من هذا العدد من الحركات *اللاحقة* للصنف للتأكد من أن إدراج/تعديل هذا المستند لا يدفع مستندًا مستقبليًا إلى السالب. زده لضمانات أكثر صرامة على البيانات المؤرخة بتاريخ سابق بكثرة؛ واضبطه على 0 لتعطيل النظر إلى الأمام.
...
**تفعيل التحقق من كمية الحجز بالتاريخ للمخازن / للمواقع** `value.enableIgnoreInReservationQtyCheckByDateForWarehouses` / `value.enableIgnoreInReservationQtyCheckByDateForLocators` — اقرأ التسمية بتمعّن: تقول «تفعيل التحقق»، بينما الذي تفعّله في الحقيقة هو إمكانية *تخطّي* التحقق. فهذان هما المفتاحان الرئيسيان اللذان يتيحان استثناء مخازن أو مواقع **بعينها** من تأكد الحجز بالتاريخ — تفعّل المفتاح هنا، ثم تضع العلامة المقابلة على المخزن أو الموقع نفسه. استخدمها عندما يجب ألا تُحسب بعض المواقع — الحجر، الترانزيت، ساحة التوالف — ضمن المتاح للحجز. راجع الدليل المخصص [تجاهل مخازن/مواقع بعينها في التأكد من كمية الحجز بالتاريخ](../ignore-reservation-qty-check-by-date.md).
...
|---|---|---|
| «الكمية من الصنف {0} {1} لا تكفي. الكمية المتاحه {2} . الكميه المحجوزه {3}» | فحص الرصيد الفوري: السطر يصرف أكثر مما هو موجود الآن بعد استبعاد المحجوز. | أنقص الكمية، أو استلم المخزون أولاً، أو اسمح بالسحب على المكشوف للصنف أو لقسمه أو لسطر المحددات. |
| «الكمية من الصنف {0} {1} لا تكفي , الكمية المتاحة في تاريخ {2} - الساعة {3} كانت: {4}» | الفحص بالتاريخ: الرصيد لم يكن كافياً **في تلك اللحظة من الماضي** وإن كان كافياً اليوم. والرسالة تذكر التاريخ والساعة والرصيد كما كان. | راجع تاريخ المستند. إما أن تنقله إلى ما بعد الاستلام، أو توقف الفحص بالتاريخ لهذه الحالة. |
| «الكمية من الصنف {0} {1} لا تكفي , الكمية المتاحة في تاريخ {2} - الساعة {3} كانت: {4}  المستند {5} سيؤدي الي كميات مكشوفة» | الفحص بالتاريخ نفسه، لكن السالب يظهر على مستند **لاحق** — هو المسمّى في الرسالة — لا على المستند الذي تحفظه. | انظر إلى المستند المسمّى. فإدخال حركات مخزنية في الماضي هو ما يدفع مستنداً لاحقاً إلى السالب. |
| «الكمية من الصنف {0} {1} لا تكفي. الكمية المحجوزة {2}» | الكمية موجودة لكنها محجوزة لغير هذا المستند. | أفرج عن الحجز، أو اصرف من غير المحجوز. |
| «لا يمكن حفظ المستند {0} في التاريخ {1} لوجود عدد مستندات {2} لم تتم معالجة تكاليفهم» | حارس التراكم الموصوف أعلاه: المستند أقدم من **أقصى عدد أيام** *و* عدد المستندات المخزنية المنتظرة لمعالجة التكلفة يتجاوز **أقصى عدد مستندات غير معالجة**. | دع التراكم ينحسر، أو احفظ المستند بتاريخ اليوم. ولا يعمل هذا الحارس أصلاً إلا إذا مُلئ الإعدادان معاً. |
| «رصيد بالسالب للصنف {0} - كمية {1} في التاريخ {2}» | جرت محاولة إنشاء قيد إقفال وصنف رصيده سالب في نهاية الفترة، بينما **السماح بإنشاء قيد الإقفال عند وجود رصيد سالب** مغلق. | عالج السالب — وغالباً ما يكون استلاماً ناقصاً — أو فعّل ذلك الخيار إن كنت تقبل الإقفال بأرصدة سالبة. |
| «لا يمكن استعمال السماح بالسحب علي المكشوف إلا مع الأصناف المخزنية أو المجمعة» | ضُبطت سياسة سحب على المكشوف على صنف لا يحمل مخزوناً، كصنف خدمي. | اترك السياسة فارغة على تلك الأصناف. |
