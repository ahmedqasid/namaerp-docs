...
- **إلغاء المستند الذي أدخل الأصل الخدمة أو حذفه يعيده إبتدائيًا.** فنقض سند الشراء أو الافتتاح يفرّغ الأصل من جديد.
...
|---|---|---|---|---|---|
| تُهلِكه | ✗ *«لا يمكن عمل اهلاك للاصل الثابت لان الحالة ابتدائية»* | ✔ | ✗ *«الأصل {0} مهلك تماماً»* | ✗ — غير القابل للإهلاك لا يُهلَك أبدًا | ✗ |
...
**لا شيء يمسّ أصلًا متخلَّصًا منه.** وهذه ليست قاعدة في كل مستند على حدة، بل فحص واحد تجريه كل مستندات الأصول الثابتة قبل أن تمسّ أصلًا — *«Cannot make action on asset {0} because it is disposed»* — وليس لهذه الرسالة نص عربي في المنتج، فهي تظهر بالإنجليزية على الشاشات العربية أيضًا. فإن جرى التخلص من أصل بالخطأ فالطريق هو عكس سند التخلص، لا الالتفاف حوله.
