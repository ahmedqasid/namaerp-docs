...
**صيغة العرض** `value.info.viewingFormat` *(الافتراضي HTML)* — هل يُفتح التقرير بصيغة **HTML** أم **PDF**. فـHTML أسرع في العرض ويتكيّف مع الشاشة، وPDF هو المطلوب حين يُطبع التقرير أو يُرسل بالبريد كما هو.
...
**خلفية بيضاء** *(مفعل)*، **منع دمج الأسطر** *(مفعل)*، **تجاهل حدود الخلية** *(مفعل)*، **تجاهل خلفية الخلية**، **تجاهل الرسوم** — تجرّد التنسيق البصري الذي لا يحتاجه جدول البيانات. ومنع دمج الأسطر تحديداً هو ما يمنع الخلايا المدمجة من تعطيل الفلاتر والفرز.
...
**إزالة ترويسة الصفحة** *(مفعل)* و**عدم إزالة ترويسة الصفحة الأولى** *(مفعل)* — يبقيان الترويسة مرة واحدة في الأعلى ويحذفان تكرارها في كل صفحة تالية، وهو تماماً ما يريده جدول البيانات.

**إزالة تذييل الصفحة** *(مفعل)*، **إزالة ترويسة العمود** *(مفعل)*، **إزالة تذييل العمود** *(مفعل)*، **إزالة عنوان التقرير** *(مفعل)* — تحذف بقية زخارف الطباعة.
