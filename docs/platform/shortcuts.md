...
## اختصارات الدعم الفني / التشخيص {#Support--Debug-Shortcuts}
...
## اختصارات الجداول {#Grid-Shortcuts}
...
## اختصارات شريط البحث {#Find-Bar-Shortcuts}
...
## اختصارات حقول المرجع (Reference) {#Reference-Field-Shortcuts}
...
## اختصارات القوائم والبحث {#Menu--Search-Shortcuts}
...
## اختصارات نقاط البيع (POS) {#POS-Shortcuts}
...
### الشاشات والتنقل {#Screens--Navigation}
...
### الدفع والفوترة {#Payment--Invoicing}
...
### الفواتير المعلّقة {#Held-Invoices}
- **F6**: تعليق فاتورة
