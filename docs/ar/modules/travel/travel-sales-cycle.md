...
الرسائل الأربع كلها من **مردود مبيعات خدمات السفر**؛ وهي القواعد الموصوفة أعلاه بالنص الذي تستعمله الشاشة.

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| «لا يمكن إيجاد سطر مع الخدمة {0} وسعر الوحدة {1} في الفاتورة» | الخدمة السياحية في سطر المردود **وسعر وحدته** معاً لا يطابقان أي سطر في الفاتورة المصدر — وغالباً لأن سعر الوحدة عُدِّل على المردود. | أعد سعر الوحدة كما في الفاتورة، أو ارتجع الخدمة التي باعتها الفاتورة فعلاً. |
| «لا يمكن ان يكون اجمالي الكمية المرتجعة {0} من الخدمة السياحية {1} أكبر من الكمية {2} الموجودة فى الفاتورة» | الكمية في هذا المردود **مضافاً إليها** كل ما ارتُجع في مردودات سابقة على الفاتورة نفسها يتجاوز ما باعته الفاتورة. | راجع المردودات السابقة على تلك الفاتورة قبل أن تخفض الكمية هنا. |
| «سعر الوحدة {0} للخدمة السياحية {1} يجب أن تكون أقل من او تساوي سعر الوحدة {2} فى الفاتورة» | السطر يردّ للوحدة أكثر مما حصّلته الفاتورة. | اخفض سعر الوحدة إلى سعر الفاتورة؛ فالمردود لا يردّ أكثر مما أُخذ. |
| «نسبة الخصم{0} وقيمته {1} للخدمة السياحية {2} فى السطر {3} أكبر من نسبة الخصم{0} و قيمته {4} فى الفاتورة» | أحد مستويات الخصم الثمانية في سطر المردود نسبته أعلى من نسبة المستوى نفسه في سطر الفاتورة، و`{0}` هو رقم الخصم. | انقل نسبة الفاتورة لذلك المستوى، أو افرغها. |
