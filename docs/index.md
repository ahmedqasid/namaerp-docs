...
# الرئيسية
  ...
  - [الخصائص العامة للنظام](/platform/)
  ...
  - [التكاملات الخارجية](/integration/)
    - [واجهة برمجية REST لنظام نما ERP](/integration/nama-erp-api.md)
    - [سيناريوهات الربط بين نظام نما والأنظمة الأخرى](/integration/system-integration-scenarios.md)
    - [إرسال الفواتير والمستندات للعملاء](/integration/invoice-retriever.md)
    - [الربط مع ماكينات الحضور والانصراف](/integration/attendance-machines-integration.md)
    - [إعداد اتصال Oracle JDBC في ملف context.xml لأغراض التكامل](/integration/oracle-jdbc-connection.md)
  - [إدارة النظام](/admin/)
  ...
  - [توثيق مسارات الكيان (مولد بالذكاء الاصطناعي)](/entity-flows/)
    - [الأساسيات](/entity-flows/core/)
    ...
    - [وحدة الحسابات](/entity-flows/accounting/)
    ...
    - [وحدة الذكاء الاصطناعي](/entity-flows/ai/)
    ...
    - [وحدة المقاولات](/entity-flows/contracting/)
    ...
    - [وحدة إدارة علاقات العملاء](/entity-flows/crm/)
    ...
    - [وحدة تكامل التجارة الإلكترونية](/entity-flows/magento/)
    ...
    - [وحدة العقارات](/entity-flows/realestate/)
    ...
    - [وحدة مركز الخدمة](/entity-flows/srvcenter/)
    ...
    - [وحدة سلسلة التوريد](/entity-flows/supplychain/)
  ...
  - [ملاحظات الإصدارات](/release-notes/)
