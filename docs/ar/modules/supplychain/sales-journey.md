...
## قبل أن تبدأ الرحلة: ملف العميل

كل مستند فيما يلي يشير إلى عميل، ويرث من ذلك العميل قائمة أسعاره وسياسة ضريبته وحساباته ومندوبه وشروط
سداده — فالملف يستحق أن يُضبط قبل أول عرض أسعار. وهو موصوف في
[العملاء والموردون وجهات الصلة](/ar/platform/customers-suppliers-and-parties).

**وحد الائتمان يستحق تنبيهًا.** ملف العميل يحمل حد ائتمان ومدة سداد وعلامتَي *منع الفواتير قبل السداد*
و*منع الطلب قبل السداد*، ومن الطبيعي أن تُقرأ هذه كفرامل على الرحلة. وهي ليست كذلك: لا شيء في المنتج
الجاهز يمنع أمر بيع أو فاتورة لأن العميل تجاوز حده. فإن احتاج تطبيقك هذه الفرامل فهي تُبنى بـ
[التحقق بناءً على المعايير](/ar/platform/criteria-based-validation#mnaa-byaa-ytjwz-Hd-ytmn-laamyl)،
حيث الاستعلام مكتوب بالكامل.
...
- **تجميع** (Collect) — يسأل عن **تاريخ من** و**تاريخ إلى**، ثم يملأ جدول المستندات المخزنية بالفاتورة بأوامر الصرف التي سُلِّمت لهذا العميل من نفس المخزن، وسُجّلت مرة على الأقل، وليس عليها علامة *عدم التجميع في الفواتير*، ولم تُفوتر بعد. أما جهة الاتصال والذمة فيضيّقان البحث أيضًا، لكن فقط إذا كان التوجيه مفعّلًا فيه *اعتبار جهة الاتصال عند تجميع السندات المخزنية في الفواتير* / *اعتبار الذمة عند تجميع السندات المخزنية في الفواتير*. وبهذا يصير شهر كامل من التسليمات فاتورة واحدة.
- **تطبيق** (Apply Receipts) — يقرأ أوامر الصرف الموجودة في ذلك الجدول ويحوّلها إلى سطور فاتورة مسعَّرة، بمصنِّفات أسعار الفاتورة ومندوبها وإعدادات الضريبة والتصنيف والتوجيه. **تجميع** يملأ الجدول، و**تطبيق** يحوّله إلى فاتورة. وإذا كان التوجيه مفعَّلًا فيه *تطبيق المستند المخزني بمجرد اخنتياره*، فاختيارك لأمر صرف في الجدول يشغّل هذا الإجراء وحده.
