...
## الفكرة الأساسية في مثال واحد {#The-Big-Idea-in-One-Example}
...
## نافذة Edit Mappings {#The-Edit-Mappings-Dialog}

تنقسم النافذة إلى قسمين متراكمين عموديًا.

### الأعلى — محرر SQL {#Top----The-SQL-Editor}
...
### الأسفل — قائمة الخصائص {#Bottom----The-Property-List}
...
### الإبلاغ عن الخصائص اليتيمة (Orphan Flagging) {#Orphan-Flagging}
...
## كيف يُحلّل Bootstrap كل عمود {#How-Bootstrap-Resolves-Each-Column}
...
## ما الذي يحدث عند الحفظ {#What-Happens-When-You-Save}
...
## استخدام الكيانات الافتراضية في معالج التقارير {#Using-Virtual-Entities-in-the-Report-Wizard}
...
## استخدام الكيانات الافتراضية في معالج Widget لوحة المعلومات {#Using-Virtual-Entities-in-the-Dashboard-Widget-Wizard}
...
لمعرفة تفاصيل سلوك الـ widgets المدعومة بالمعالج، راجع [دليل وحدة BI](./bi/bi-module-guide.md#Data-Sources) ومرجع [Wizard Mode](./bi/bi-module-technical-reference.md#13-Wizard-Mode---Chart-Config-Shape).

---

## مثال عملي — تقرير حركات تكاليف البضاعة في الطريق {#Worked-Example----In-Transit-Cost-Movements-Report}

لنستعرض الخطوات الكاملة من منظور المستخدم باستخدام SQL من بداية الدليل.

### الخطوة 1 — إنشاء الكيان الافتراضي {#Step-1----Create-the-Virtual-Entity}
...
### الخطوة 2 — ربط الأعمدة {#Step-2----Map-the-Columns}
...
### الخطوة 3 — بناء التقرير {#Step-3----Build-a-Report}
...
## حالات الحافة والمزالق الشائعة {#Edge-Cases---Common-Pitfalls}
...
## نموذج الثقة — من يجب أن يتمتع بالوصول {#Trust-Model----Who-Should-Have-Access}
...
## ما القادم لاحقًا {#What-s-Coming-Later}
