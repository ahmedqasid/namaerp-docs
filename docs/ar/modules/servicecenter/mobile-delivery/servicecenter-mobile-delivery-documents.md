...
**إلغاء المستند لا يزيل سندات التحويل التي أنشأها.** فهي تبقى قائمة، ويظل المخزون مقيّداً على مندوب لم يعد يحمله. فبعد إلغاء مستند حركة أو حذفه، ابحث عن سندات التحويل المُنشأة وعالجها يدوياً. (أما إعادة حفظ مستند قائم فتحذف فعلاً السندات التي لم تعد لازمة — الثغرة خاصة بالإلغاء وحده.)
:::
