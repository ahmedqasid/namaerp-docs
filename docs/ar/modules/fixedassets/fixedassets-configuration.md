...
ليس في شاشة إعدادات الوحدة أزرار خاصة بها. فهي بطاقة واحدة لكل قاعدة بيانات: تفتحها وتغيّر الخيار
الذي جئت من أجله وتحفظ. وما يصفه القسم التالي — أن بعض التغييرات لا تسري إلا على السجلات المنشأة
بعدها — هو الشيء الوحيد الفاصل بين الحفظ ورؤية الأثر.
