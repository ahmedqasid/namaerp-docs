...
| إلغاء المراجعة | يرفع آخر ختم مراجعة. ويظهر بجوار «مراجعة» في أنواع السجلات التي فُعّلت لها المراجعة | |
| عرض شجري | يفتح سجلات هذا النوع في صورة شجرة. ولا يظهر إلا على الأنواع ذات البنية الأبوية | Ctrl + T |
| المساعدات السريعة | يعرض التلميحات المعرّفة لهذه الشاشة. ولا يظهر إلا حيث عرّفها أحد | |
| اسأل الذكاء الاصطناعي | يفتح مساعد الذكاء الاصطناعي على هذا السجل. ولا يظهر إلا إذا كانت وحدة الذكاء الاصطناعي مرخّصة والمستخدم مسموحاً له باستعمالها | |
...
الزر الرمادي ليس خللاً. «مسودة» يظهر رمادياً على **المستند** الذي سبق اعتماده — فالمستند يترك المسودة
خلفه إلى الأبد، أما الملف الرئيسي كالعميل أو الصنف فيبقى له زر المسودة بعد الاعتماد — و«موافقة» يظهر
رمادياً حين لا شيء ينتظر قراراً، و«حذف» يختفي تماماً عند مستخدم لا تسمح له صلاحياته بالحذف. الشريط يعرض دائماً الأزرار
...
بالمدخلات** فيأخذ الفلتر الذي بنيته للتو على القائمة ويفتح [تعريف معايير](/ar/platform/criteria-definitions) جديداً في نافذة منبثقة،
يحمل ذلك الفلتر، ومضبوطاً على هذا النوع من الكيانات، ومعلَّماً بأنه صالح للاستعمال في القوائم — فيصير
البحث الذي ركّبته بيدك فلتراً مسمّى يختاره الجميع. وإن لم يكن هناك فلتر رد بـ*«يرجي تحديد معايير»* ولم
يفعل شيئاً.
