...
يجب أن يكون السجل **معتمداً** أولاً. فالمسودة لا تُراجع، والرفض نصه *The record {0} is draft, you can not revise draft records* — والسجل الجالس في دورة موافقة لا يُراجع كذلك، لأن محتواه لم يستقر بعد: «السجل {0} خاضع لموافقة حاليا».

وبمجرد أن تراجع تحدث ثلاثة أمور:

1. **يُقفل السجل.** فأي محاولة لتعديله أو حذفه تُرفض بالرسالة «لا يمكن التعامل مع السجل {0} لانه تمت مراجعته». وتصحيح سجل مراجَع يبدأ بإلغاء مراجعته.
...
|---|---|---|
| «لا يمكن التعامل مع السجل {0} لانه تمت مراجعته» | حاولت تعديل أو حذف سجل عليه اعتماد مراجعة. | ألغِ مراجعته، ثم صحّح، ثم راجعه من جديد. |
| «السجل {0} تمت مراجعته» | ضُغط **مراجعة** على سجل بلغ بالفعل أعلى مستوى تسمح به قاعدته — وهو مستوى واحد حيث لا إعداد آخر. | لا شيء؛ فالسجل مُعتمد بالكامل. ولرفع السقف امنح الكيان مستويات أكثر في إعدادات المراجعة التفصيلية. |
| «السجل {0} لم تتم مراجعته» | ضُغط **إلغاء المراجعة** على سجل لا اعتماد عليه. | لا شيء — فليس هناك ما يُسترد. |
| «السجل {0} لا يزال مسودة» · *The record {0} is draft, you can not revise draft records* | جرت محاولة مراجعة سجل لم يُعتمد قط. | اعتمد السجل أولاً. |
| «السجل {0} خاضع لموافقة حاليا» | السجل في دورة موافقة مفتوحة، فمحتواه غير نهائي. | انتظر انتهاء الموافقة ثم راجعه. |
| «لا توجد لديك الصلاحية للعملية {0} على السجل {1}» | ملف الأمان لا يحمل قدرة **مراجعة** لهذا النوع عند المستوى الذي تحاول بلوغه. والفحص لكل مستوى على حدة — فقد يُمنح L1 ولا يُمنح L2. | اطلب القدرة، أو دع صاحب تلك الخطوة يعتمدها. |
| «لا يمكنك تعديل صلاحية السجل {0} حيث تمت مراجعته» | عُدّلت قدرات الأمان على سجل أمان مراجَع. | ألغِ مراجعته أولاً. |
| «المستند {0} لا يمكن إلغاؤه لأنه تمت مراجعته» | مستند إلغاء مستند يسمّي مستنداً مراجَعاً. | ألغِ مراجعة المستند ثم ألغِه. |

ورسالة *The record {0} is draft, you can not revise draft records* لا ترجمة عربية لها، فتظهر
بالإنجليزية حتى على الشاشة العربية.
