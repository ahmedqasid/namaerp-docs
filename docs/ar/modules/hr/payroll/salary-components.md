...
## مجموعة مفردات راتب (Salary Component Group)

**مجموعة مفردات راتب** (**الرواتب > إعدادات الراتب > مجموعة مفردات راتب**) تجمع المفردات المرتبطة معاً لأغراض الفلترة والتقارير. وهذا أكثر ما تفعله، وهو كل ما تفعله في أغلب المجموعات.

والاستثناء جدول **أنواع المفردات** داخل المجموعة. فكل سطر يسمّي نوع مفرد، وحيث يكون تأثير ذلك النوع **أخرى** يحدد عمود **معاملة المفردات من نوع أخرى** في السطر هل يعامله إصدار الرواتب إضافةً أم استقطاعاً عند حساب مفرد يشير إلى المجموعة. فالمجموعة إذن تنظيم *مع* قاعدة واحدة ضيقة، ورسالة الرفض في آخر هذه الصفحة موجودة لتُبقي ذلك العمود محصوراً في الأنواع التي يخصها.

## رسائل قد تظهر لك

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| «لا يمكنك اختيار {0} ونوع التصنيف {1} في نوع المفرد {2}» | عُلِّم على **عدم تعديل القيمة عند إعادة الإصدار** في مفرد نوعُه مصنَّف **قسط**؛ وقيم الأقساط تأتي من مستندات السلف في كل إعادة إصدار، فلا يمكن حمايتها من إعادة الكتابة. | أزل التعليم عن الخيار في هذا المفرد، أو انقله إلى نوع بتصنيف آخر. |
| «يجب تفعيل حقل من هذه الحقول {0} , {1} , {2} عند تفعيل هذا الحقل {3} في نوع المفرد وهذا في مفرد الراتب {4}» | نوع المفرد مفعَّل فيه **التصفية الآلية** (Auto Adjustment)، ومعنى ذلك أن يكون مُعلَّمًا في المفرد واحدٌ فقط من: **يشمل الأجازة الإضطرارية** أو **يشمل تصفية الأجازات** أو **يشمل تصفية نهاية الخدمة** — ولم يُعلَّم أي منها، أو عُلِّم أكثر من واحد. | حدّد التصفية التي يُعالج المفرد آليًا معها، وعَلِّم خيارها وحده. |
| «تقريب الراتب لا يمكن ان يكون {0}» | عُلِّم على **الاستخدام مع تقريب الراتب** (Use With Salary Approximation) وبقيت طريقة التقريب **بدون**، فلا شيء يُقرَّب إليه. | اختر طريقة تقريب فعلية، أو أزل التعليم عن خيار التقريب. |
| «التقريب لأسفل لا يجب استخدامه مع المفردات من النوع إضافة» | مفرد تأثيره **إضافة** مضبوط على التقريب **لأسفل**، وهو ما يصرف للموظف أقل من المبلغ المحسوب بهدوء. | قرّب الإضافات لأعلى أو إلى الأقرب. |
| «التقريب لأعلي لا يجب استخدامه مع المفردات من النوع إستقطاع» | الحالة المقابلة: مفرد تأثيره **إستقطاع** مضبوط على التقريب **لأعلى** فيستقطع أكثر من المحسوب. | قرّب الاستقطاعات لأسفل أو إلى الأقرب. |
| «الحسابات جب أن تحتوى على حساب واحد فقط» | طريقة توزيع المدين أو الدائن **ثابت**، أي ترحيل المبلغ كله إلى حساب واحد، لكن جدول سطور الحسابات لا يحتوي سطرًا واحدًا بالضبط. | أبقِ سطرًا واحدًا في ذلك الجدول، أو غيّر طريقة التوزيع إلى التي تقسّم على عدة حسابات. |
| «مجموع النسب يجب أن تكون 100 %» | طريقة التوزيع تقسّم المبلغ بالنسب، ونسب سطور الحسابات المدينة أو الدائنة لا تبلغ مجموعها 100. | عدّل النسب حتى تبلغ 100 في الجانبين. |
| «لا يمكنك ملء الحقل {0} لأن طريقة التوزيع {1}» | سطر حساب يحمل حقل معيار أو استعلام لا تقرأه طريقة التوزيع المختارة أصلًا — مثل استعلام موظف مع توزيع ثابت. | أفرغ الحقل المذكور في الرسالة، أو غيّر طريقة التوزيع إلى التي تستخدمه فعلًا. |
| «الأوبشن {0} لا يمكن ان يكون مفعل عندما يكون الأوبشن {1} مفعل» | عُلِّم على **إعادة توزيع القيمة الأساسية على مدة العمل** وعلى **غير مرتبط بأيام العمل** معًا: فالأول يوزّع القيمة على أيام العمل، والثاني يقول إن القيمة لا علاقة لها بأيام العمل. | أبقِ الخيار الصحيح لهذا المفرد وأزل التعليم عن الآخر. |
| «يجب ان تقوم باختيار {0} اذا قمت باختيار {1}» | في **نوع المفرد** عُلِّم على **لا يتأثر ببيانات شئون الموظفين** دون التعليم على **غير مرتبط بأيام العمل** — والنوع الذي يتجاهل بيانات الموظف الوظيفية يجب أن يكون مستقلًا كذلك عن أيام عمله. | عَلِّم على **غير مرتبط بأيام العمل** أيضًا، أو أزل التعليم عن الخيار الأول. |
| «يجب ان يكون التأثير فى نوع المفرد {0} يساوى أخرى حتى يتم اختيار معاملة المفردات من نوع أخرى» | في أحد سطور **مجموعة مفردات الراتب** مُلئ عمود **معاملة المفردات من نوع أخرى** لنوع مفرد تأثيره **إضافة** أو **إستقطاع**؛ وهذا العمود لا يوصّف إلا الأنواع التي تأثيرها **أخري**. | أفرغ العمود في ذلك السطر، أو اجعل تأثير نوع المفرد **أخري** إن كان ذلك واقعه فعلًا. |
