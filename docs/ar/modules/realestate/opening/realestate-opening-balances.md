...
صراحة: *«نوع الفترة المحاسبية لا بد ان تكون افتتاحية»*. وهذا مقصود — فالقيود الافتتاحية يجب أن تستقر في الفترة التي
...
وإلغاء المستند أو حذفه يحذف سطوره ويخفض التكلفة المخصصة من جديد، فيصبح التراجع عن دفعة ترحيل خاطئة
أمراً يسيراً.
