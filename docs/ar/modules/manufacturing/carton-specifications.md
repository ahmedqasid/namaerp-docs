...
**واجعل لكل مواصفة عملية تشغيل واحدة على الأقل.** فالمكونات التي يخرج بها تخطيط الخامات تُعلَّق كلها على أول عملية في مسار التشغيل، فالمواصفة ذات تبويب عمليات التشغيل الفارغ يُخفق معها توليد أوامر الإنتاج من أصله برسالة *This operation is not in routing*.
