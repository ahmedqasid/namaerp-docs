...
menu: الرواتب ← سندات التوظيف ← سند مباشرة عمل
---
...
|---|---|---|
| «لا يمكنك تعديل او حذف هذ المستند لانه منشأ من {0}» | هذا السند متولّد عن المستند المجمَّع المذكور في الرسالة، وهو مالكه — والقاعدة نفسها تسري على حذفه. | أجرِ التعديل في المستند المجمَّع؛ فالسندات المفردة المتولّدة تتبعه. |
| «يجب إختيار متقدم للعمل / موظف لبدء العمل» | لم يُملأ **المتقدم للعمل** ولا **الموظف**، فلا يبيّن المستند من الذي يباشر العمل. | املأ أحدهما: متقدم للعمل في حالة التعيين الجديد، أو موظفًا لمن هو مسجَّل بالفعل في ملف الموظفين. |
| «يجب عليك إنشاء عرض وظيفى للموظف {0} قبل إنشاء سند مباشرة عمل له لأن حالة الموظف {1}» | آخر تغيير مسجَّل لحالة الموظف تركه *مستقيلًا* أو *مفصولًا* أو *على المعاش*، فإعادة مباشرته تستلزم تسجيل شروط التعاقد الجديد أولًا. | أنشئ عرضًا وظيفيًا للعودة مع التعليم على **إعادة تعيين**، ثم حرّر سند مباشرة العمل. |
