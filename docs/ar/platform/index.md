...
# الخصائص العامة للنظام
  ...
  - [تعديل الشاشات](/ar/platform/screen-modifier/)
    - [أسماء التخطيط (Layout Names):](/ar/platform/screen-modifier/screen-modifier.md)
    - [أسئلة شائعة حول تعديل الشاشات](/ar/platform/screen-modifier/screen-modifier-faq.md)
