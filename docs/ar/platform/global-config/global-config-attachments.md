...
وتفعيله ليس تعديلاً عادياً. فالخيار يقع في مستوى أمان محمي، والحفظُ الذي يفعّله من جلسة عادية يُرفض
بالرسالة *«انت لا تمتلك صلاحية التعديل على الحقل value.info.doNotCheckForBackupExistence لأنه ينتمى
لمستوى الأمان L2Dangerous برجاء التواصل مع الدعم الفنى»*. ولا يفعّله إلا جلسة دعم من نما — وهذا هو
المقصود: فإسكات إنذار النسخ الاحتياطي قرار لا بد أن يتحمله أحد. أما إعادة إطفائه فغير محجوبة.
