...
هذه هي الرفوضات المسرودة في «قواعد توقف الحفظ» بالنص الذي تستعمله الشاشة.

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| «هذا المشروع {0} لايرتبط بهذا العميل {1}» | العميل على المهمة ليس عميل المشروع الذي تتبعه. | افرغ العميل ليأتي من المشروع، أو انقل المهمة إلى المشروع الصحيح. |
| «إجمالي قيمة الحقل {0} والحقل {1} لا يمكن أن تتخطى قيمة الحقل {2}» | في سطر منفذ، مجموع الساعات الفعلية والمسجَّلة يتخطى الساعات المخططة. فالساعات المخططة سقف لا هدف. | ارفع الساعات المخططة لذلك السطر، أو ارفض الزائد قبل الحفظ. |
| «لا يمكنك حذف الموظف {0} حيث أن لديه {1} ساعة فعلية في هذه المهمة» | حُذف من الجدول سطر منفذ يحمل ساعات فعلية. فالعمل الموافق عليه لا يُحذف. | علّم على *تم العمل* في السطر بدلًا من حذفه، أو ألغِ الموافقات أولًا. |
| «لا يمكنك تغيير الموظف {0} إلى الموظف {1} حيث أنه لديه {2} ساعة فعلية في هذه المهمة» | غُيّر الموظف على سطر يحمل ساعات فعلية بالفعل، وهذا يعيد إسناد عمل أدّاه غيره. | اترك السطر كما هو وأضف سطرًا جديدًا للموظف الآخر. |
| «الموظف {0} لديه فترات متقاطعة فى نفس المهمة» | الموظف نفسه على سطري منفذ تتقاطع نافذتا «من – إلى» لهما. | افصل التواريخ حتى لا يتقاطع السطران، أو ادمجهما في سطر واحد. |
