...
[المحددات الخمسة](/ar/platform/dimensions-and-composite-dimensions) — الشركة، والمجموعة التحليلية، والفرع، والقطاع، والإدارة. تقول أي شركة وأي جزء من العمل يملك الأصل، أما هل يأخذ سطر القيد محدِّده من الأصل أم من المستند فذلك من إعدادات الوحدة. وسند النقل يعيد كتابتها.
...
2. **لا يتكرر المكوّن.** لا يجوز أن يتكرر الجمع بين نوع المكون ونوع الصيانة مرتين في جدول المكونات — *«نوع مكون الأصل {0} مكرر»*.
3. **سلسلة التصنيفات يجب أن تتماسك.** إن ملأت تصنيفًا والمستوى الذي فوقه، وجب أن يكون الأعلى هو الأب الحقيقي للأدنى.
4. **طريقة الإهلاك تُقفَل بأول حركة.** فما إن توجد حركة واحدة على الأصل حتى تمتنع الطريقة عن التغيير — *«لا يمكن تغيير طريقة الإهلاك من {0} إلى {1} للأصل {2} لأنه مستخدم في حركات الأصول الثابتة بواسطة المستند {3}»*. فالاختيار بين القسط الثابت وإعادة التقييم قرار يُتخذ قبل إدخال الأصل الخدمة.
...
|---|---|---|
| «لا يمكن تغيير طريقة الإهلاك من {0} إلى {1} للأصل {2} لأنه مستخدم في حركات الأصول الثابتة بواسطة المستند {3}» | للأصل حركة واحدة على الأقل، وقد غُيّرت طريقة الإهلاك في البطاقة. والرسالة تسمّي المستند الذي كتب تلك الحركة. | أرجِع الطريقة كما كانت، أو انقُض المستند المسمّى أولًا. والاختيار بين القسط الثابت وإعادة التقييم قرار يُتخذ قبل دخول الأصل الخدمة. |
| «نوع مكون الأصل {0} مكرر» | تكرر الجمع بين نوع المكون ونوع الصيانة مرتين في جدول **مكونات الأصل**. | احذف السطر المكرر؛ فالتركيبة لا تظهر إلا مرة واحدة. |
| «تنصيف أصل ثابت الأعلى ل {0} يجب أن يساوي تصنيف أصل ثابت {1}» | ملأت مستوى تصنيف والمستوى الذي فوقه، ولكن الأعلى ليس أبًا للأدنى في شجرة التصنيفات. | اختر التصنيف الذي أبوه هو الموجود في المستوى الأعلى، أو افرغ المستوى الأعلى ليمتلئ من تلقاء نفسه. |
| «نوع أصل ثابت لتنصيف أصل ثابت {0} غير متناسق مع نوع أصل ثابت للتصنيف {1}» | مستوى تصنيف والمستوى الذي فوقه يتبعان نوعي أصل مختلفين. | صحّح شجرة التصنيفات، أو اختر تصنيفات تقع كلها تحت نوع أصل واحد. |
| «نوع أصل ثابت لتصنيف أصل ثابت {0} غير متناسق مع نوع أصل ثابت {1}» | تصنيف على الأصل يتبع نوع أصل غير **نوع الأصل** المدوّن على البطاقة نفسها. | غيّر التصنيف، أو غيّر نوع الأصل حتى يتفقا. |
