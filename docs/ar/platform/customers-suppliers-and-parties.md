...
| «لا يمكن تكرار المحددات للضوابط» | سطران في حدود الأئتمان يصفان التركيبة ذاتها من الشركة والفرع والإدارة والقطاع ومجموعة التحليل والعملة. | ادمجهما؛ فالتركيبة لا تظهر إلا مرة واحدة. |
| «لا يمكن استخدام null و قيمة اخري للشركه» | جدول حدود الأئتمان يخلط سطورًا تركت الشركة على *أي* بسطور تسمي شركة بعينها. والجدول يُقرأ بأحد الوجهين لا بهما معًا. | حدّد شركة في كل السطور، أو اتركها على *أي* في كل السطور. |
| *Credit period can't be less than 0* | فترة ائتمان أو مدة سداد سالبة. | اكتب صفرًا أو عددًا موجبًا من الأيام. |
| «يجب أن يكون رقم تليفون» | الإعدادات العامة مضبوطة على استعمال رقم الهاتف كودًا للعميل، والكود الذي كتبته لا يطابق النمط المتوقع. | اكتب رقم المحمول كودًا، أو أوقف ذلك الإعداد. |
| «هذا الخيط مرتبط بعميل» | العميل المرتقب في حقل «عميل مرتقب» أنتج عميلًا آخر بالفعل. | افتح ذلك العميل المرتقب لتجد العميل الذي أنشأه بدلًا من إنشاء عميل ثانٍ. |

وأربع من هذه الرسائل لها ترجمة عربية، وما عداها يظهر بالإنجليزية ولو كانت الشاشة عربية، ولذلك فإن
