...
| منع الاستعمال | يعطّل السجل تعطيلاً ليّناً: يبقى في النظام وفي مستنداته القديمة، لكنه يكفّ عن الظهور في قوائم الاختيار عند إنشاء شيء جديد |
| منع الاستعمال في بناءاً علي | النسخة الأضيق — يظل السجل قابلاً للاختيار عادةً، لكنه لم يعد صالحاً ليكون المستند المصدر الذي يُولَّد منه مستند آخر |
...
| تعيين كقالب | يحوّل السجل الذي أمامك إلى قالب قيم افتراضية، فتبدأ السجلات الجديدة من هذا النوع مملوءة منه |
