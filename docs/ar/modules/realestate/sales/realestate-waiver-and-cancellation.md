...
menu: العقارات و الممتلكات ← المستندات ← سند تنازل عن ملكية
---
...
- **إلغاء عقد البيع أو حذفه** — بـ[مستند إلغاء مستند](/ar/platform/document-cancel-document.md) العام، أو بحذف العقد نفسه. وهو الطريق الأمين وحده حين يكون العقد ما كان ينبغي أن يوجد أصلاً: أُدخل على وحدة خاطئة أو لمشترٍ خاطئ أو في شهر خاطئ ولم يُحصَّل عليه شيء. وإلغاؤه يعكس ما فعله الاعتماد: يعود العقار متاحاً، ويرجع الحجز إلى «مؤكد»، ويُسحب القيد.
...
ولهذا النسخ نتائج تستحق المعرفة. حقل **المدفوع من الحجز** معطَّل على هذه الشاشة. و**لا يمكن تغيير «بناءا على» بعد أول اعتماد** — *«From document can not be changed from {0} to {1}»* (وليس لهذه الرسالة نص عربي في المنتج، فتظهر بالإنجليزية على الشاشات العربية) — فإن كان خاطئاً فألغِ المستند وابدأ من جديد. وبخلاف عقد البيع، **المشتري اختياري** هنا: فتنازل «للشركة» لا مشتري وارداً فيه ليُسمّى.

وإن تعذّر الوصول إلى العقد الأصلي عند اعتماد التنازل ستظهر رسالة *«برجاء عمل إعادة حفظ لسند المبيعات السابق لهذا التنازل»* — أعد اعتماد العقد ثم أعد المحاولة.
...
| الحالة | ما تفعله |
|---|---|
| العقد أُدخل بالخطأ ولم يحدث عليه شيء | ألغِ العقد أو احذفه |
