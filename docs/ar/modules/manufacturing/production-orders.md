...
![شاشة أمر الإنتاج](images/production-order/production-order-ar.png)

وشاشة القائمة هي موضع رؤية الصورة كاملة — كل الأوامر وحالاتها وكمياتها في مكان واحد.

![شاشة قائمة أوامر الإنتاج](images/production-order/production-order-list-ar.png)
...
## كيف تحصل على نتائج جيدة من أوامر الإنتاج

أمر الإنتاج لا يكون أبدًا أفضل من البيانات الرئيسية التي تحته. والوقت المبذول في جعل [قوائم المكونات](/ar/modules/manufacturing/manufacturing-bom) دقيقة — كميات صحيحة، ونسب هالك صادقة، ومردود واقعي — و[مسارات التشغيل](/ar/modules/manufacturing/manufacturing-routing) واقعية، يردّ نفسه في كل أمر يستخدمها. والبديل مصنع يعدّل يدويًا كل أمر ينشئه، وهو أبطأ وأقل موثوقية من إصلاح الملف الرئيسي مرة واحدة.

والحجة نفسها تسري على تجاوز كميات المكونات على الأمر ذاته. فالأرقام المحسوبة تراعي أصلًا المردود والهالك وتناسب كمية الأمر. والتجاوز صحيح أحيانًا، لكن ينبغي أن يكون قرارًا له سبب لا عادةً، لأن الرقم اليدوي يكفّ عن الاستجابة لتغيرات الوصفة ويصير خاطئًا في صمت.

والتوقيت مهم كذلك. فحالة **جارٍ التنفيذ** موضوعة للأوامر التي يجري العمل عليها فعلًا، وبدء أمر قبل الإنتاج بشهور يترك لديك قائمة أوامر مفتوحة لا تخبرك بشيء عما يفعله المصنع حقًا. والإغلاق السريع منطقه المعكوس نفسه: بعد أسبوع أو أسبوعين من انتهاء الإنتاج، أغلقه. فالسجل يبقى متاحًا، لكنه يكفّ عن تشويش صورة العمل الجاري.

وحيث تجد نفسك تنشئ عشرات الأوامر المتشابهة يدويًا، فقف واستخدم الأدوات الموضوعة لذلك — [طلبات أوامر الإنتاج](/ar/modules/manufacturing/production-order-request) لمسار الطلب إلى الأمر، أو الأوامر المجمّعة لتخطيط الدفعات.

::: warning مقفل بعد البدء
بمجرد بدء أمر الإنتاج، يُقفل هيكل قائمة المكونات ومسار التشغيل فيه. راجعهما قبل البدء لا بعده.
:::

::: tip الخطوة التالية: التنفيذ
إنشاء الأمر تخطيط، و[تنفيذ الإنتاج](/ar/modules/manufacturing/production-execution) هو موضع تسجيل العمل.
:::
...
|---|---|---|
| «بالنسبة للأوبشن {0} في سطور{1} - سطر واحد فقط يمكنه تفعيل هذا الأوبشن» | أكثر من سطر مكوّن في الأمر معلَّم فيه **مكمِّل الوزن**. فمكوّن واحد يستوعب فرق الوزن لا عدة مكونات. | أزل العلامة عن جميع المكونات إلا واحدًا. |
| «توجية و دفتر أمر الإنتاج الموجودين في التوجيه لا يمكن ان يكونا فارغين» | يُحفَظ **أمر إنتاج مجمَّع** وتوجيهه لا يذكر التوجيه والدفتر الذي تُنشأ بهما أوامر الإنتاج المفردة. | املأ توجيه أمر الإنتاج ودفتره في توجيه الأمر المجمَّع، ثم احفظ من جديد. |
| «أمر الإنتاج {0} حالته ليست إبتدائية لا يمكنك تعديله» | تغيّر سطر من الأمر المجمَّع، وأمر الإنتاج وراءه غادر الحالة *الابتدائية* بالفعل. وتُرفع للأمر الذي تشير إليه الآن وللأمر الذي تتخلى عنه. | اترك الأوامر التي بدأت وعدّل مستندات التنفيذ بدلًا منها. والرفض نفسه يظهر بالإنجليزية حين يكون السطر الجديد هو المفحوص، لأن إحدى الصيغتين فقط لها ترجمة عربية. |
| «لا يمكنك اختيار الحقل {0} و{1} معًا» | **بدء أمر الإنتاج** و**إلغاء بدء أمر الإنتاج** معلَّمان معًا في الأمر المجمَّع، فكأنك تطلب بدء الأوامر وإلغاء بدئها في حفظة واحدة. | علّم أحدهما واحفظ، وعلّم الآخر في حفظة لاحقة إن أردت العكس بعدها. |
