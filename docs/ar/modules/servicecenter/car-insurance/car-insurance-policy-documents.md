...
وعند الاعتماد يختم كل وثيقة بـ**تمت معالجتها بواسطة** مشيراً إلى نفسه، و — فقط إن لم تكن الوثيقة قد استُلمت بعد — يضع *الحالة المادية* على **مطلوبة من المورد** و*حالة السداد* على **مسددة كلياً أو جزئياً** و*حالة الوثيقة* على **أول مرة**. وإلغاء المستند أو حذفه يمسح الأربعة، فيعيد الحالة المادية إلى *مبدئية* وحالة السداد إلى *غير مسددة*.
...
وعند الاعتماد يضع *الحالة المادية* لكل وثيقة على **تم استلامها من المورد** (فقط إن لم تكن استُلمت من قبل) ويكتب تاريخ الاستلام على الوثيقة. وإلغاء المستند أو حذفه يمسح تاريخ الاستلام ويعيد الحالة إلى *مطلوبة من المورد*.
...
والشيء الوحيد الذي يتحقق منه أن تاريخ التسليم لا يسبق تاريخ استلام الوثيقة. وعند الاعتماد يضع *الحالة المادية* على **تم تسليمها للعميل** ويكتب تاريخ التسليم على الوثيقة؛ وإلغاء المستند أو حذفه يمسح الاثنين.
...
::: danger إلغاء التجديد لا يتراجع عنه
إلغاء التجديد أو حذفه يعكس **قيده المحاسبي فقط**. أما الوثيقة فتحتفظ بالتاريخ الفعلي المجدَّد وتاريخ الانتهاء المجدَّد وحالة *تجديد*؛ ولا شيء يُعاد.
...
فإن احتجت التراجع عن تجديد، فألغِه أو احذفه لعكس المحاسبة، ثم صحّح تواريخ الوثيقة عمداً — وراجعها بعد الحفظ.
:::
...
وعند الاعتماد يكتب تاريخ الإلغاء على كل وثيقة، ويضع *حالة الوثيقة* على **ملغاة**، ويسجّل نفسه مستنداً مُلغياً. وإلغاء مستند الإلغاء أو حذفه يمسح الثلاثة — لكن للوثائق التي ألغاها هذا المستند بعينه فقط، فلا يستطيع إلغاء ثانٍ أن ينقض عمل الأول. واعتماد إلغاء على وثيقة ألغاها مستند آخر مرفوض برسالة تسمّي ذلك المستند.
...
- **وتعديل الفترة لا سلوك تراجع له إطلاقاً.** فإلغاؤه — أو حذفه — يترك تاريخ الانتهاء الجديد وحالة *تعديل فترة* على الوثيقة إلى الأبد. ولا سبيل إلى الرجوع عنه بالمستند؛ بل عليك أن تفتح الوثيقة وتصحح التاريخ بنفسك، وحتى حينها تبقى الحالة على ما هي.

أما تعديل القيمة فيستعيد القيمة السابقة عند إلغائه أو حذفه، بتحفظ واحد: إنه يستعيد القيمة المخزَّنة في سطره هو، لا «قيمة قديمة» محفوظة على حدة. فلو عدّل أحدهم عمود قيمة الوثيقة في ذلك السطر بعد الاعتماد، فالتراجع يستعيد الرقم المعدَّل لا الأصلي.
