...
وإلغاء مستند الإلغاء أو حذفه يعيد الحقلين إلى حالتهما، وإعادة توجيه حقل *بناءا على* فيه إلى
...
| للتراجع عن | افعل هذا |
|---|---|
| حركة مخزنية أنشأها توريد سيارة أو تسليم نهائي | **ألغِ المستند الأصلي أو احذفه.** هذا ما يزيل المستند المخزني المُنشأ عنه — ولن يفعله مستند الإلغاء. |
