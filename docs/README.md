...
# Home
  ...
  - [Getting Started](/getting-started/)
    - [System Minimum Requirements](/getting-started/system-minimum-requirements.md)
    - [Nama ERP Installation Guide](/getting-started/installation-guide.md)
    - [Nama Properties](/getting-started/nama-properties.md)
    - [Two-Factor Authentication (2FA) Guide](/getting-started/two-factor-authentication.md)
  ...
  - [External Integrations](/integration/)
    - [Nama ERP REST API](/integration/nama-erp-api.md)
    - [سيناريوهات الربط بين نظام نما والأنظمة الأخرى](/integration/system-integration-scenarios.md)
    - [Sending Invoices and Documents to Customers](/integration/invoice-retriever.md)
    - [الربط مع ماكينات الحضور والانصراف](/integration/attendance-machines-integration.md)
    - [ORACLE JDBC Integration Connection in context.xml for integration purposes](/integration/oracle-jdbc-connection.md)
