...
|---|---|---|
| «السجل: {0} مستخدم في سطور الأصناف المفضلة في إعدادات نقاط البيع» | تحذف قيمة تصنيف — تصنيف صنف أو فئة أو ماركة — وإعدادات نقاط البيع ما زالت تدرجها في الأصناف المفضلة. | احذفها من جدول الأصناف المفضلة في إعدادات نقاط البيع، ثم احذفها. |
| «السجل: {0} مستخدم في سطور الأصناف المفضلة في ماكينة نقاط البيع {1}» | المنع نفسه، لكن الإشارة في ماكينة نقاط بيع واحدة لا في الإعدادات. والرسالة تذكر الماكينة، وتُرفع رسالة لكل ماكينة. | احذفها من كل ماكينة تذكرها الرسائل، ثم احذف السجل. |
| «لا يمكنك إضافة سطور إلى جريد التفاصيل» | في **تشكيلة الأصناف** خيار **الضرب التقاطعي لألوان ومقاسات الصنف** مفعَّل، ومعناه أن المحتويات تُستخرج من ألوان الصنف ومقاساته — ومع ذلك مُلئ جدول السطور يدويًا. | أفرِغ جدول السطور واترك الضرب التقاطعي يبني المحتويات، أو أوقف الضرب التقاطعي واحتفظ بسطورك. ومع تفعيل الضرب التقاطعي تصبح **الكمية الافتراضية** مطلوبة كذلك. |
| «المقاس {1} للصنف {0} ليس له ملف مقاسات، يجب إضافة ملف مقاسات قبل استخدام تشكيلة ألوان ومقاسات {2}» | سطر في مستند يتعامل بوحدة تشكيلة مبنية بالضرب التقاطعي، وأحد مقاسات الصنف مكتوب كنص حر لا يشير إلى ملف **مقاس صنف** — فلا شيء تضربه المصفوفة. | افتح الصنف واستبدل هذا المقاس بمقاس من ملف مقاسات الأصناف. وتُرفع رسالة لكل مقاس مخالف. |
| «لا يمكنك استخدام تشكيلة ألوان ومقاسات {1} حيث أن الصنف {0}  ليس  له مقاسات» | التشكيلة تتوقع مقاسات والصنف ليس له مقاسات إطلاقًا. | أضف المقاسات للصنف، أو استخدم تشكيلة لا تعتمد على المقاس. |
| «اللون {1} للصنف {0} ليس له ملف ألوان، يجب إضافة ملف ألوان قبل استخدام تشكيلة ألوان ومقاسات {2}» | الوجه اللوني من الفحص نفسه: لون على الصنف نص حر لا مرجع لملف **لون صنف**. | استبدل هذا اللون في الصنف بلون من ملف ألوان الأصناف. |
| «لا يمكنك استخدام تشكيلة ألوان ومقاسات {1} حيث أن الصنف {0}  ليس  له ألوان» | التشكيلة تتوقع ألوانًا والصنف لا يحمل أي لون. | أضف الألوان للصنف، أو استخدم تشكيلة لا تعتمد على اللون. |
