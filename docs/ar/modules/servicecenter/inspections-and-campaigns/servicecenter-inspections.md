...
فيُرفض الاعتماد برسالة *Current odometer {0} must be greater than current odometer in product {1}* — ولا ترجمة عربية لها، فتظهر بالإنجليزية.
...
التاريخ ولا يكتب فوق الحاضر. وإلغاء سند الفحص أو حذفه يرفع قيده وتُعاد الحالة بدونه.
