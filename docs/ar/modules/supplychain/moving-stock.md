...
**في التحويل المخزني، وفي شقّي التحويل ذي الخطوتين (جانب الصرف وجانب الاستلام):** **تجميع الشحنات** (Collect Lots) — يملأ الشحنة في كل سطر تفاصيل مما يحويه مخزن الرأس وموقعه، متبعًا توجيه المستند. ويسأل أولًا هل يمسح الشحنات المُدخلة من قبل.

**في طلب التحويل المخزني:**

- **إضافة طلب** (Add Stock Transfer Req) — يطلب منك اختيار طلب تحويل آخر، ثم يلحق سطوره **غير المستوفاة** بهذا الطلب، متخطيًا ما نُفِّذ منها. ويحتاج ملء المخزن المحوَّل منه والمحوَّل إليه والتوجيه أولًا، ولا يفعل شيئًا إن نقص أحدها.
- **تجميع الطلبات** (Collect Requests) — النسخة المجمَّعة من الفكرة نفسها، إذ تلمّ الطلبات المفتوحة بدل إضافتها واحدًا واحدًا.
