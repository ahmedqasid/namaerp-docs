...
menu: المقاولات ← مقاولة مشروع ← طلب شراء خامات من الموازنة التنفيذية
---
...
وبتحقق الثلاثة يرفض المستند الحفظ في اللحظة التي تتجاوز فيها التكلفة الفعلية المتراكمة على كود بند الموازنة إجمالي التكلفة المخططة لذلك السطر، برسالة
«يجب ان تكون التكلفة {0} اقل من التكلفة المخططة {1} في {2} لكود البند {3}» — و{2} هو نوع المستند أو الكارت الذي يحمل سطر البند.
...
**وإن علّمه أحد.** توجيه صرف الخامات مُعلَّم بـ *منع الحفظ اذا تعدت التكلفة الفعلية التكلفة المخططة*. فالصرف الأول يرفع التكلفة الفعلية إلى 58,800، وهي ما زالت تحت 82,000، فيُحفَظ. والصرف الثاني سيرفعها إلى 88,800 فيُرفض: «يجب ان تكون التكلفة 88,800 اقل من التكلفة المخططة 82,000 في صرف خامات مقاولات لكود البند X-3». وعلى المشتري أن يُجزّئ الأمر، أو يستصدر تعديل موازنة، أو يستصدر اعتماداً للتجاوز — وهذا بالضبط هو الضبط الذي كان يُفترض أن تعطيك إياه الموازنة، وبالضبط هو الضبط الذي لا تحصل عليه حتى يُعلَّم ذلك الخيار.
...
|---|---|---|
| «الإعتماد {0} لم يتم الموافقة عليه» | سطر في التفاصيل يسمّي **اعتماد عميل** غير مُعلَّم بالموافقة. ولا يُشترى إلا على اعتماد تمت الموافقة عليه. | استصدر الموافقة على الاعتماد (أو علّم حقل الموافقة عليه) قبل حفظ الطلب، أو وجّه السطر إلى اعتماد آخر. |
| «{0} سعر الوحدة لا يمكن أن يكون أكبر من السعر المتفق عليه في اعتماد العميل للخامات» | سعر الوحدة على السطر أعلى من تكلفة الوحدة التي وافق عليها العميل على ذلك الاعتماد. | سعّر السطر بالسعر المتفق عليه أو أقل، أو — إن كان الشراء بأغلى قراراً إدارياً — علّم خيار **السماح بتخطي السعر المتفق عليه مع العميل** على توجيه الطلب. |
| «{2} الكمية {0} لا يمكن أن تكون أكبر من الكمية المتفق عليها {1} في اعتماد العميل للخامات» | إجمالي الكمية المطلوبة على ذلك الاعتماد — من كل سطور هذا الطلب ومن كل ما طُلب عليه في غيره — أكبر من الكمية الموافق عليها. فالمستهلَك هو الكمية المتبقية على الاعتماد لا إجمالي هذا المستند وحده. | أنقص الكمية، أو علّم خيار **السماح بتخطي الكمية الموافق عليها من العميل** على توجيه الطلب. |
| «يجب ان تكون التكلفة {0} اقل من التكلفة المخططة {1} في {2} لكود البند {3}» | لا يرفعها الطلب نفسه بل مستند الإنفاق الذي يتحول إليه: خيار **منع الحفظ اذا تعدت التكلفة الفعلية التكلفة المخططة** مُعلَّم على توجيه ذلك المستند، والتكلفة المتراكمة على كود بند الموازنة تجاوزت إجمالي التكلفة المخططة. | جزّئ الإنفاق، أو عدّل سطر الموازنة، أو — إن كان التجاوز معتمداً — أزل تعليم الخيار من توجيه ذلك المستند. |
