...
- [Getting Better Support with an AI Assistant](./ai-assisted-support.md) - the complete setup for answering support questions with Claude Desktop: installing it, putting the documentation knowledge base on your machine, keeping it current, connecting to a live system, and the tools worth defining.
