...
menu: إدارة النظام ← تخصيص شكل النظام ← تعريف قائمة
---
...
رسائل ترفض حفظ تعريف القائمة.

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| «يوجد تعريف قائمة آخر معلم عليه كقائمة إفتراضية للنظام: {0}» | عُلِّمت **القائمة الإفتراضية للنظام** هنا بينما تحملها قائمة أخرى بالفعل، ولا يمكن أن تكون القائمة الافتراضية إلا واحدة. والرسالة يُفترض أن تسمّي القائمة الأخرى لكنها تصل والموضع فارغ، فلا تدلّك عليها. | أزل العلامة هنا، أو ابحث عن القائمة التي تحملها — بفلترة قائمة القوائم على هذه الخانة — وأزلها منها أولًا. |
| «لا يمكن تحديد مجموعة أعلي للمجموعات الرئيسية» | سطر في جدول **المجموعات** معلَّم بـ**مجموعة أساسية** وفيه **المجموعة الأعلى** مملوءة. والمجموعة الأساسية مجلد من المستوى الأعلى فلا تقع داخل شيء. | أفرغ **المجموعة الأعلى**، أو أزل علامة **مجموعة أساسية** إن كان السطر مقصودًا به مجموعة فرعية. |
| «لا يمكنك سوى استعمال المجموعات الرئيسية كمجموعة أعلى - المجموعة {0} المستعملة في المجموعة {1} ليست رئيسية» | **المجموعة الأعلى** لمجموعة فرعية تسمّي مجموعة فرعية أخرى. والقائمة ثلاثة مستويات بالضبط، فأب المجموعة الفرعية لا بد أن يكون مجموعة أساسية. | اجعل الأب مجموعة أساسية، أو علّم **مجموعة أساسية** على الأب إن كان مجلدًا من المستوى الأعلى فعلًا. |
| «{0} يجب ان يكون من النوع {1}» | وصلة نوعها **تقرير** ومرجعها ليس تعريف تقرير. | أعد اختيار المرجع واختر تعريف تقرير. |
| «{0} يجب ان يكون من النوع {1} او النوع {2}» | وصلة نوعها **مجموعة تقارير** أو **مجموعة لوحات** ومرجعها ليس مجموعة ولا مجموعة تقارير أو لوحات. | اختر مجموعة من النوع الصحيح. وإن استعملت مجموعة عامة فلا بد أن يكون **النوع** فيها هو تعريف التقرير أو اللوحة، وإلا تلتها الرسالة الشقيقة «{0} يجب ان يكون مجموعة للنوع {1}». |
