...
menu: الحسابات ← المستندات ← سند قيد
---
...
ثلاثة أزرار تحمل معظم العمل اليومي على هذه المستندات.

في **سند القيد**:

- **عكس المستند** (Reverse Document) — هو الجواب على «القيد خطأ والفترة لم تعد تقبل التعديل». يفتح لك سند قيد **جديدًا غير محفوظ** ينسخ الأصل سطرًا بسطر مع تبديل المدين بالدائن، فيُلغي حفظه أثر القيد الأصلي بدل محو التاريخ. يجب أن يكون الأصل محفوظًا أولًا، والقيد العكسي سند عادي: تختار له تاريخه الفعلي وفترته ودفتره قبل الحفظ.
- **حذف السطور الصفرية** (Delete Empty Lines) — يزيل كل سطر تفاصيل مدينه ودائنه صفر أو فارغان. مفيد بعد لصق السطور أو استيرادها، حيث تأتي معها سطور فارغة تمنع القيد من التوازن بشكل نظيف.

في **سند تغيير سعر الصرف**:

- **مطالعة النتائج** (Preview Results) — يحسب إعادة التقييم ويملأ سطور المستند بما *سيُسجَّل* لكل رصيد وفق السعر الجديد، لتراجع الفروق قبل الاعتماد. شغّله بعد تحديد الحساب (أو نطاق الحسابات) والعملة والسعر الجديد والحساب الوسيط؛ ويجب أن يكون المستند محفوظًا أولًا.
