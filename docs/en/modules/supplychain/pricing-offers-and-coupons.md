...
The shared document-level discount, offer, and loyalty-point mechanics are documented in the [Invoicing module](/en/modules/invoicing/) (the discounts, offers, and reward-points guides). This page focuses on the supply-chain-specific pricing entities and refers to those guides where they intersect, to avoid duplication.
:::
...
![Sales price list screen in NaMa ERP](../../../modules/supplychain/images/pricing/sales-price-list-en.png)
...
![Sales offers screen in NaMa ERP](../../../modules/supplychain/images/pricing/sales-offers-en.png)
...
- [Invoicing module](/en/modules/invoicing/) - document-level discount, offer, and loyalty mechanics
