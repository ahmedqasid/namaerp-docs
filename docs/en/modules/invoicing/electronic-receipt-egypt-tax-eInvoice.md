...
![Register POS screenshot](../../../modules/invoicing/images/electronic-receipt-register-pos.png)

When you click "Register POS", the following window appears:

![Register POS Details](../../../modules/invoicing/images/electronic-receipt-register-pos-details.png)
...
* Select the Vendor and Model approved by the Authority
  ![Nama ERP system name in egtax website](../../../modules/invoicing/images/electronic-receipt-register-system-name.png)
...
1. Go to Tax Authority settings in the system:
   ![Nama ERP Tax Authority Configuration](../../../modules/invoicing/images/electronic-receipt-nama-tax-config.png)
...
![Receipt Serials in Nama ERP](../../../modules/invoicing/images/electronic-receipt-nama-serials.png)
...
![Minimum Value For Personal Receipts](../../../modules/invoicing/images/electronic-receipt-nama-min-value-for-personal.png)
