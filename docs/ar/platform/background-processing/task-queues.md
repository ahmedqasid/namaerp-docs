...
menu: الأساسيات ← الإعدادات ← طابور المهام
---
...
رسائل ترفض حفظ مسار كيان ضُبطت فيه حقول الخلفية المذكورة في هذه الصفحة.

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| «يجب تفعيل الأوبشن ( يعمل بعد حفظ المستند نهائيا و التأثير على قاعدة البيانات ) لإستخدام الأوبشن ( انتظار انتهاء معالجة الكميات )» | عُلِّم **انتظار انتهاء معالجة الكميات** على مسار ما زال يعمل داخل الحفظ. ولا شيء ينتظره، فالأعمال المخزنية لم تُرفع بعد عند تلك اللحظة. | علّم **يعمل بعد حفظ المستند نهائيا و التأثير على قاعدة البيانات** أولًا، أو أزل علامة الانتظار. |
| «يجب تفعيل الأوبشن ( يعمل بعد حفظ المستند نهائيا و التأثير على قاعدة البيانات ) لإستخدام ( {0} )» | عُبِّئ **Retry Every Seconds** أو **Max Retry Count** على مسار ما زال يعمل داخل الحفظ. وإعادة المحاولة لا معنى لها إلا بعد تأجيل المسار، فالفشل داخل الحفظ جزء من الحفظ نفسه. | أجّل المسار، أو أفرغ حقل إعادة المحاولة الذي تسمّيه الرسالة. |
| «يوجد إدخالات نظامية لم يتم معالجتها لمسار الكيان الحالى» | ما زالت للمسار مدخلات تنتظر في طابور، وحفظه الآن يغيّر القواعد تحت عمل جارٍ بالفعل. | اترك الطابور يفرغ — تابع جدول **مسارات الكيانات في قائمة الانتظار** — ثم احفظ. |
