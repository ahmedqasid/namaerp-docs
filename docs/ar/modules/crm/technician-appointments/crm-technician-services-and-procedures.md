...
**الخدمة الفنية** (Technician Service) مهمة واحدة: *تركيب وحدة داخلية*، *تمديد خط الصرف*، *اختبار وتسليم*. و**الإجراء الفني** (Technician Procedure) هو العمل الذي يطلبه العميل فعلاً — *تركيب مكيف* — وهو ليس أكثر من قائمة مسمّاة بالخدمات التي يتكون منها ذلك العمل.
...
وفي المثال أعلاه يحمل الإجراء `TP-01 - تركيب مكيف سبليت` (*Split Unit Installation*) أربعة أسطر: *تركيب وحدة داخلية* و*تركيب وحدة خارجية* و*تمديد خط الصرف* و*اختبار وتسليم*.
...
استعمله حين يؤدي قسمان عملين مختلفين حقاً، مثل قسم تركيب وقسم صيانة، كي لا يرى موظف الحجز في أحدهما قائمة أعمال الآخر على التقويم.

والقصر لا يسري إلا في تقويم الحجز. أما منتقي **إجراء فني** في شاشة الموعد نفسها فيعرض كل الإجراءات.
:::
...
4. ثم انتقل إلى [فرق الفنيين](/ar/modules/crm/technician-appointments/crm-technician-crews) حيث تقول أيّ الفرق مؤهلة لأيّ الإجراءات.
