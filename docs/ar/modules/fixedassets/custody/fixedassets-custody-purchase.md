...
أو اترك المبلغ كله متبقياً وسدّده لاحقاً بسندات دفع، أو ابنِ جدول أقساط بإجراء **إنشاء الدفعات**
وسدّد الأقساط عند استحقاقها. وتظهر السندات المحرَّرة على الفاتورة في جدول سندات الدفع في الصفحة الثانية، ويتحرك
رقم *المتبقي* مع تسجيلها.

## تصحيح مستند

إلغاء مستند شراء العهدة أو حذفه يعكس قيده المحاسبي ويمسح السعر الذي ثبّته المستند على الصنف. وإن كان
...
ذلك فألغِ تلك المستندات أو احذفها أولاً ثم تراجع للخلف. انظر
