...
menu: إدارة النظام ← التقارير ← أداة إنشاء تقرير
---
...
رسائل ترفض حفظ سجل أداة إنشاء التقارير.

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| «يجب أن تكون شفافية صورة الخلفية بين 0 و 255» | حُدِّدت صورة خلفية وشفافيتها خارج المدى 0–255. | اجعل الشفافية داخل المدى، أو أفرغ الصورة. |
| «لا يمكنك تضمين الجداول بشرط من خلال مدخلات اذا لم تكن هناك Union Tables» | جدول **تضمين الجداول بشرط من خلال مدخلات** فيه سطور بينما **Union Tables** فارغ، فلا شيء تضمّه أو تستبعده خانات القارئ. | عبِّئ جداول الاتحاد أولًا، أو أفرغ جدول التضمين بالمدخلات. |
| «لا يمكن تكرار الجدول {0}» | سطر واحد في **تضمين الجداول بشرط من خلال مدخلات** يسمّي الجدول نفسه مرتين في أعمدة **جدول 1** … **جدول 10**. | احذف الاسم المكرر من ذلك السطر. |
| «الجروب المختار فارغ» | حقل أو مكوّن رأس يشير إلى أحد مستويات التجميع الخمسة وجدولُه بلا سطور — إما مكوّن موضوع في رأس ذلك المستوى أو تذييله، وإما حقل يطلب الإجمالي الجاري لذلك المستوى. | أضف سطورًا إلى جدول ذلك المستوى، أو اجعل الحقل أو المكوّن يشير إلى مستوى عبّأته فعلًا. |
| «نوع المدخل {0} مكرر في السطر {1} و {2}» | سطران في جدول المدخلات يحملان نوع المدخل نفسه. | أبقِ أحدهما واحذف الآخر أو غيّر نوعه. |
| «نوع المدخل {0} في السطر {1} متقاطع مع النوع {2} في السطر {3}» | نوعا مدخل متقاطعان — أحدهما يسأل عن قيمة يغطّيها مدى الآخر، فيتعارض الفلتران. | اختر أنواع مدخلات لا تغطّي المساحة نفسها. |
| «سطور {0} فارغة - لا يمكنك استعمالها في أرقام السطور» | حقل مضبوط ليعدّ السطور داخل مجموعة يسمّي مستوى تجميع جدولُه فارغ. | عبِّئ جدول ذلك المستوى، أو عُدّ داخل مستوى له سطور. |
| «لا يمكن اختيار طريقة الترتيب {0} مع تنازلي أو تصاعدي {1}» | التقرير يرتّب بجدول حقول الترتيب، بينما اختيار التصاعدي أو التنازلي واحد من الإعدادات المتغيّرة التي لا معنى لها إلا إذا اختار القارئ الترتيب عند التشغيل. | إما أن تدع القارئ يختار الترتيب بمدخل، وإما أن تثبّت التصاعدي أو التنازلي هنا. |
| «عدد مدخلات الترتيب يجب أن يكون أقل من أو يساوي {0}» | التقرير يرتّب بمدخل عند التشغيل ويسأل القارئ عن اختيارات ترتيب أكثر من سطور جدول حقول الترتيب. | أنقص العدد، أو أضف حقول ترتيب. |
| «قيمة يستعمل كقيمة افتراضية للمدخل رقم لا يمكن أن تكون أكبر من {0}» | حقل ترتيب معلَّم كافتراضي لسؤال ترتيب لا يطرحه التقرير، لأن رقمه أكبر من عدد مدخلات الترتيب. | استعمل رقمًا داخل العدد، أو ارفع العدد. |
| «قيمة يستعمل كقيمة افتراضية للمدخل رقم مكررة في السطر {0}» | حقلا ترتيب يدّعيان أنهما الافتراضي لسؤال الترتيب نفسه. | اجعل لكل سؤال ترتيب حقلًا افتراضيًّا واحدًا. |
