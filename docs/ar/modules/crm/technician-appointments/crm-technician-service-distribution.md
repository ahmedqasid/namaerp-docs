...
ويُعاد فحص هذين الحدّين عند ترحيل المستند أيضاً، فالسطر الذي كان صحيحاً حين كُتب ثم انزاح — تغيّرت قائمة خدمات الإجراء، أو نُقل أحدهم خارج الفريق — يُلتقط بدل أن يُحفظ بصمت. والرسائل تسمّي السطر المخالف، وهي مسرودة كاملة في «رسائل قد تظهر لك» أدناه.
...
|---|---|---|
| «فريق الفنيين {0} لا ينتمي إلى موعد الفني {1}» | فريق الفنيين في المعلومات الأساسية لم يبق هو الفريق المحجوز له الموعد المسمّى — وغالباً لأن فريق الموعد تغيّر بعد كتابة هذا المستند. | أعد اختيار الموعد ليُملأ الفريق منه، ثم راجع الفنيين في الجدول. |
| «الخدمة الفنية {0} لا تنتمي إلى موعد الفني {1}» | سطر في التفاصيل يسمّي خدمة ليست على إجراء الموعد — وعادة لأن قائمة خدمات الإجراء عُدِّلت بعد كتابة السطر. | استبدل الخدمة بواحدة يعرضها المنتقي الآن، أو أضفها إلى إجراء الموعد. |
| «الفني {0} لا ينتمي إلى الفريق {1}» | سطر في التفاصيل يسمّي فنياً ليس عضواً في فريق المعلومات الأساسية — وعادة لأن الفني نُقل إلى فريق آخر بعد كتابة السطر. | اختر عضواً حالياً في الفريق، أو أعد الفني إلى الفريق إن كان السطر صحيحاً. |
