...
menu: البنوك ← إذن خزانة ← إذن خزانة
---
...
![شاشة إذن الخزانة](images/treasury/treasury-bill-ar.png)
...
![شاشة شراء إذن الخزانة](images/treasury/treasury-bill-purchase-ar.png)
...
زرٌّ واحد يوفّر عليك عناءً كبيرًا حين تُثبت العائد على أذون كثيرة دفعة واحدة:

- **تجميع أذون الخزانة المستحقة** (Collect Treasury Bill) — في **إثبات عائد أذون خزانة مجمع**، يملأ جدول التفاصيل بكل إذن لم يُقفل بعد، جالبًا معه حسابه البنكي وتاريخ شرائه وتاريخ استحقاقه وقيمته الحالية ونسبة عائده وقيمة العائد. تضغطه فتجد المحفظة القائمة كلها على المستند، جاهزةً لتحذف منها ما لا تقصد إثباته.
...
|---|---|---|
| «إذن الخزانة {0} قد تم شرائه بالفعل بالمستند {1}» | يُنشأ **مستند شراء إذن خزانة** ثانٍ لإذن له مستند شراء معتمد بالفعل. | عدّل مستند الشراء القائم بدل إنشاء آخر. |
| «إذن الخزانة {0} قد تم بيعه بالمستند {1}» | للإذن مستند بيع معتمد، فلا يُباع مرة أخرى ولا يُقفَل. | إن كان البيع خطأً فاحذفه أولًا؛ وإلا فقد انتهت حياة الإذن. |
| «إذن الخزانة {0} قد تم إقفاله بالفعل بالمستند {1}» | للإذن مستند إقفال معتمد؛ والبيع والإقفال نهايتان متبادلتان. | احذف مستند الإقفال إن كان قد أُصدر خطأً، ثم بِع. |
