...
![Payroll group](../../../modules/mobile/images/hr/payroll-group.jpg)
...
![Electronic attendance log](../../../modules/mobile/images/hr/attendance-electronic-log.jpg)
...
![Comprehensive attendance log](../../../modules/mobile/images/hr/attendance-comprehensive-log.jpg)
...
![Comprehensive attendance log — present-day detail](../../../modules/mobile/images/hr/attendance-comprehensive-log-2.jpg)
...
![Create vacation request](../../../modules/mobile/images/hr/vacation-request.jpg)
...
![Create permission request](../../../modules/mobile/images/hr/permission-request.jpg)
...
![Create mission voucher](../../../modules/mobile/images/hr/mission-voucher.jpg)
...
![Loan voucher](../../../modules/mobile/images/hr/loan-voucher.jpg)
...
- **Work-starting voucher** — to document the start of work, and it can be created **based on** a prior vacation voucher.
  ...
  ![Create work-starting request](../../../modules/mobile/images/hr/work-starting-request.jpg)

- **Termination voucher** — the termination date, the **termination reason** and notes.

  ![Create termination request](../../../modules/mobile/images/hr/termination-request.jpg)
...
![Human Resources group](../../../modules/mobile/images/hr/hr-group.jpg)

- **Exit/return visa request** — the residence expiry date, the residence period in days, and notes.

  ![Create exit/return visa request](../../../modules/mobile/images/hr/exit-return-visa-request.jpg)

- **Residence renewal request** — reference fields and notes with the ability to attach a file.

  ![Create residence renewal request](../../../modules/mobile/images/hr/residence-renewal-request.jpg)
