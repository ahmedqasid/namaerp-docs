...
حين يكون مفعّلًا، يُرفَض حفظ أي من هذه المستندات إن ورد الحساب في أحد أسطرها، برسالة *«الحساب  {0} يستخدم فقط بواسطة النظام»* مع الإشارة إلى السطر المخالف:
...
- **«الحساب  {0} يستخدم فقط بواسطة النظام» عند حفظ سند قيد أو سند قبض/صرف** — الحساب مفعّل عليه **حساب خاص بالنظام**. حدِّد أي المخارج الثلاثة يناسب قبل أن تغيّر شيئًا: سجل الاستثناء هو الجواب الصحيح في الغالب الأعم، وخيار الوحدة هو الجواب الصحيح في أندر النادر.
...
|---|---|---|
| «الحساب  {0} يستخدم فقط بواسطة النظام» | الحساب في السطر المؤشَّر عليه مرفوع عليه علم **حساب خاص بالنظام**، ولا ينطبق على هذا المستند أو التاريخ أو المستخدم أيٌّ من الطرق الثلاث. | راجِع الطرق الثلاث أعلاه بالترتيب؛ وسجل استثناء لحسابٍ ونافذةٍ ونوع مستندٍ بعينها هو الجواب الصحيح في الغالب. |
| «إلى تاريخ {1} يجب أن يكون بعد من تاريخ {0}» | **من تاريخ** في سجل الاستثناء بعد **إلى تاريخ**، فلا تُفتح النافذة أصلًا. | صحّح التاريخين؛ وترك **إلى تاريخ** فارغًا يجعل الاستثناء مفتوح المدة. |
| *{0} must be of document type {1} not {2}* | سطر تفاصيل يذكر **دفترًا** أو **توجيهًا** تابعًا لنوع مستند غير النوع في عمود **نوع المستند** بالسطر. | اختر دفترًا وتوجيهًا تابعين لنوع المستند في السطر، أو أفرِغ العمود. وهذه الرسالة لا نصّ عربي لها في المنتج، فتظهر بالإنجليزية على الشاشات العربية أيضًا. |
