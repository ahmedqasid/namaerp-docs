...
features:
  ...
  - icon: 🏗️
    title: المقاولات
    details: جانب المالك وجانب مقاول الباطن جنبًا إلى جنب — العقود وتعديلاتها، الحصر والمستخلصات، الدفعات المقدمة والاحتجاز والغرامات، الموازنات، تكاليف المشروع، وفحوص الجودة
  ...
  - icon: 📐
    ...
    details: للمكاتب التي تبيع وقت العاملين وخبراتهم — عروض الأسعار والمشاريع الإدارية، حزم العمل حسب المراحل والتخصصات، المهام وأوقات التنفيذ والموافقة عليها، مصاريف المشروع، والفوترة التي تجمّع الأوقات والمصاريف غير المفوترة
    link: /ar/modules/ecpa/
  - icon: 🏭
    title: الأصول الثابتة
    details: سجل الأصول من الشراء أو الاستيراد مرورًا بالإهلاك وإعادة التقييم والنقل والصيانة حتى التخلص — إضافة إلى عهد الأصناف المسلَّمة للموظفين
    link: /ar/modules/fixedassets/
  - icon: 🚗
    title: مركز الخدمة
    details: تجارة السيارات — ورشة الإصلاح من طلب الخدمة إلى أمر الشغل والإقفال والفوترة، إلى جانب مشتريات معرض السيارات ومبيعاته وتأمينه وتمويله، مع تأجير المركبات وطابور تذاكر الاستقبال
    link: /ar/modules/servicecenter/
  - icon: ✈️
    title: السفر والرحلات
    details: لمنظّمي الرحلات ووكالات السفر — برامج سياحية قابلة لإعادة الاستخدام وملف رحلة يومي لكل مجموعة وافدة، وقسائم الفنادق والمطاعم، ودورة شراء وبيع الخدمات السياحية التي تحوّل الرحلة إلى تكلفة وإيراد
    link: /ar/modules/travel/
  - icon: 🤝
    title: خدمة العملاء
    details: خيوط البيع والحملات والمكالمات والزيارات والاستبيانات والشكاوى وطلبات الدعم وعقود الخدمة — إلى جانب منظومة صيانة معدات منفصلة لها عقودها وخطط عملها وأوامرها وفوترتها
    link: /ar/modules/crm/
  - icon: 📱
