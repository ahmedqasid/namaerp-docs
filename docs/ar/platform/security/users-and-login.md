...
- **السماح بتسجيل الدخول بعد المنع بسبب محاولات الدخول الخطأ** (Allow Login After Failed Logins) — هذا هو زر فك المنع. فحين يُمنع مستخدم بحدّ المحاولات الخاطئة المذكور أعلاه، لا ينتهي المنع من تلقاء نفسه؛ بل يفتح المدير سجل المستخدم ويحفظه ويضغط هذا الزر، فيستطيع المستخدم الدخول بكلمة السر نفسها.
