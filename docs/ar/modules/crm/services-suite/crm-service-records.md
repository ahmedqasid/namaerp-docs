...
- كل خدمة مذكورة في جدول قطع الغيار أو العُدد أو الأعطال **يجب أن تظهر أيضًا في جدول الخدمات**، وإلا رفض المستند الحفظ برسالة *Can not use the service {0} because it was not found in the services grid*.
- لا يجوز تكرار الزوج نفسه **(خدمة، قالب مهام)** في جدول الخدمات — *The service {0} in line {1} is repeated*.

والرسالتان أعلاه لا ترجمة عربية لهما، فتظهران بالإنجليزية على الشاشة العربية.
