...
menu: المبيعات ← قوائم الأسعار والعروض ← قائمة أسعار
---
...
|---|---|---|
| «قائمة الأسعار {0} لها نفس الترتيب» | قائمة أسعار أخرى نشطة تغطّي الفترة نفسها بنفس **الترتيب**، فلا يعرف المحرّك أيّ سعر يسبق. | غيّر الترتيب في إحدى القائمتين، أو فعّل **السماح بتكرار ترتيب العروض** في إعدادات سلسلة الإمداد إن كان التداخل مقصودًا. |
| «السطر رقم {0} مكرر مع السطر رقم {1}» | سطران في قائمة الأسعار لهما نفس تركيبة الصنف والمحدّدات والوحدة، فيعطيان الصنف سعرين. | احذف أحد السطرين، أو اجعل بينهما اختلافًا في محدّد حقيقي. |
| «السطر {0} يجب أن يحتوي على صنف أو تصنيف صنف وليس الاثنين معا» | السطر يذكر صنفًا **و**تصنيف صنف؛ وسطر السعر يسعّر أحدهما لا كليهما. | أفرِغ العمود الذي لم تقصده من الاثنين. |
| «السطر {0} يجب أن يحتوي على صنف أو تصنيف صنف» | السطر لا يذكر صنفًا ولا تصنيف صنف، فلا شيء يُسعَّر. | املأ أحد العمودين، أو احذف السطر. |
| «السطر {0} لا يمكن التسعير على مستوى تصنيف الصنف قبل ضبط إعداد سلسلة الإمداد التسعير على مستوى تصنيف الصنف» | السطر يسعّر تصنيف صنف وإعدادات سلسلة الإمداد لا مستوى **التسعير على مستوى تصنيف الصنف** محدَّد فيها. | حدّد مستوى تصنيف الصنف في إعدادات سلسلة الإمداد، أو سعّر الأصناف المفردة بدلًا من ذلك. |
| «السطر {0} تصنيف الصنف يجب أن يكون من نوع {1} حسب إعدادات سلسلة الإمداد» | السطر يستخدم مستوى تصنيف صنف غير الذي تعيّنه إعدادات سلسلة الإمداد للتسعير. | استخدم المستوى الذي تسمّيه الرسالة، أو غيّر الإعدادات. |
| «الصنف {1} لا يحتوي على الإصدار {0} في السطر {2}» | الإصدار المكتوب في السطر ليس من إصدارات ذلك الصنف المعرَّفة. | اختر إصدارًا من قائمة الصنف نفسه، أو أضِفه على الصنف أولًا. |
| «الصنف {1} لا يحتوي على اللون {0} في السطر {2}» | اللون في السطر غير معرَّف على ذلك الصنف. | اختر لونًا يملكه الصنف فعلًا، أو أضِفه إلى الصنف. |
| «الصنف {1} لا يحتوي على المقاس {0} في السطر {2}» | المقاس في السطر غير معرَّف على ذلك الصنف. | اختر مقاسًا يملكه الصنف فعلًا، أو أضِفه إلى الصنف. |
| «يجب عليك إختيار قواعد تطبيق العروض , لأنك قد قمت بتفعيل الأوبشن اساس الخصم من إجمالى السطور المنطبقة فقط» | سطر خصم فاتورة مرفوع عليه علم **أساس الخصم من إجمالي السطور المنطبقة** ولا **قواعد تطبيق عروض** فيه، فلا شيء يحدّد السطور المنطبقة. | اختر قواعد تطبيق العروض في السطر، أو اخفِض علم الأساس. |
| «قيمة الخصم الأدني {0} لا يمكن ان تكون اكبر من قيمة الخصم الأقصي {1}» | قيمة الخصم الأدنى والأقصى في سطر خصم الفاتورة معكوستان. | بدِّل بينهما، أو أفرِغ القيمة التي لم تقصد تحديدها. |
| «قم بتفعيل اوبشن ( تجاهل العروض الأخرى عند وجود عروض على عدد أصناف الفاتورة بها تجاهل العروض الأخرى ) من اعدادات ال Supply Chain» | سطر عرض على عدد الأصناف مرفوع عليه علم **تجاهل العروض الأخرى** والأوبشن المقابل في إعدادات سلسلة الإمداد مُطفأ، فلا يعمل السطر كما هو مكتوب. | فعّل ذلك الأوبشن في إعدادات سلسلة الإمداد، أو اخفِض علم **تجاهل العروض الأخرى** في السطر. |
| «يجب عليك إدخال نسبة او قيمة التخفيض» | سطر صنف مجاني مؤشَّر عليه **ليس مجانيًا بل بخصم** ولا نسبة خصم فيه ولا قيمة خصم. | أدخِل إحداهما، أو اخفِض علم **ليس مجانيًا بل بخصم** ليُمنح الصنف مجانًا. |
| «قيمه الفاتوره يجب ان تساوي قيمة الفاتوره -الي - {0}» | سطر كوبون يعدّ الأصناف مع قيمة الفاتورة، وكوبون العدّ يحتاج قيمة فاتورة واحدة لا مدى. | اجعل قيمة «من» مساوية لقيمة «إلى»، أو اضبط نوع عدّ أصناف البيع على **بلا**. |
| «لا يمكن ان تكون قيمة أقصى كمية {0} أقل من الكمية {1}» | سقف **أقصى كمية** في سطر عرض أو صنف مجاني أقل من كمية السطر نفسه، فلا ينطبق السطر أبدًا. | ارفع أقصى كمية، أو أنقِص الكمية. |
| «قم بتفعيل الاوبشن - تفعيل الاصناف المجانية علي قيمة الفاتورة - من اعدادات ال supply chain» | العرض يستخدم أصنافًا مجانية على مستوى الفاتورة و**تفعيل الأصناف المجانية على قيمة الفاتورة** مُطفأ في إعدادات سلسلة الإمداد. والرسالة نفسها تعود من زر احتساب العروض في الفاتورة. | فعّل ذلك الأوبشن في إعدادات سلسلة الإمداد، أو احذف سطور الأصناف المجانية على الفاتورة. |
