# استلام المخزون في المستودع (Receiving Stock into Your Warehouse)
...
### OpeningStockDocument - نظرة النظام
...
## استلام البضائع التالفة والخردة

ليس كل ما يرد في حالة جيدة.

### PurgeStockReceipt - تتبع ما لا يصلح للاستخدام
...
### StockReceiptCancellation - عكس التوريد
...
## سيناريوهات استلام خاصة

### CostRevaluation - تعديل القيم دون الكميات
...
### WeightScalePreparationDoc - التعامل مع المواد السائبة
...
## الاستلام من مصادر محددة

تحتاج المصادر المختلفة للمخزون إلى معالجة مختلفة:

### ProductDelivery - من التصنيع
...
### RawMaterialReturn - العودة من الإنتاج
...
### ReceiptInspection - حارس البوابة
...
## إدارة المستودعات المتعددة والمواقع
...
## فهم حركات المخزون خلف الكواليس
