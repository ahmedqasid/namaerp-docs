...
menu: مركز خدمة ← المستندات ← تصريح عبور البوابة
---
...
|---|---|---|
| «بناءا على يجب ان تكون أمر شغل» | حقل *بناءا على* مملوء بمستند ليس أمر شغل، وخيار **السماح بعمل التصريح بدون أمر شغل** غير مفعّل على التوجيه. | وجّه *بناءا على* إلى أمر الشغل الذي نُفِّذ العمل تحته. |
| «لا توجد فاتورة عميل لأمر الشغل {0}» | سطر مهمة أو خامة على الأمر يحمل نصيباً على العميل، وفاتورة العميل للأمر إما غير موجودة وإما ما زالت مسودة. فلا يُحتسب إلا المرحَّل. | أصدر فاتورة العميل ورحّلها، أو فعّل **السماح بعمل التصريح بدون فاتورة العميل** على التوجيه إن كانت الورشة تفرج قبل الفوترة. |
| «لا توجد فاتورة تأمين لأمر الشغل {0}» | الأمر نفسه بالنسبة لنصيب التأمين وفاتورة التأمين. | رحّل فاتورة التأمين، أو فعّل **السماح بعمل التصريح بدون فاتورة التأمين**. |
| *The order {0} does not have an warranty invoice* (بنص المنتج نفسه؛ ولا نص عربي لهذه الرسالة، فتظهر بالإنجليزية على الشاشات العربية كذلك) | الأمر نفسه بالنسبة لنصيب الضمان وفاتورة الضمان. | رحّل فاتورة الضمان، أو فعّل **السماح بعمل التصريح بدون فاتورة الضمان**. |
| «الفاتورة {0} ليست مدفوعة بالكامل. المتبقي {1}» | الفاتورة موجودة ومرحَّلة لكن عليها متبقٍ، وخيار *بدون الدفع بالكامل* المقابل غير مفعّل. والرسالة نفسها تغطي فاتورة العميل والتأمين والضمان — فاقرأ أيها تسمّي. | حصّل المتبقي، أو فعّل خيار **السماح بعمل التصريح بدون دفع فاتورة … بالكامل** المقابل على التوجيه. |
