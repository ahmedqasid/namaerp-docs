...
- **Zid**
- **WooCommerce**
- **Amazon** (واجهة SP-API) — راجِع [إشعارات طلبات أمازون](/ar/modules/ecommerce/amazon-order-notifications.md) لإنشاء أوامر البيع تلقائيًا من الطلبات المشحونة
...
|---|---|---|
| «موقع ماجنتو {0} لا يمكن استخدامه لربط الأصناف, الرجاء التاكد من تفعيل الأوبشن {1}» | مستند ربط الأصناف يشير إلى موقع خيار **ربط الأصناف** فيه مرفوع، فالموقع غير مهيأ لاستقبال روابط الأصناف. | علّم على خيار ربط الأصناف في الموقع، أو اربط الأصناف بموقع مهيأ لذلك. |
| «لا يجب ترك الحقلين فارغين {0} , {1} , يجب علي الأقل ملئ واحد منهم» | مستند تحديث الأسعار لا يسمّي مصدر سعر خاص ولا مصدر سعر أصلي، فلا شيء يُرسله. | املأ أحد المصدرين على الأقل. |
| «لا يمكن ترك من تاريخ وإلي تاريخ للسعر الخاص فارغين» | المستند يحمل مصدر سعر خاص لكن «من تاريخ» أو «إلى تاريخ» للسعر الخاص فارغ؛ والسعر الخاص لا بد له من نافذة زمنية. | املأ التاريخين، أو افرغ مصدر السعر الخاص. |
| «لا يمكنك إنشاء أكثر من ملف من النوع {0} للمتجر الإلكتروني {1}» | يوجد سجل إعداد أقسام مرحَّل لذلك الموقع بالفعل. فسجل إعداد واحد لكل موقع. | افتح السجل القائم وعدّله بدلًا من إنشاء ثانٍ. |
