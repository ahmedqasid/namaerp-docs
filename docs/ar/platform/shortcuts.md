...
## اختصارات الجداول
متاحة أثناء تحرير جداول التفاصيل في شاشة التحرير. و**مفتاح Insert وحده لا يفعل شيئًا** — فكل مفاتيح
الصفوف هي Insert مع مفتاح مُعدِّل.

- **Ctrl + Insert**: إضافة صف فارغ جديد بعد الصف الحالي. ويُرفض ما دام هناك صف فارغ مفتوح: *«Could not insert new line while you have an empty line»*
- **Shift + Insert**: نسخ الصف الحالي إلى صف جديد. ويُرفض على صف فارغ: *«Could not duplicate empty line»*
...
::: tip إضافة صف والجدول مفلتر
إذا كان على الجدول فلتر عمود، سأل النظام أولًا — *«الجددول يوجد به فلاتر حاليا. السطر المراد إضافته قد لا يظهر مع السطور الحالية بالرغم من إضافته فعليا. هل أنت متأكد؟»*. والصف يُضاف في الحالتين، وإنما الفلتر هو الذي يخفيه.
:::
...
- **Ctrl + R**: حفظ مسودة — يحفظ السجل دون اعتماده
- **Alt + R**: عكس المستند
- **Alt + N**: سجل جديد
...
### صفوف الجداول
- **Alt + Ctrl + N**: إضافة صف
- **Shift + Insert**: إدراج صف — وفي جداول شاشات التحرير ينسخ الصف الحالي كما سبق أعلاه
...
مفتاحان يعملان في أي مكان في النظام مهما كانت الشاشة المفتوحة:

- **Ctrl + K**: الانتقال إلى خانة البحث في الشريط العلوي (البحث العام)
- **Ctrl + U**: فتح القائمة الجانبية ووضع المؤشر في خانة بحثها

وهذان يسكنان جدولًا منفصلًا في تعريف الاختصارات نفسه، وذلك الجدول يقبل أكثر من البحث: فالسطر يستطيع
أن يربط مفتاحًا بـ**فتح قائمة كيان**، أو **إنشاء سجل جديد من نوع ما**، أو **فتح سجل بعينه**، أو
**فتح رابط** داخلي أو خارجي. وبهذا يعطي التطبيق أمينَ المخزن مفتاحًا واحدًا لـ«صرف مخزني جديد».
