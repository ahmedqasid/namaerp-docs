...
|---|---|---|
| «الصنف {0} لا يحتوي على الوحدة {1}» | الوحدة في كمية الرأس — الوحدة التي تنتج بها القائمة — ليست من وحدات الصنف المنتَج. | استخدم إحدى وحدات الصنف، أو أضف الوحدة إلى ملف الصنف. |
| «الصنف {0} في السطر {1} لا يحتوي على الوحدة {2}» | الفحص نفسه على سطر مكوّن أو سطر منتج مشترك: الوحدة المكتوبة فيه غير معرَّفة على ذلك الصنف. | غيّر الوحدة في السطر، أو أضفها إلى الصنف. |
| «العملية {0} ليست من عمليات التشغيل {1}» | سطر مكوّن مُسنَد إلى رقم عملية لا يحتويه مسار التشغيل المختار. وغالبًا يظهر بعد تغيير مسار التشغيل تحت قائمة جاهزة. | أعد ترقيم المكوّن إلى عملية موجودة فعلًا في المسار، أو أعد العملية إلى المسار. |
| «لا يمكن ترك الصنف و تصنيف المكون كلاهما فارغين, يجب أن يكون إحداهما له قيمة» | سطر مكوّن لا يذكر صنفًا ولا تصنيف مكوّن. وهذه الصيغة تظهر عند تفعيل **السماح بترك الصنف فارغًا في سطور قائمة المكونات إذا وُجد تصنيف المكوّن**؛ ومع إيقافه يصبح الصنف مطلوبًا بلا أكثر. | اذكر الصنف، أو اذكر التصنيف الذي سيُختار منه الصنف وقت الإنتاج. |
| «قيمة التكلفة لايمكن ان تكون صفر» | سطر منتج مشترك مضبوط على تقاسم التكلفة بالنسبة والنسبة فارغة أو صفر، فلن يحمل شيئًا من تكلفة الأمر. | أعطِه نسبة، أو غيّر نوع تكلفة السطر إلى تكلفة ثابتة. |
| «بالنسبة للأوبشن {0} في سطور{1} - سطر واحد فقط يمكنه تفعيل هذا الأوبشن» | أكثر من سطر مكوّن معلَّم فيه **مكمِّل الوزن**. ولا يقوم بهذا الدور إلا مكوّن واحد في القائمة. | أزل العلامة عن الجميع إلا المكوّن الذي يستوعب فرق الوزن. |
| «القيمة المئوية للتكلفة اكبر من المئة» | مجموع نسب تكلفة المنتجات المشتركة يتعدى المئة، فيُحمَّل الأمر تكلفة أكثر مما يحمل. | أعد النسب إلى مئة أو أقل. وهذه الرسالة مخزَّنة بالعربية فقط فتظهر بالعربية على الشاشة الإنجليزية أيضًا، وتُرفع على رقم سطر ثابت هو 1 لا على السطر المخالف. |
