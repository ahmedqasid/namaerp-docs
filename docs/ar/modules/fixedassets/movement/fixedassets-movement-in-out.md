...
وإلغاء مستند أو حذفه يرفع وحداته من المجموع الجاري ويعيد حساب العدّادات مما بقي، فالتصحيحات آمنة —
فأنت لا ترقّع رقماً مخزَّناً بيدك أبداً.

## الإجراءات في هاتين الشاشتين

لا سند الخروج ولا سند الرجوع فيه زر خاص به. تسمّي الأصل والكمية الخارجة أو العائدة، ثم تحفظ وتعتمد؛
فتتحرك العدّادات الموصوفة أعلاه عند الاعتماد وترجع عند إلغاء المستند أو حذفه.
