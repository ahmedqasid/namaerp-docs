...
- **التفويض (Delegation)**: من ينوب عن مستلمٍ خلال فترة تفويض سارية يُضاف إلى القائمة تلقائياً — انظر *التفويض: إيصال التنبيه إلى النائب* أدناه

::: tip حين لا تعرض قائمة المستلمين نوع السجل الذي تريده
لا تعرض قوائم اختيار المستلم إلا أنواع السجلات التي سمح بها المسؤول كمستلمي بريد. فإن كان النوع الذي تحتاجه — طرف آخر أو جهة اتصال أو سائق — غائبًا عن القائمة، فأضفه في [أعدادات الحقول و الشاشات](/ar/platform/fields-and-entities-settings/fields-settings-record-behaviour) فيصير قابلًا للاختيار في كل موضع يُختار فيه المستلمون.
:::
...
### التفويض: إيصال التنبيه إلى النائب

التنبيه الذي يصل إلى صندوق موظف في إجازة أسبوعين هو تنبيه لا يتصرف فيه أحد. فحين يكون للموظف مستند **تفويض (Delegation)** ساري — المستند نفسه الذي تُنقل به الاعتمادات المعلقة إلى النائب — يمدّ النظام التنبيهات على المنوال ذاته.

فطوال فترة التفويض يُرفع كل تنبيه موجّه إلى المفوِّض للنائب أيضاً. وتحمل نسخة النائب حقل **مفوض من (Delegated From)** يذكر المستلم الأصلي، فيعرف من أول نظرة أن الرسالة تخص عمل غيره. ولا يُنتزع شيء من المستلم الأصلي — تبقى نسخته كما هي، فلا يضيع شيء إن اطّلع على النظام من إجازته.

والنائب يدخل قائمة المستلمين نفسها، أي أنه يُبلَّغ عبر كل القنوات التي يستعملها التعريف — تنبيه داخل التطبيق أو بريد أو رسالة قصيرة أو واتساب — لا لوحة التنبيهات وحدها. وهذا مقصود لتغطية الإجازات، لكن من الجدير معرفته قبل أن تفوّض شخصاً عن موظف كثيف التنبيهات.

ويتحكم في هذا السلوك مفتاحان:

- **عدم تطبيق التفويض (Do Not Apply Delegation)** في تعريف التنبيه يوقف التفويض لهذا التعريف وحده. استعمله للرسائل التي يجب ألا تخرج عن صاحبها: تغييرات الرواتب، والمسائل التأديبية، وكل ما لا يرضى الموظف أن يقرأه زميله.
- **عدم إرسال التنبيهات للموظف المفوض (Do Not Send Notifications To Delegated Employee)** في [الإعدادات العامة](/ar/platform/global-config/global-config-notifications) يوقف السلوك على مستوى التركيبة كلها.

وتنبيهات [المهام المجدولة](/ar/platform/scheduled-tasks) تتبع القاعدة نفسها. وليس للمهمة المجدولة مفتاح خاص بها، فلا ينطبق عليها إلا الإعداد العام.

::: tip التنبيهات التي كانت منتظرة من قبل
يغطي التفويض التنبيهات التي تُرفع *أثناء* سريان الفترة، ولا يرجع إلى الرسائل التي تراكمت قبل إنشاء التفويض. ولهذه افتح مستند التفويض واستعمل **المزيد ← نقل الإشعارات إلى الموظف المفوض**. فينتقل كل تنبيه غير مقروء للمفوِّض يقع تاريخه داخل فترة التفويض إلى النائب، ويُوسم بـ**مفوض من**.

ولاحظ الفرق: هذا *نقل* حقيقي — تغادر التنبيهات قائمة المفوِّض — بينما التفويض الجاري ينسخها. فهو أداة لحالة «المدير في إجازة بالفعل وصندوقه ممتلئ»، لا للتغطية الاعتيادية. ويجب أن يكون المستند محفوظاً ومعتمداً قبل تشغيل الإجراء.
:::
