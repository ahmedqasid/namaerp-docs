export const SIDEBAR_CONFIG = {
  ...
  "/guide" : [ {
    ...
    children: [ "/full-search.md", {
      text: "Guides",
      collapsible: true,
      children: [ "/guide/docs-quick-guide.md", "/guide/utils.md", "/guide/system-minimum-requirements.md", "/guide/installation-guide.md", "/guide/troubleshooting-system-hanging.md", "/guide/reports-guide.md", "/guide/shortcuts.md", "/guide/screen-modifier.md", "/guide/list-views/", "/guide/approvals-system.md", "/guide/entity-flows/", "/guide/report-wizard-guide.md", "/guide/bi-module-guide.md", "/guide/bi-module-technical-reference.md", "/guide/invoices/", "/guide/supplychain/", "/guide/manufacturing/", "/guide/tempo.md", "/guide/invoice-retriever.md", "/guide/sms-and-whatsapp.md", "/guide/two-factor-authentication.md", "/guide/field-filter-with-criteria.md", "/guide/translations.md", "/guide/criteria-based-validation.md", "/guide/attendance-machine-formula.md", "/guide/attendance-machines-integration.md", "/guide/notifications-system.md", "/guide/scheduled-tasks.md", "/guide/nama-properties.md", "/guide/mobile-application-guide.md", "/guide/mobile-qr-integrator.md", "/guide/GenericReferenceOverrider_UserGuide.md", "/guide/ReportWizard_User_Documentation.md", "/guide/oracle-jdbc-connection.md", "/guide/nama-erp-api.md", "/guide/text-criteria-guide.md", "/guide/dev-request-guidelines.md", "/guide/e-commerce/", {
        text: ".",
        "link" : "/guide/"
      } ]
    }, "/examples/", "/reprocessing/", "/faq/", {
