...
|---|---|---|
| «لا يوجد خامات في مستند التخطيط: {0}» | الصرف يشير إلى مستند تخطيط جدول خاماته فارغ، فلا شيء يُسحب من المخزن. | افتح مستند التخطيط ونفّذ عملية التحسين ليُستخرج الخامات، ثم عُد. |
| «لا يمكن ايجاد سطر المصدر لتصنيف الصنف {0} - {1} - {2} في مستند التخطيط {3}» | سطر في الصرف يصف تركيبة من تصنيفَي الصنف والصندوق لم ينتجها مستند التخطيط قط — وغالبًا لأن السطر كُتب يدويًا، أو أُعيد تحسين مستند التخطيط بعد إنشاء الصرف. | خُذ السطور من مستند التخطيط لا بالكتابة، وأعد بناء الصرف إن تغيّرت الخطة بعده. |
| «لا يوجد أمر انتاج منشأ بواسطة مستند التخطيط: {0}» | الترحيل يحتاج أمر الإنتاج الذي ولّده مستند التخطيط، ولا وجود لأمر كهذا — فالخطة لم تُحوَّل إلى أوامر، أو حُذف الأمر. | ولّد أوامر الإنتاج من مستند التخطيط أولًا؛ فصرف الخامات يحمّل خاماته عليها. |
