...
2. **هل مستخدمك مرتبط بموظف؟** إن لم يكن توقفت الشاشة برسالة *«حساب المستخدم الخاص بك غير مرتبط بموظف، لذلك لا يمكن تحديد الفريق الذي تنتمي إليه. اطلب من مدير النظام ربط حسابك ببطاقة الموظف الخاصة بك.»* — وهذا بالضبط ما ينبغي عمله.
...
وإن لم يجد أيٌّ من هذه فريقاً قالت الشاشة *«أنت لست عضواً في أي فريق فنيين، لذلك لا يوجد جدول لعرضه. اطلب من مدير النظام إضافتك إلى فريق.»* فأضف الموظف في [الفريق](/ar/modules/crm/technician-appointments/crm-technician-crews)، أو انقله إليه بـ[سند نقل](/ar/modules/crm/technician-appointments/crm-technician-transfers). ويرى مدير النظام أو المشرف الرسالة نفسها إن لم يكن في نطاقه فريق بعد.
