...
::: warning كل وحدة يجب أن تصل إلى الوحدة الأساسية مباشرة
النظام لا يسلسل معاملات التحويل. فالبالتة التي فيها ٥٠ كرتونًا تحتاج سطرها الخاص `1 بالتة = 1200 زجاجة` — ولا يكفي تعريفها بـ `1 بالتة = 50 كرتون` اعتمادًا على أن النظام سيضرب عبر سطر الكرتون؛ عندئذٍ يرفض الصنف الحفظ برسالة *لم يمكن العثور علي تحويل بين الوحدة الأساسية والوحدة*. و[وحدات القياس](./units-of-measure.md) تشرح مجموعات الوحدات والتحويلات المشتركة وبقية الموضوع بالتفصيل.
:::
...
- **إضافة الصنف الي قائمة سعر بيع** (Add Item To Sales Price List) و**إضافة الصنف الي قائمة سعر شراء** (Add Item To Purchase Price List) و**إضافة الصنف الي ملف التصويت على الأصناف** (Add Item To Item Voting File) و**إضافة الصنف الي ملف التصويت على الأسعار** (Add Item To Price Voting File) — يسأل كلٌّ منها عن القائمة أو الملف المقصود، ثم يضع الصنف فيه. وهي توفّر عليك فتح القائمة والبحث فيها عن الصنف.
- **عكس حالة حذف السطور** (Reverse Delete Case) — في جدول الكلمات الدالة، يقلب علامة الحذف في كل سطر، فتُعلَّم مجموعة كاملة للحذف أو تُستثنى منه بضغطة واحدة.

**في مستند تحديث الأصناف:** **نسخ إلى الصنف** (Copy To Item) — يكتب ما يحمله المستند من تغييرات على الأصناف المستهدفة. ولا ينتقل شيء إلى الأصناف قبل تشغيله.

**في منشئ الأصناف المتعدد:** **انشاء الأصناف** (Generate Items) — ينشئ الأصناف الفعلية من التوليفات المعرَّفة في المستند.

**في مجموعة مقاسات وألوان الصنف:** **إنشاء مصفوفة** (Generate Item Color Size) — يبني المصفوفة من سطور الألوان وسطور المقاسات، فيعطيك كل توليفة لون ومقاس بدل كتابتها.

**في تشكيلة الأصناف:** **إنشاء مصفوفة ألوان ومقاسات من كل احتمالات البيانات المدخلة بالسطور** (Create Assortment From Lines Data) — والاسم يصف عمله: ينشئ التشكيلة من كل احتمالات البيانات المدخلة في السطور.
...
بطاقة الصنف ترفض الحفظ حين تتعارض مفاتيحها مع جداولها. أما الرفوض المتعلقة بالوحدات - المعدلات والوحدة الأساسية والوحدات المحذوفة - فهي في [وحدات القياس](./units-of-measure.md).

| الرسالة | لماذا | ما تفعله |
|---|---|---|
| «لايمكن اعادة استعمال طلب اضافة الصنف {0} حيث انه تم استعمالة فى الصنف {1}» | طلب إضافة الصنف المذكور في هذا الصنف استُهلك بالفعل في الصنف الآخر الذي تذكره الرسالة. فالطلب الواحد يُنتج صنفًا واحدًا. | افرغ الحقل، أو أنشئ طلب إضافة صنف جديدًا لهذا الصنف. |
| «الألوان غير مفعلة» | سطر في جدول محددات الصنف يحمل لونًا و**له ألوان** غير مفعّل في الصنف. | فعّل **له ألوان**، أو افرغ اللون من ذلك السطر. |
| «المقاسات غير مفعلة» | سطر في جدول المحددات يحمل مقاسًا و**له مقاسات** غير مفعّل. | فعّل **له مقاسات**، أو افرغ المقاس من السطر. |
| «الشحنات غير مفعلة» | سطر في جدول المحددات يحمل دفعة و**له دفعات** غير مفعّل. | فعّل **له دفعات**، أو افرغ الدفعة من السطر. |
| «الإصدارات غير مفعلة» | سطر في جدول المحددات يحمل إصدارًا و**له إصدارات** غير مفعّل. | فعّل **له إصدارات**، أو افرغ الإصدار من السطر. |
| «النسبة ابفعالة غير مفعلة» | سطر في جدول المحددات يحمل نسبة فعّالة والخيار غير مفعّل في الصنف. والنص العربي فيه خطأ إملائي من المنتج نفسه. | فعّل الخيار، أو افرغ النسبة من السطر. |
| «النسبة الغير فعالة غير مفعلة» | سطر في جدول المحددات يحمل نسبة غير فعّالة والخيار غير مفعّل. | فعّل الخيار، أو افرغ النسبة من السطر. |
| «الصنف الفرعي غير مفعل» | سطر في جدول المحددات يذكر صنفًا فرعيًا والخيار غير مفعّل. | فعّل الخيار، أو افرغ الصنف الفرعي من السطر. |
| «ألمحددات مكررة مع سطر آخر» | سطران في جدول المحددات يصفان التركيبة نفسها تمامًا - المخزن والموقع واللون والمقاس والدفعة والصندوق والإصدار والنسب والصنف الفرعي والمحددات التحليلية. وترتفع الرسالة على السطرين معًا. | ادمج السطرين، أو اجعل أحدهما مختلفًا. وإن كان التكرار مقصودًا فعلًا فخيار *السماح بتكرار تفاصيل الصنف* في إعدادات سلاسل التوريد يرفع الفحص. |
| «أقل كمية يجب أن تكون أقل من أو تساوي أقصى كمية» | سطر في جدول المحددات أقل كمية فيه أكبر من أقصى كمية. والسطور التي يُترك فيها أحد الرقمين فارغًا أو صفرًا لا تُفحص. | صحّح أحد الرقمين. |
| «الإصدارات يجب أن تكون فارغة في حالة عدم تفعيلها» | جدول الإصدارات به سطور و**له إصدارات** غير مفعّل. وإيقاف الخيار لا يفرغ الجدول تلقائيًا. | احذف سطور الإصدارات، أو أعد تفعيل **له إصدارات**. |
| «معرف الإضدارة مكرر» | سطران في جدول الإصدارات يتشاركان معرّف الإصدار نفسه. وترتفع الرسالة على السطرين معًا. | أعطِ كل إصدار معرّفًا خاصًا به. |
| «يجب تفعيل الشحنات لتتمكن من تفعيل تاريخ الصلاحية» | فُعّل **له تاريخ صلاحية** و**له دفعات** غير مفعّل. وتاريخ الصلاحية يتبع الدفعة، فلا مكان لتسجيله بدون دفعات. | فعّل **له دفعات** أولًا ثم **له تاريخ صلاحية**. |
| «لا يمكن تحديد ألوان أو مقاسات إذا لم يكونوا مفعلين» | جدول المقاسات والألوان به سطور و**له مقاسات** و**له ألوان** كلاهما غير مفعّل. | فعّل أحدهما على الأقل، أو أفرغ الجدول. |
| «لا يمكن تحديد مقاس إذا لم تكن المقاسات مفعلة» | سطر في جدول المقاسات والألوان يحمل مقاسًا و**له مقاسات** غير مفعّل - فالصنف بالألوان وحدها. | افرغ المقاس من السطر، أو فعّل **له مقاسات**. |
| «لا يمكن تحديد لون إذا لم تكن الألوان مفعلة» | سطر في جدول المقاسات والألوان يحمل لونًا و**له ألوان** غير مفعّل - فالصنف بالمقاسات وحدها. | افرغ اللون من السطر، أو فعّل **له ألوان**. |
| «لا يمكن استخدام لا يمكن بيعه ولا يمكن شراؤه في سطور المقاسات و الألوان بدون تفعيل هذه الخاصية في إعدادات المخازن» | سطر في جدول المقاسات والألوان موسوم بأنه لا يمكن بيعه أو لا يمكن شراؤه وخيار *تفعيل لا يمكن بيعه ولا يمكن شراؤه في سطور الألوان والمقاسات* في إعدادات سلاسل التوريد غير مفعّل. | فعّل الخيار، أو ألغِ الوسم من السطور. |
| «يجب تحديد لون واحد على الأقل» | **له ألوان** مفعّل ولا يذكر أي سطر في جدول المقاسات والألوان لونًا. | أضف ألوان الصنف، أو أوقف **له ألوان**. |
| «يجب تحديد مقاس واحد على الأقل» | **له مقاسات** مفعّل ولا يذكر أي سطر في جدول المقاسات والألوان مقاسًا. | أضف مقاسات الصنف، أو أوقف **له مقاسات**. |
| «لا يمكنك حذف السطور الخاصة بالحقل {0} - {1} لان له {2} حركات» | حُذف لون أو مقاس أو إصدار من الصنف بعد تسجيل حركات مخزنية أو سطور قوائم أسعار عليه. والرسالة تذكر الحقل والقيمة المحذوفة وعدد السجلات التي تستعملها. | أعد السطر. وخيارا *السماح بالحذف من ألوان ومقاسات الصنف بعد الحركات* و*السماح بالحذف من إصدارات الصنف بعد الحركات* في إعدادات سلاسل التوريد يرفعان الفحص إن كان التاريخ قابلًا للتخلي عنه فعلًا. |
| «لا يمكنك تغيير نوع الصنف من خدمة الى صرف او العكس بعد استخدامة فى سند الصرف , التوريد المخزني او التحويل المخزني» | غُيّر نوع الصنف بين خدمي ومخزني بعد أن حملته سندات صرف أو توريد أو تحويل محفوظة. والصنف الخدمي لا يحمل كمية، فتلك المستندات تفقد معناها. | اترك النوع كما هو وأنشئ صنفًا ثانيًا بالنوع الصحيح. |
| «لا يمكنك تغيير الاعدادات بعد عمل حركة» | تغيّرت **الإعدادات** المرتبطة بالصنف - وهي التي تحدد ما تُتبَّع به التكلفة والكمية - بعد أن صارت للصنف حركات. | أبقِ الإعدادات التي استُعمل بها الصنف، أو فعّل خيار *السماح بتغيير تتبع التكلفة والكمية بعد الاستخدام* في إعدادات سلاسل التوريد مع تقبّل أن الأرصدة القائمة تُتبَّع بالطريقة القديمة. |
