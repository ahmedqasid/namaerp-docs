...
menu: الرواتب ← الأساسيات ← مستند الزياده السنوية
---
...
|---|---|---|
| «يمكنك ملء الحقل نسبة الزيادة في الأساسي التأميني الثابت أو حقل القيمة و ليس كلاهما معا» | كلٌّ من **نسبة الزيادة في الأساسي التأميني الثابت** و**قيمة الزيادة في الأساسي التأميني الثابت** يحمل رقمًا، فتصبح الزيادة الشاملة قابلة للقراءة بوجهين. | أبقِ النسبة أو المبلغ، وأفرغ الآخر. |
| «يجب ان يكون الموظف {0} فى سطور الموظفين» | سطر في جدول **الإستثناءات** يسمّي موظفًا ليس من الموظفين الذين جمّعهم المستند، فلا توجد قاعدة شاملة يتجاوزها الاستثناء. | وسّع نطاق الموظفين ليجمّع المستند ذلك الموظف، أو احذف سطر الاستثناء. |
| «يجب ان يتم إدخال مكون الراتب هدف الزيادة او مكون الراتب» | سطر استثناء لا يبيّن *ما* الذي تُرفع قيمته — فحقلا **مفرد الراتب هدف الزيادة** و**نوع المفرد** فارغان. | املأ أحدهما في ذلك السطر. |
| «مكون الراتب هدف الزيادة {0} يجب ان يكون فى التفاصيل» | الاستثناء يستهدف مفردًا لا يرفعه جدول **التفاصيل** أصلًا؛ والاستثناء لا يتجاوز إلا قاعدة شاملة قائمة. | أضف المفرد إلى جدول التفاصيل، أو وجّه الاستثناء إلى مفرد تشمله الجولة فعلًا. |
| «الموظف {0} مع مكون الراتب {1} مكرر فى السطر {2} و {3}» | سطرا استثناء يعطيان الموظف نفسه معاملتين مختلفتين للمفرد نفسه. | احذف أحد السطرين — والرسالة تذكر رقميهما. |
