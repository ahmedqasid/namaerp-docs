...
|---|---|---|
| «{0} لا يمكن إجراء معاملات في الفترة المغلقة» | التاريخ الفعلي للمستند يقع في فترة مغلقة عليك — إما مغلقة على المستوى الأساسي، أو مغلقة على جهتك بقاعدة في «تحديث حالة السنة المالية». | انقل التاريخ الفعلي إلى فترة مفتوحة، أو افتح الفترة، أو امنح استثناء «تجاهل الفترات المغلقة» للجهة أو لنوع المستند. |
| «لا يمكن حذف مستندات في فترة مغلقة» | حذف مستند تاريخه الفعلي في فترة مغلقة. فالحذف يُفحص كما يُفحص الحفظ. | افتح الفترة أو امنح الاستثناء، ثم احذف. |
| «التاريخ الفعلي {0} خارج نطاق تواريخ الفترة المالية [{1} - {2}]» | الفترة المالية المسمّاة على المستند لا تحتوي التاريخ الفعلي. وهذه ليست قاعدة إقفال، وإنما اختلاف بين الاثنين. | صحّح التاريخ الفعلي، أو دع المستند يختار فترته من جديد. |
| «لم يمكن العثور على فترة مالية للتاريخ {0} - يرجي تعريف سنة مالية او فترة مالية لهذا التاريخ» | لا توجد فترة مالية تغطي ذلك التاريخ أصلاً — وغالباً ما يحدث مع مستند متكرر يدخل سنة لم يعرّفها أحد بعد. | عرّف السنة المالية وفتراتها لذلك التاريخ. |
