...
![صفحة إعدادات الحقول](./images/security-profile-field-settings-ar.png)
...
![صفحة صلاحيات الصفحات](./images/security-profile-page-security-ar.png)
...
![صفحة صلاحيات مطالعة القوائم](./images/security-profile-listview-security-ar.png)
...
- **اقل عدد حروف للبدأ بالبحث** (على سطور الصلاحيات الأساسية) يمنع البحث المرجعي من سرد الملفات الضخمة — راجع [ملف الصلاحيات](/ar/platform/security/security-profiles.md).
...
- يمكن أيضاً تعطيل الحقل من جدول **Disabled Fields** في [أعدادات الحقول و الشاشات](/ar/platform/fields-and-entities-settings/fields-settings-input-validation). وهذا تسهيل لإدخال البيانات لا ضابط أمني — فهو يسري على الجميع لا على دور بعينه، ولا يمنع سوى الكتابة في المتصفح. أما حين تجب حماية الحقل فعلاً فاستخدم صفحة *إعدادات الحقول* أعلاه. وفي الشاشة نفسها تُضبط قواعد الإدخال لكل حقل — الصيغ والقيم المسموح بها وحدود عدد السطور وأقصى طول للحقل.
- لتقييد *الصفوف* الظاهرة داخل شاشة عرض مسموحة، فأنت تريد الفلاتر الإضافية (Extra Filters) — راجع [الصلاحيات على مستوى السجلات](/ar/platform/security/record-level-security.md).
- ولقصر مستخدم على سنة مالية أو فترة محددة في المستندات والتقارير راجع [قصر المستخدم على سنة مالية](/ar/platform/list-views/limit-user-to-year.md).
