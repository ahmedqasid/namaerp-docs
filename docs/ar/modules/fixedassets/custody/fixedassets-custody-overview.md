...
## لا أزرار في هذه السلسلة كلها

يحسن أن يقال مرة واحدة هنا بدل ست مرات: **لا شاشة من شاشات العهدة فيها زر خاص بها.** فالنوع والسجل
والشراء والتسليم والنقل والتخلص كلها تُملأ وتُحفَظ، وكل ما تفعله بالسجل وبدفتر الأستاذ يحدث عند
اعتمادها ويُنقض بإلغائها أو حذفها. والاستثناء الوحيد هو مستند الشراء الذي يستعير آلية الفاتورة ومعها
**إنشاء الدفعات** لكتابة جدول أقساط.

فإذا سأل أحدهم عن الزر الذي يجمع كل ما بحوزة موظف، فالجواب أنه لا يوجد. فالشاشة التي تؤدي هذه المهمة
تؤديها دون زر: [سند تسليم العهد](/ar/modules/fixedassets/acquisition/fixedassets-delivery-receipt.md)
يملأ جريده بنفسه لحظة تسميتك الموظف المسلِّم.
...
تتذكّر كل عهدة آخر مستند لمسها. وهذه العلامة الواحدة هي ما يحفظ انضباط السلسلة: فإن حاولت إلغاء مستند
...
فالقاعدة عند تصحيح سلسلة عهدة بسيطة: **ألغِ الأحدث أولاً ثم تراجع للخلف**. ألغِ مستند النقل أو احذفه،
فتُعاد بناء سطور الحيازة من المستند الذي سبقه؛ ثم ألغِ مستند التسليم أو احذفه، فيعود الصنف إلى حالة *تم شراؤة*
وتُمسح سطور حيازته. وتمنعك العلامة نفسها من تبديل العهدة على مستند سبق اعتماده — ألغِه أو حرّر
مستنداً جديداً.
