...
::: warning الطلب نهاية طريق لا بدايته
لا سبيل إلى تحويل طلب تسجيل الوقت إلى مستند تنفيذ مهام: فلا شيء يحوّله، ولا تراه موافقة ولا فاتورة قط — إذ لا يقرأ **تجميع السجلات** ولا **تجميع التنفيذات** إلا سطور مستندات التنفيذ. فاستعمل الطلب لالتقاط التكلفة لا غير، وسجّل كل ما يحتاج إلى موافقة أو مطالبة على مستند تنفيذ مهام من البداية.
:::
