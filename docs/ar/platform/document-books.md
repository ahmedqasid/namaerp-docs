...
menu: الأساسيات ← الإعدادات ← دفتر مستند
---
...
شركة حقيقية عند الحفظ — والمستند الذي يبلغ الحفظ بلا شركة يُرفض بالرسالة
«لايمكن حفظ المستند على الشركة عام». ويجب أن تحمل الشركة نفسها **دفتر حسابات**؛ فإن لم تحمله رُفض
المستند بالرسالة «فضلاً قم بتحديد دفتر حسابات في الشركة»، وهي نقص في إعداد سجل الشركة لا خطأ في الدفتر.
...
{0} لا يمكن استخدامة حيث أنه غير نشط».
...
ولا يستطيع المستخدم اختيار دفتر نظامي على مستند ينشئه بيده؛ فيُرفض الحفظ برسالة
«الدفتر  {0} لا يمكن استخدامة حيث أنه دفتر نظامي». اترك «نظامي» مغلقًا في كل دفتر تنشئه للمستخدمين.
...
الدفاتر المسموح بها** تطابقها بقاعدة. عبِّئ أيًّا منهما ويُرفض المزيج غير المتطابق:
«لا يمكن استعمال التوجيه {0} مع الدفتر {1}». واترك الاثنين فارغين ليعمل التوجيه مع أي دفتر من نوع مستنده.
