...
ستجد صرف الخامات ضمن **التصنيع ← Cartoon ← صرف خامات كرتون**.
...
## العمل بصرف الخامات عمليًا

اصرف من مستند التخطيط كلما استطعت. فالملء الآلي ليس أسرع من كتابة الأسطر فحسب، بل هو ما يضمن أن اللوطات الخارجة من المخزن هي اللوطات التي بنى المُحسِّن خطته عليها، والأسطر المُدخلة يدويًا تفقد هذا الضمان في صمت.

واصرف سريعًا كذلك. فخطة مبنية على صورة مخزون الأسبوع الماضي قد تصير غير قابلة للتنفيذ: ربما سحب غيرك من اللوط نفسه، أو حرّكت تسويةٌ الأرقامَ. والتحقق من الكمية المتاحة عند الإدراج هو الطريقة الرخيصة لالتقاط ذلك قبل الترحيل لا بعده.

وتستحق عروض اللفّات عناية خاصة. فالمُحسِّن خطط نمط قص حول عروض بعينها، وإحلال لفّة 1800 مم محل 2000 مم ليس تبديلًا بالمثل — فقد لا يتّسع النمط أصلًا. وحيث تضطر إلى إحلال لوط أو عرض، فبيّن السبب في الملاحظات. فهذه الملاحظة تكلف ثوانيَ الآن وتجيب عن سؤال كان سيستغرق ساعة لإعادة تركيبه لاحقًا.

وأنظف أثر مستندي هو مستند تخطيط واحد لصرف واحد. والصرف الجزئي والصرف متعدد الخطط كلاهما مدعوم، ولهما مسوّغات وجيهة، لكنهما يجعلان تتبع الأثر أصعب — فعاملهما بوصفهما الاستثناء.

وأخيرًا، لا بد أن يعرف المصنع أي اللوطات تُصرف. فرقم لوط صحيح على الورق لا يحقق شيئًا إن سحب العامل اللفّة المادية الخطأ، وفي مخزن كبير يكون تحديد المواقع هو ما يحوّل «في مكان ما بالمخزن» إلى رفّ وموضع.
