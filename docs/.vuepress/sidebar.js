export const SIDEBAR_CONFIG = {
  "/" : [ {
    ...
    children: [ {
      text: "Guides",
      collapsible: true,
      children: [ "/guide/utils.md", "/guide/system-minimum-requirements.md", "/guide/reports-guide.md", "/guide/shortcuts.md", "/guide/screen-modifier.md", "/guide/ea-fields-values-calculator.md", "/guide/excel-and-sql-import-by-entity-flow.md", "/guide/tempo.md", "/guide/translations.md", "/guide/criteria-based-validation.md", "/guide/attendance-machine-formula.md", "/guide/scheduled-tasks.md", "/guide/nama-properties.md", "/guide/reward-points.md", "/guide/oracle-jdbc-connection.md" ]
    }, {
      text: "Examples",
      collapsible: true,
