...
|---|---|---|
| «القالب {0} لديه بالفعل مستند توريد قالب , لا يمكن عمل مستند توريد قالب لنفس القالب» | صُدر **مستند توريد قالب** ثانٍ لقالب داخل الخدمة بالفعل. فالقالب يدخل الخدمة مرة واحدة، وما بعدها سندات، وفي النهاية تخريد. | إن كانت القيمة أو المعدل خطأً في التوريد الأول، فصحّح ذلك المستند بدلًا من إضافة آخر. |
| «المستند الأول للقالب {0} يجب أن يكون مستند توريد قالب, لا يمكن أن يكون {1}» | سند أو تخريد هو أول مستند في تاريخ القالب — فلا شيء أدخل القالب الخدمة بقيمة بعد. والرسالة تذكر المستند الذي جاء أولًا. | سجّل مستند توريد القالب بتاريخ قبل ذلك المستند، ثم احفظ من جديد. |
| «القالب {0} تم تخريده, لا يمكن السماح بالحركة {1}» | مستند تاريخه بعد تخريد القالب يحاول تحريكه. والقالب المخرَّد لا يقبل حركات بعد ذلك. | ضع تاريخ المستند قبل التخريد إن كان من عمر القالب العامل، أو ألغِ التخريد إن كان القالب عاد للخدمة فعلًا. |
| «عدد القالب {0} هو {1} , لايمكن السماح بالحركة {2} لان العدد سيتغير إالي {3}» | بإعادة تشغيل مستندات القالب بترتيب التاريخ، يخفض هذا المستند العدد إلى ما تحت الصفر — وغالبًا لأن سندًا أُدرج قبل التوريد الذي وفّر ذلك العدد، أو لأن التوريد عُدِّل بالخفض بعد إصدار السندات. | اقرأ الأرقام في الرسالة: العدد قبل الحركة، والحركة، وما سيصير إليه. ثم صحّح ترتيب التاريخ أو الكمية الخطأ. |
| «قيمة القالب {0} هو {1} , لايمكن السماح بالحركة {2} لان القيمة ستتغير إالي {3}» | الإعادة نفسها في جهة القيمة: القيمة المستهلكة تتعدى ما أدخله التوريد، فتصير قيمة القالب أقل من الصفر. | راجع معدل الساعة للقالب والساعات المحمَّلة عليه. فالمعدل المرتفع يستنزف القيمة أسرع من التآكل الحقيقي. |
