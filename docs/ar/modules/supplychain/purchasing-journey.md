...
- **تجميع** (Collect) — يسأل عن **تاريخ من** و**تاريخ إلى**، ويملأ جدول المستندات المخزنية بأوامر الاستلام التي أُخذت من هذا المورد في نفس المخزن وجهة الاتصال والذمة ولم تُفوتر بعد.
...
- **تحديث التفاصيل** (Update Details) — ينزل بقيم الرأس إلى كل سطر تفاصيل. ويسأل عن كل منها على حدة بنعم/لا: تاريخ من، وتاريخ إلى، والمجموعة التحليلية، والشركة، والفرع، والإدارة، والقطاع، والمورد، وتصنيف الفاتورة، ومصنِّفات الأسعار من ١ إلى ٥.
- **تحديث الأسعار** (Update Prices) — يعيد حساب الأسعار عبر قواعد محدِّثات السعر في الرأس: حقل مصدر، وحتى أربعة حقول وجهة، وحتى خمسة محدِّثات، تُطبَّق على كل السطور أو على المختار منها فقط. ويرفض العمل إن كانت القائمة بلا سطور أو لم يُملأ أي محدِّث.
...
- **إضافة سطور المصدر الإضافي** (Add additional source lines) — يلحق سطور قائمة أسعار أخرى معرَّفة كمصدر إضافي، مع إمكانية نقل خصومات الفواتير معها وتخطي الأصناف الموجودة في القائمة أصلًا.
- **فرد بيانات السطر المحدد** (Spread Selected Line Data) — يأخذ السطر الواقف عليه ويفرده على وحدات الصنف وإصداراته ومقاساته وألوانه، بحسب مفاتيح الفرد في الرأس.
