...
::: info لمن هذا القسم؟
نظام البريد جزء متخصّص داخل وحدة الشحن. إن كان عملك هو الشحن البحري والتخليص فقط، فقد لا تحتاج إليه. أمّا مشغّلو البريد والطرود فيجدون فيه دورة عمل كاملة. كلا القسمين في قائمة **نظام إدارة الشحن** نفسها، لكن ترخيصهما منفصل: مستندات الشحن والتخليص تحت `frm`، وكل ما يخصّ البريد تحت `frm-ips`.
:::
