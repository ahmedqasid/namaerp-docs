...
::: warning «لا يوجد نموذج للطباعه»، على مستند صنعتَ له نموذجًا لتوّك
...
| **صفحة النموذج** | يربط النموذج بتبويبات شاشة بعينها، للمستندات التي لشاشاتها أكثر من تبويب. اضغط داخله تظهر تبويبات شاشة **الجدول الرئيسي** لتختار منها؛ ولتغطية أكثر من تبويب افصلها بفواصل لاتينية — `Main,Attachments`. |
