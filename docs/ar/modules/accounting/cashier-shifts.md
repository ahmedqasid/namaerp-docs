...
menu: الحسابات ← الكاشير ← سند فتح وردية
---
...
![شاشة سند فتح وردية](images/cashier/open-shift-ar.png)
...
![شاشة سند غلق وردية](images/cashier/close-shift-ar.png)

## الإجراءات في هذه الشاشة

يحمل **سند غلق وردية** زرًّا واحدًا يهمّ حين تبدو أرقام الدرج غير سليمة:

- **إعادة احتساب قيم طرق الدفع** (Recalculate Payments Values) — يعيد قراءة وردية الفتح ويعيد بناء قيم طرق الدفع في سند الغلق من سندات القبض والصرف المسجَّلة فعلًا خلالها. استعمله حين تُضاف سندات أو تُعدَّل أو تُحذف بعد بدء سند الغلق فلم تعد إجمالياته متّفقة مع الوردية — فضغطه يعيد مطابقتها بدل أن تضطر لبدء سند غلق جديد.
...
|---|---|---|
| «يجب غلق الوردية {0} قبل فتح وردية جديدة» | مستخدم الكاشير في **سند فتح الوردية** هذا له بالفعل وردية معتمدة لم تُغلق. | أغلِق الوردية المفتوحة بـ**سند غلق وردية**، ثم افتح الجديدة. |
| «يجب حذف السند {0} كود {1} أو حذف فتح الوردية من هذا السند» | أنت تحذف **سند فتح وردية** ما زالت سندات مرتبطة به؛ والرسالة تسرد نوع كل مستند وكوده مما يشير إليه. | احذف تلك المستندات أو أفرِغ حقل الوردية المفتوحة فيها، ثم احذف الوردية. |
| «المبلغ المحول {0} لا يمكن ان يكون أكبر من المبلغ الفعلى {1}» | سطر في تفاصيل **سند غلق الوردية** يحوّل أكثر من المبلغ المعدود فعلًا في السطر. | اجعل المبلغ المحوّل بحدّ المبلغ الفعلي؛ والباقي يبقى مع الكاشير أو يصبح فرقًا. |
| «الوردية {0} مغلقة بالفعل بواسطة {2}» | يوجد **سند غلق وردية** معتمد آخر أغلق الوردية التي يشير إليها هذا السند. | استخدم سند الغلق القائم واحذف هذا. (النصّ العربي لهذه الرسالة يترك أحد المتغيّرات بدون تعويض.) |
