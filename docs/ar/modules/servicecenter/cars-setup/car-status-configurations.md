...
menu: سيارات ← ملفات السيارات ← إعدادت حالة حاله السياره
---
...
> «لا يمكن تغيير حالة {0} من الحالة {1} - و حالة رئيسية {2} الي الحالة {3} - و حالة رئيسية {4} في المستند {5} للصنف {6} في السطر رقم {7}»

و{0} هو نوع الصنف الفرعي — *سيارة العميل* في الورشة، و*سيارة* في المعرض.
...
يبدو مكتملاً، ولا تكتشف الثغرة إلا حين يُرفض مستند حقيقي أمام عميل بهذا الرفض نفسه.
