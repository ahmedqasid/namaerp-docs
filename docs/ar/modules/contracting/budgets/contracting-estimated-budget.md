...
menu: المقاولات ← الملفات ← موازنة مقاولات تقديرية
---
...
- **كل منهما تُشير إلى الأخرى.** في الموازنة التقديرية حقل **الموازنة التنفيذية**، وفي التنفيذية حقل **الموازنة التقديرية**. املأ أحد الطرفين فيملأ النظام الطرف الآخر عند الحفظ. والاقتران واحد لواحد ومُلزَم: إن كانت الموازنة التي اخترتها مقترنة بموازنة أخرى من نوعك فسيفشل الحفظ برسالة «السجل {0} بالفعل مرتبط بالسجل {1}».
