...
![Run the report - select start and end date](../../../platform/reports/images/report-wizard-ex-1-run-report.png)

Select an appropriate time period (from date - to date) and click **Run Now**. The report will appear as follows:

![Report result - sales invoices](../../../platform/reports/images/report-wizard-ex-1-view-result.png)
