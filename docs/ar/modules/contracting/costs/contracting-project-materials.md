...
كل كود بند غير فارغ يُراجَع على قائمة بنود العقد المختار، والكود غير الموجود فيها يُرفَض برسالة
«كود البند {0} غير موجود فى العقد {1}». أما كون كود البند **إجبارياً** فهو قرار إعداد على توجيه المستند:
...
- «لم يتم صرف الصنف {0} للبند {1}» — أنت ترد شيئاً لم يُصرف على ذلك البند أصلاً؛
- «الكمية المردودة أكبر من الكمية المصروفة للصنف {0} والبند {1}» — أنت ترد أكثر مما خرج.
...
كل من الصرف والرد يرفض الحذف بعد أن يستوعب حصر تكاليف أحد سطوره، برسالة
«لا يمكن حذف المستند {0} بسبب انه مرتبط بمستند حصر تكاليف {1}». وتعديل ذلك السطر ممنوع للسبب نفسه. وهذا مقصود — فحصر التكاليف المعتمد حوّل تلك التكلفة إلى تكلفة
...
|---|---|---|
| «إجمالي كمية أوامر الشراء {0} أقل من الكمية المصروفة {1} للصنف {2} وكود البند {3}» | توجيه الصرف مفعَّل فيه خيار *منع الحفظ إذا تعدت كمية الأصناف المصروفة كمية الأصناف في أمر الشراء*، وهذا الصنف على هذا كود البند صار المصروف منه أكثر مما أُمر بشرائه للعقد. والمجاميع تحسب كل الصرفيات وكل أوامر شراء المقاولات على العقد لا هذا المستند وحده. | أنقص الكمية على السطر، أو أدخل أمر شراء مقاولات بالكمية الزائدة أولاً. وإن لم تكن المراجعة مطلوبة لهذا النوع من المستندات فأزل تفعيل الخيار من التوجيه. |
| «لم يتم صرف الصنف {0} للبند {1}» | سطر في رد خامات مقاولات يرد صنفاً على كود بند لم يُصرف له هذا الصنف على هذا العقد قط. | راجع كود البند على سطر الرد في مقابل الصرف الذي تعكسه — فالغالب أن الرد كُتب على البند الخطأ. |
| «الكمية المردودة أكبر من الكمية المصروفة للصنف {0} والبند {1}» | الرد سيُرجع أكثر مما صُرف لذلك الصنف وذلك البند، بعد حساب كل ما رُدّ بالفعل. | رد الكمية المتبقية فقط. والمواقع التي تحتاج الرد بأكثر من المصروف فعلاً تستطيع السماح بذلك من خيار التوجيه الذي يسمح بتعدي الكمية المرتجعة للمصروفة. |
