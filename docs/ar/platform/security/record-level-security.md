...
كل سجل في نما تقريباً يحمل خمسة محددات تنظيمية — وأما الملفات الرئيسية نفسها والمحدد المركب الذي ينوب عن عدة محددات فتجدها في [المحددات والمحددات المركبة](/ar/platform/dimensions-and-composite-dimensions):
...
::: info تخفيف قواعد المحددات
هناك مفتاحان متصلان بهذا الأمر لكنهما خارج الصلاحيات، في [أعدادات الحقول و الشاشات](/ar/platform/fields-and-entities-settings/fields-settings-relaxing-restrictions): يمكنك إعلان نوع سجل إضافي **عاماً على مستوى المحددات** فيتصرف كالملفات الرئيسية العامة المذكورة أعلاه، كما يمكنك إيقاف فحص توافق المحددات على حقل مرجع بعينه حين يحتاج المستند فعلاً إلى الإشارة إلى سجل من فرع أو إدارة أخرى.
:::
...
ثلاث علامات على سطر الصلاحيات الأساسية (على مستوى الملف أو المستخدم — راجع [ملف الصلاحيات](/ar/platform/security/security-profiles.md)) تربط الصلاحية بمنشئ السجل:
...
1. عرّف سجل نوع صلاحيات — راجع [ملف الصلاحيات](/ar/platform/security/security-profiles.md).
...
يمكن وسم الملف الرئيسي بعلامة **منع الاستعمال** — صنف موقوف، أو عميل لا يُباع له بعد اليوم — وملف
الصلاحيات هو الذي يقرر من يظل يراه. والعمود اسمه **عرض السجلات الممنوعة من الاستعمال** في جدول
الصلاحيات الأساسية، بقيمة واحدة لكل نوع كيان: *Display* أو *Hide* أو *Same As Config*. وبهذا يظل
مدير المشتريات يفتح تاريخ مورد ممنوع بينما لا يستطيع مدخل البيانات وضع المورد نفسه على أمر شراء جديد.

وصفحة [منع الاستعمال](/ar/platform/prevent-usage) هي التي تغطي العلامة نفسها، وكل ما تمنعه، وكل
موضع يُقرأ فيه الإعداد.
