...
|---|---|---|
| «الموظف {0} مكرر فى السطر رقم {1}» | الموظف نفسه مدرج مرتين في جدول التفاصيل بالاسم نفسه — وسطر اشتراك واحد لكل شخص (أما المرافقون فلهم سطور بأسمائهم). | احذف السطر المكرر، أو صحّح الاسم إن كان السطر الثاني لمرافق. |
| «الموظف {0} لم ينتهى تأمينه بعد» | تأمين الموظف الصحي الحالي لم ينتهِ بعدُ في التاريخ الفعلي لهذا المستند، فإضافته من جديد تُحدث تغطيتين متداخلتين. | انتظر انتهاء التغطية الحالية، أو أخرج الموظف من البوليصة القائمة أولًا، أو استخدم سند الترقية إن كان المقصود فئة أعلى. |
| «لايمكن الترقية إلى نفس الفئة او فئة اقل» | في سطر سند ترقية التأمين الصحي جاءت **الفئة الجديدة** مساوية لفئة الموظف الحالية أو أقل منها. وترتيب الفئات: B ثم B+ ثم A ثم AA ثم VIP ثم VIP+. | اختر فئة أعلى، أو احذف السطر — فالنزول بفئة الموظف يتم بإخراجه وإعادة إضافته لا بسند ترقية. |
