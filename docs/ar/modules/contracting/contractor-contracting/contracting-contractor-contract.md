...
menu: المقاولات ← مقاولة مقاول باطن ← عقد مقاول باطن
---
...
**لا تُسند أكثر مما بعت.** إذا سمّى عقد الباطن عقد مشروع، فإن الحفظ يجمع كمية **كل بند من بنود عقد العميل عبر كل عقود الباطن على ذلك العقد** ويرفض إن تجاوز المجموع الكمية الموجودة في عقد العميل نفسه — «إجمالي كميات عقود مقاول الباطن لكود البند {0} - {1} في عقد المشروع {2} تساوي {3}، بينما كمية كود البند تساوي {4}». فعقد الفنار يحمل 2,000 م² من أعمال المباني، و CC-0042 يأخذها كلها، فعقد باطن ثانٍ على البند نفسه سيُرفض حتى يُعدَّل عقد العميل. وهناك خيار في إعدادات المقاولات يرفع الفحص للمنشآت التي تفضّل الإسناد أولاً والتعديل لاحقاً.
...
| أكواد البنود لا تتكرر | «لا يمكن ادخال بنود مكرره» |
