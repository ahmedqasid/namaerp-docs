...
وأخيراً تحمل مجموعة **[المحددات](/ar/platform/dimensions-and-composite-dimensions)** الشركة والمجموعة التحليلية والفرع والقطاع والإدارة. وهل يأخذ القيد
...
الاعتماد. وللعكس تُلغي المستند أو تحذفه — ولا يوجد زر عكس ولا حاجة إليه.

## التراجع عن التخلص

لا يوجد زر «عكس»، ولا حاجة إليه: **ألغِ المستند أو احذفه** فيُنقض كل ما فعله.
...
- **حدوث شيء للأصل بعد التخلص.** فإن وُجد على الأصل أي قيد لاحق رُفض الإلغاء وذكرت الرسالة
...
ولست مضطراً دائماً إلى الإلغاء. فمستند التخلص المعتمد يمكن **تعديله** ببساطة — بما في ذلك تغيير
الأصل الذي يشير إليه. وعندها يُستعاد الأصل السابق استعادة كاملة، تماماً كما لو ألغيت المستند، قبل
...
|---|---|---|
| «الجدول {0} لا يمكن ملئه بسبب عدم اختيار أوبشن {1} في إعدادات الأصول الثابتة» | جدول الأصول المنشأة فيه صفوف والخيار المقابل في إعدادات وحدة الأصول الثابتة مُطفأ. | افرغ الجدول، أو شغّل الخيار في إعدادات الوحدة واحفظها قبل الترحيل. |
| «لا يمكن عمل التخلص للاصل الثابت لان الحالة ابتدائية» | الأصل لا يزال **إبتدائى** — لا تكلفة له، فلا شيء يُتخلَّص منه. | إن كان الأصل لم يُقصد وجوده أصلاً فاحذف البطاقة. وإن كان مشترى فرسمِله أولاً. |
| «لا يمكن عمل تخلص للأصل {0} لأن حالته تم التخلص منه» | تم التخلص من الأصل بمستند سابق بالفعل. | انقُض ذلك التخلص السابق إن كان خطأ، ولا ترفع تخلصاً ثانياً. |
