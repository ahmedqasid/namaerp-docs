...
::: tip تعديل الشاشات أم أعدادات الحقول و الشاشات؟
يسهل الخلط بين هاتين الشاشتين. تعديل الشاشات يحدّد **أين** تظهر الأشياء — في أي صفحة تقع المجموعة، وأي الحقول مخفية، وما اسم التبويب، وأي الأعمدة تعرضها القائمة. وهو لا يغيّر سلوك الحقل نفسه. أما أقنعة الإدخال والقيم المسموح بها والحقول للقراءة فقط والأيقونات والألوان وما يعرضه حقل المرجع وكيف يبحث والحقول المحسوبة — فكلها في [أعدادات الحقول و الشاشات](/ar/platform/fields-and-entities-settings/) تحت **الأساسي ← الإعدادات**. فإن كنت جئت لتغيير سلوك حقل لا موضعه، فتلك هي الشاشة التي تريدها.
:::
...
![قائمة عرض تعديل الشاشات](./images/screen-modifier-list-ar.png)
...
![تعديل الشاشة — التبويب الرئيسي](./images/screen-modifier-full-ar.png)
