...
menu: البنوك ← ودائع بنكية ← وديعة بنكية
---
...
![شاشة الوديعة البنكية](images/deposits/fixed-deposit-ar.png)
...
![شاشة إصدار الوديعة](images/deposits/fixed-deposit-issue-ar.png)
...
**سند إصدار أرباح** لا يطلب منك سرد الودائع يدويًا:

- **تجميع الودائع** (Collect Deposits) — حدّد نطاق **من وديعة** / **إلى وديعة** ومدى تاريخي، فيملأ المستند بالأرباح المستحقة على كل وديعة مطابقة في ذلك المدى، فيثبت مستندٌ واحد أرباح فترة كاملة عبر عدة ودائع. ويحتاج **تاريخًا فعليًا** إن لم تضيّق النطاق بوديعة أو بتاريخ بداية، ويتجاوز الودائع التي تُخرجها حالتها من الاحتساب.
