...
::: warning كود البند فريد داخل عقده هو فقط
جدول البنود في عقد المشروع يرفض تكرار الكود، فكود البند فريد **داخل ذلك العقد** ولا شيء غير ذلك. وأكواد
مثل `V.O.1` أو `4.1` أو `م.ع` تتكرر في كل مشروع بحكم طبيعتها، والكود نفسه لا يدل على المشروع الذي ينتمي
إليه. الذي يحدد المشروع هو **العقد**: كل مستند تكلفة وكل سطر تكلفة يحمل عقداً، وعقد المشروع يحمل مشروعه؛
وبعض مستندات التكلفة فقط (مستند السركى ومستند بيان معدات) تحمل فوق ذلك حقل مشروع خاصاً بها.

ولهذا فأي تقرير أو استعلام أو تصدير يجمّع أو يربط على كود البند **لا بد أن يضم العقد — أو المشروع الذي
خلفه — إلى مفتاح التجميع والربط**. فالتجميع على الكود وحده يضيف بصمت تكلفة كل مشروع يستخدم نفس الكود، والإجمالي
يبدو معقولاً تماماً: بند تكلفته الحقيقية 9,375 قد يظهر بـ 30,990 ولا شيء على الشاشة يشير إلى أن مشروعين
لا علاقة بينهما قد اندمجا.
:::
